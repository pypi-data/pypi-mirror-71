...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    languages_by_size = [
        ...
        'vi', 'ja', 'zh', 'ar', 'pt', 'uk', 'fa', 'ca', 'sr', 'arz', 'no',
        'id', 'ko', 'fi', 'hu', 'cs', 'sh', 'ro', 'zh-min-nan', 'eu', 'tr',
        'ms', 'eo', 'hy', 'he', 'bg', 'da', 'ce', 'azb', 'sk', 'kk', 'min',
        'hr', 'et', 'lt', 'be', 'el', 'sl', 'gl', 'simple', 'az', 'ur', 'nn',
        'hi', 'th', 'ka', 'uz', 'la', 'cy', 'ta', 'vo', 'ast', 'mk', 'lv',
        'tg', 'mg', 'tt', 'af', 'bn', 'oc', 'zh-yue', 'bs', 'sq', 'ky', 'new',
        'tl', 'be-tarask', 'te', 'ml', 'br', 'nds', 'pms', 'su', 'sw', 'ht',
        'lb', 'vec', 'jv', 'mr', 'sco', 'pnb', 'ga', 'szl', 'ba', 'is', 'my',
        'fy', 'cv', 'lmo', 'an', 'pa', 'ne', 'wuu', 'yo', 'bar', 'io', 'gu',
        'ku', 'als', 'ckb', 'kn', 'scn', 'bpy', 'ia', 'qu', 'mn', 'diq',
        'bat-smg', 'or', 'si', 'cdo', 'nv', 'ilo', 'gd', 'yi', 'am', 'nap',
        'bug', 'xmf', 'wa', 'hsb', 'sd', 'mai', 'map-bms', 'fo', 'mzn', 'li',
        'eml', 'os', 'sah', 'sa', 'ps', 'frr', 'bcl', 'ace', 'zh-classical',
        'mrj', 'mhr', 'hif', 'hak', 'roa-tara', 'pam', 'nso', 'km', 'hyw',
        'se', 'rue', 'crh', 'bh', 'vls', 'mi', 'shn', 'nah', 'nds-nl', 'as',
        'sc', 'vep', 'gan', 'myv', 'ab', 'gor', 'glk', 'bo', 'so', 'co', 'tk',
        'fiu-vro', 'sn', 'lrc', 'kv', 'csb', 'ha', 'gv', 'udm', 'ie', 'ay',
        'pcd', 'zea', 'kab', 'nrm', 'ug', 'lez', 'stq', 'kw', 'haw', 'frp',
        'lfn', 'lij', 'mwl', 'gn', 'gom', 'rm', 'mt', 'lo', 'lad', 'koi',
        'fur', 'olo', 'sat', 'dsb', 'dty', 'ang', 'ext', 'ln', 'bjn',
        'cbk-zam', 'dv', 'ban', 'ksh', 'gag', 'pfl', 'pag', 'pi', 'tyv', 'av',
        'zu', 'awa', 'bxr', 'xal', 'krc', 'pap', 'za', 'pdc', 'kaa', 'rw',
        'arc', 'szy', 'to', 'nov', 'jam', 'tpi', 'kbp', 'kbd', 'ig', 'na',
        'tet', 'wo', 'tcy', 'ki', 'inh', 'jbo', 'atj', 'roa-rup', 'bi', 'lbe',
        'kg', 'ty', 'mdf', 'lg', 'srn', 'xh', 'gcr', 'fj', 'ltg', 'chr', 'sm',
        'got', 'kl', 'ak', 'pih', 'om', 'cu', 'tn', 'tw', 'st', 'ts', 'rmy',
        'bm', 'chy', 'nqo', 'rn', 'tum', 'ny', 'mnw', 'ss', 'ch', 'pnt', 'iu',
        'ady', 'ks', 've', 'ee', 'ik', 'sg', 'ff', 'ti', 'dz', 'din', 'cr',
    ]

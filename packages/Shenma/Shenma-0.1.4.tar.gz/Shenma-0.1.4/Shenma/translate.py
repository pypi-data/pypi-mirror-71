...
APP_ID = '20205509'
API_KEY = 'jUE1ayWr97dq6vAoicWMy20c'
SECRET_KEY = 'rcwwlyjoXndz38rVeqpkVBfKveY3nGbq'
...
class Translation(object):
    def __init__(self,filePath):
        ...
        Text = client.asr(wav ,'wav' , 16000 , {'dev_pid': 1537,})['result'][0]
        # 应用ID（到控制台获取）
        self.APPID = "5ed47c39"
        # 接口APIKey（到控制台机器翻译服务页面获取）
        self.APIKey= "810ebe7348798656d569ff72dc1f389a"
        # 接口APISercet（到控制台机器翻译服务页面获取）
        self.Secret = "84d9a46e479c424cfe04c2c495cd4eb5"
    ...
    def result(self):
        if self.APPID == '' or self.APIKey == '' or self.Secret == '':
            ...
            if status_code!=200:
                ...
                print('原文：{}\n译文：{}'.format(respData['data']['result']['trans_result']['src'],respData['data']['result']['trans_result']['dst']))
                # 以下仅用于调试

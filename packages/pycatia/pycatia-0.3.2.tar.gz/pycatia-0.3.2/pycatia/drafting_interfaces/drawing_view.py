...
class DrawingView(AnyObject):
    ...
    def insert_view_angle(self, i_first, io_text):
        ...
        # # vba_function_name = 'insert_view_angle'
        # # vba_code = """
        # # Public Function insert_view_angle(drawing_view)
        # #     Dim iFirst (2)
        # #     drawing_view.InsertViewAngle iFirst
        # #     insert_view_angle = iFirst
        # # End Function
        # # """
    ...
    def insert_view_scale(self, i_first, io_text):
        ...
        # # passed to it and there is no way to do this directly with python. In those cases the following code
        # # should be uncommented and edited accordingly. Otherwise completely remove all this.
        # # vba_function_name = 'insert_view_scale'
        # # vba_code = """
        # # Public Function insert_view_scale(drawing_view)
        # #     Dim iFirst (2)
        # #     drawing_view.InsertViewScale iFirst
        # #     insert_view_scale = iFirst
        # # End Function
        # # """

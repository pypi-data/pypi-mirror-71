...
#define __PYX_HAVE__moxy__main
#define __PYX_HAVE_API__moxy__main
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'moxy.main' */
#define __Pyx_MODULE_NAME "moxy.main"
extern int __pyx_module_is_main_moxy__main;
int __pyx_module_is_main_moxy__main = 0;

/* Implementation of 'moxy.main' */
...
static PyObject *__pyx_n_u_compiled;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_u_compiled, __pyx_k_compiled, sizeof(__pyx_k_compiled), 0, 1, 0, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_moxy__main) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "moxy.main")) {
      if (unlikely(PyDict_SetItemString(modules, "moxy.main", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *         compiled = False
 */
          if (PyDict_SetItem(__pyx_d, __pyx_n_s_compiled, Py_True) < 0) __PYX_ERR(0, 15, __pyx_L8_error)
 ...
 */
        ...
        if (__pyx_t_7) {
          __Pyx_AddTraceback("moxy.main", __pyx_clineno, __pyx_lineno, __pyx_filename);
          if (__Pyx_GetException(&__pyx_t_8, &__pyx_t_9, &__pyx_t_10) < 0) __PYX_ERR(0, 16, __pyx_L10_except_error)
 ...
 * 
 */
          if (PyDict_SetItem(__pyx_d, __pyx_n_s_compiled, Py_False) < 0) __PYX_ERR(0, 17, __pyx_L10_except_error)
 ...
 * ]
 */
  __pyx_t_10 = PyList_New(1); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __Pyx_INCREF(__pyx_n_u_compiled);
  __Pyx_GIVEREF(__pyx_n_u_compiled);
  PyList_SET_ITEM(__pyx_t_10, 0, __pyx_n_u_compiled);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_all, __pyx_t_10) < 0) __PYX_ERR(0, 20, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init moxy.main", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init moxy.main");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT

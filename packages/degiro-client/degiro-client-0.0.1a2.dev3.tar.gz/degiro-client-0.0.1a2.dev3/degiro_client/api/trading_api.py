...
class TradingApi(object):
    ...
    def confirm_order(self, body, confirmation_id, session_id, **kwargs):  # noqa: E501
        """TODO  # noqa: E501

        TODO  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.confirm_order(body, confirmation_id, session_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.confirm_order_with_http_info(body, confirmation_id, session_id, **kwargs)  # noqa: E501
        else:
            (data) = self.confirm_order_with_http_info(body, confirmation_id, session_id, **kwargs)  # noqa: E501
            return data

    def confirm_order_with_http_info(self, body, confirmation_id, session_id, **kwargs):  # noqa: E501
        """TODO  # noqa: E501

        TODO  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.confirm_order_with_http_info(body, confirmation_id, session_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `confirm_order`")  # noqa: E501
        # verify the required parameter 'confirmation_id' is set
        if ('confirmation_id' not in params or
                params['confirmation_id'] is None):
            raise ValueError("Missing the required parameter `confirmation_id` when calling `confirm_order`")  # noqa: E501
        # verify the required parameter 'session_id' is set
        if ('session_id' not in params or
                params['session_id'] is None):
            raise ValueError("Missing the required parameter `session_id` when calling `confirm_order`")  # noqa: E501

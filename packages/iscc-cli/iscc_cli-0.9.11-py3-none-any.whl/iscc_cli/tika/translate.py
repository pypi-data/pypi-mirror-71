...
def from_file(
    filename, srcLang, destLang, serverEndpoint=ServerEndpoint, requestOptions={}
):
    """
...
def from_buffer(
    string, srcLang, destLang, serverEndpoint=ServerEndpoint, requestOptions={}
):
    """
...
def auto_from_file(
    filename, destLang, serverEndpoint=ServerEndpoint, requestOptions={}
):
    """
    ...
    """
    jsonOutput = doTranslate1(
        destLang, filename, serverEndpoint, requestOptions=requestOptions
    )
    return jsonOutput[1]


def auto_from_buffer(
    string, destLang, serverEndpoint=ServerEndpoint, requestOptions={}
):
    """
    ...
    status, response = callServer(
        "put",
        ServerEndpoint,
        "/translate/all/" + Translator + "/" + destLang,
        string,
        {"Accept": "text/plain"},
        False,
        requestOptions=requestOptions,

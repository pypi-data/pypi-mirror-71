...
class FaceDetection():
    def __init__(self, mtcnn=None, inception_net=None, db=None, saved_models=None):

        self.facedb = FaceDatabase(saved_models, db)
...
class FaceDatabase():
    ...
    """
    def __init__(self, db_path=None, db_file=None):
        if db_file is None:
            print('init new db')

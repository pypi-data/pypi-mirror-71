...
def recreate_image(rgb=None, w=0, h=0, n_colors=65535):
    ...
    kmeans = KMeans(n_clusters=n_colors, verbose=2, random_state=0, init='k-means++', algorithm='full', n_init=1).fit(image_array_sample)
    ...
    ret = np.reshape(image, (w * h, d)).tolist()

...
def main():
	...
	argument_parser.add_argument("--extras", nargs="+", help="Categories of extras_require extras to install.")
	arguments = argument_parser.parse_args()

	setuper.run(arguments.setup_path, arguments.pip_arguments, arguments.remove_self, arguments.extras)

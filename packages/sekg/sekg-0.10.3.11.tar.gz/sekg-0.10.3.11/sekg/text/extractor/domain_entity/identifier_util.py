...
class IdentifierInfoExtractor:
    ...
    def extract_from_method_name(self, method_name: str, mark_for_identifier_in_relation=IDENTIFIER_ENTITY):
        ...
        if method_name.find(".is") > 0:
            ...
            if search_obj:
                ...
                identifier_relations.add((mark_for_identifier_in_relation, operation_relation_name, f"if {end_part}"))
            ...
            if search_obj:
                ...
                identifier_relations.add((mark_for_identifier_in_relation, operation_relation_name, f"{end_part}"))
    ...
    def extract_knowledge_from_method_name(self, method_name: str):
        ...
        for rel in relations:
            ...
            name = str(name).strip()
            res.append(f"{method_name} {verb} {name}")
        return res

...
class GetTestPlanResponse(betterproto.Message):
    ...
    # automatically.
    target: "DeviceIdentifier" = betterproto.message_field(1)
    # The test plan retrieved from the Dynamic Test Plan system
...
class StatusBody(betterproto.Message):
    ...
    # A list of one TestCaseResult, for historical reasons This is not set if
    # running is False
    results: List["TestCaseResult"] = betterproto.message_field(7)

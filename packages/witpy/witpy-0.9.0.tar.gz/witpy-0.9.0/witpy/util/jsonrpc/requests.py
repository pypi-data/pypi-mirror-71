...
class Request(Notification):
    ...
    def __init__(self, method: str, *args: Any, id_generator: Optional[Iterator[Any]] = None, **kwargs: Any) -> None:
        """
        :param method:
        :param args: Positional arguments added to `params`.
        :param id_generator:
        :param kwargs: Keyword arguments added to `params`. Use request_id=x to force the `id` to use.
        """

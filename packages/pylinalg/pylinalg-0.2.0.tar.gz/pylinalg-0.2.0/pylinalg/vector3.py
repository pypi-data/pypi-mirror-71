from math import acos, ceil, cos, floor, sin
...
class Vector3:
    ...
    def project(
        self, matrix_world_inverse: "Matrix", projection_matrix: "Matrix"
    ) -> "Vector3":
        return self.apply_matrix4(matrix_world_inverse).apply_matrix4(projection_matrix)

    def unproject(
        self, projection_matrix_inverse: "Matrix", matrix_world: "Matrix"
    ) -> "Vector3":
        return self.apply_matrix4(projection_matrix_inverse).apply_matrix4(matrix_world)

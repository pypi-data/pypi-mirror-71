...
module = Extension('_titanlib',
        ...
        extra_compile_args=" -std=c++1y -Wall -Wextra -Wno-unused-parameter -Wno-sign-compare -fPIC -O3 -fopenmp".split(),
        extra_link_args=" -std=c++1y -Wall -Wextra -Wno-unused-parameter -Wno-sign-compare -fPIC -O3 -fopenmp".split(),

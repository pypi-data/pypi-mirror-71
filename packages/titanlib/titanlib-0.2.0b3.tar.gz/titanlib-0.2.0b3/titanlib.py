...
def sct_old(lats, lons, elevs, values, nmin, nmax, num_min_prof, min_elev_diff, min_horizontal_scale, dz, pos, neg, eps2):
    return _titanlib.sct_old(lats, lons, elevs, values, nmin, nmax, num_min_prof, min_elev_diff, min_horizontal_scale, dz, pos, neg, eps2)
sct_old = _titanlib.sct_old

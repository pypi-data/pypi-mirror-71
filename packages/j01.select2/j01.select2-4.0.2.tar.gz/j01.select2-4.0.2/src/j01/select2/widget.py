...
##############################################################################
"""
$Id: widget.py 5030 2020-06-13 16:21:23Z roger.ineichen $
"""
...
class Select2WidgetMixin(object):
    ...
    def translate(self, msg):
        return zope.i18n.translate(msg, context=self.request, default=msg)
        ...
        if vocab is not None:
            ...
            if ignored:
                ...
                if group is None:
                    ...
                    group  = zope.i18n.translate(self.optGroupTitleCustom,

...
class InternalIdSpatialItemDTO(object):
    ...
    def __init__(self, name=None, external_id=None, start_time=None, end_time=None, description=None, metadata=None, asset_ids=None, source=None, crs=None, id=None, last_updated_time=None, created_time=None, local_vars_configuration=None):  # noqa: E501

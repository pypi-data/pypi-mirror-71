...
class ProjectTestCase(SDKTestcase):
    ...
    @responses.activate
    def test_set_target_feature_engineering_graphs_n_credentials(self):
        feature_engineering_graph = [{
            'id': 'feg-id',
            'linkage_keys': ['dept_id', 'cust_id']
        }]
        credentials = [
        ...
        project = {
            ...
            'fileName': 'Untitled Project.csv',
            'stage': 'modeling',
            'featureEngineeringGraphs': feature_engineering_graph,
            'credentials': credentials
        }
        prep_successful_aim_responses(project=project)

        project = Project('p-id').set_target(target='SalePrice',
                                             feature_engineering_graphs=feature_engineering_graph,
                                             credentials=credentials)
        ...
        assert request_message == {
            'target': 'SalePrice',
            'mode': AUTOPILOT_MODE.FULL_AUTO,
            'featureEngineeringGraphs': [
                {
                    'id': 'feg-id',
                    'linkageKeys': ['dept_id', 'cust_id']
                }
            ],
            'credentials': [
                {
        ...
        self.assertEqual(project.feature_engineering_graphs, feature_engineering_graph)

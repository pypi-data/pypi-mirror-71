...
from datarobot import (Blueprint, DatetimeModel, enums, Featurelist, Model, Project,
                       RatingTableModel)
...
from datarobot.models.advanced_tuning import (NonUniqueParametersException,
...
def test_retrain_duration_params(get_id_from_location_mock, model_data, project_id, model_json):
    ...
    assert 'Only one of training_duration or training_row_count should be specified.' in str(
        error_info.value)
    result_job = dt_model.retrain(time_window_sample_pct=40,

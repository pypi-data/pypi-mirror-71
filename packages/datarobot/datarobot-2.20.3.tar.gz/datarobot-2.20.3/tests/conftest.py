...
from datarobot import (Dataset, Project, Model, PrimeFile, PrimeModel, Ruleset, enums,
                       ...
                       RatingTable, RatingTableModel, DatetimeModel)
...
def client(request):
    ...
    for your test
    """
    if request.node.get_marker('no_client'):
        set_client(None)
        yield None
    else:

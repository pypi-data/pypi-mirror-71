...
class DEPLOYMENT_MATERIALITY(object):
    CRITICAL = 'CRITICAL'
    HIGH = 'HIGH'
    MODERATE = 'MODERATE'
    LOW = 'LOW'
...
class SERVICE_STAT_METRIC(object):
    ...
    ALL = [
        TOTAL_PREDICTIONS, TOTAL_REQUESTS, SLOW_REQUESTS, EXECUTION_TIME, RESPONSE_TIME,
        USER_ERROR_RATE, SERVER_ERROR_RATE, NUM_CONSUMERS, CACHE_HIT_RATIO, MEDIAN_LOAD, PEAK_LOAD
    ]

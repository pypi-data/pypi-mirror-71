...
class Feature(APIObject, HasHistogram):
    ...
    _converter = t.Dict({
        ...
        t.Key('key_summary', optional=True): t.List(t.Dict({
    ...
    def __init__(self, id, project_id=None, name=None, feature_type=None, importance=None,
                 ...
                 time_step=None, time_unit=None, target_leakage=None, key_summary=None):
...
class DatasetFeature(APIObject):
    ...
    def __init__(self, id_, dataset_id=None, dataset_version_id=None, name=None, feature_type=None,
                 low_information=None, unique_count=None, na_count=None, date_format=None,
                 min_=None, max_=None, mean=None, median=None, std_dev=None,
                 time_series_eligible=None, time_series_eligibility_reason=None,
                 time_step=None, time_unit=None, target_leakage=None, target_leakage_reason=None):
        self.id = id_

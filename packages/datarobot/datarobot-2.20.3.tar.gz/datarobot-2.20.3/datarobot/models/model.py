...
from datarobot.models.validators import (feature_impact_trafaret,
                                         multiclass_feature_impact_trafaret)
...
class Model(APIObject):
    ...
    _converter = t.Dict({
        ...
        t.Key('parentModelId', optional=True): t.String() | t.Null,
    ...
    def request_feature_effect(self):
        """
    ...
    def get_or_request_feature_effect(self, source, max_wait=DEFAULT_MAX_WAIT):
        """

...
from datarobot.enums import (CV_METHOD, DEFAULT_MAX_WAIT, DIFFERENCING_METHOD,
                             PERIODICITY_MAX_TIME_STEP, SERIES_AGGREGATION_TYPE, TIME_UNITS,
...
_start_end_backtest_fields = {
    'primary_training_start_date', 'primary_training_end_date',
...
class BacktestSpecification(object):
    ...
    """
    def __init__(self, index, gap_duration=None, validation_start_date=None,
                 validation_duration=None, validation_end_date=None,
                 primary_training_start_date=None, primary_training_end_date=None):
        self.index = index
    ...
    def collect_payload(self):
        ...
        if all(getattr(self, field, None) for field in _duration_backtest_fields):
            payload.update({field: getattr(self, field, None)
                            for field in _duration_backtest_fields})
...
class DatetimePartitioningSpecification(PartitioningMethod):
    ...
    def __init__(self, datetime_partition_column, autopilot_data_selection_method=None,
                 ...
                 multiseries_id_columns=None, use_cross_series_features=None,
                 aggregation_type=None, cross_series_group_by_columns=None, calendar_id=None,
                 holdout_end_date=None, unsupervised_mode=False, model_splits=None,
                 ):

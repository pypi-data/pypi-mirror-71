...
class Accuracy(APIObject, DeploymentQueryBuilderMixin):
    ...
    def __repr__(self):
        return encode_utf8_if_py2(u'{}({} | {} - {})'.format(
            self.__class__.__name__, self.model_id,
            self.period.get('start'), self.period.get('end')))
    ...
    def get(cls, deployment_id, model_id=None, start_time=None, end_time=None):
        ...
        params = cls._build_query_params(start_time=start_time,
                                         end_time=end_time,
                                         model_id=model_id)
...
class AccuracyOverTime(APIObject, DeploymentQueryBuilderMixin):
    ...
    def __repr__(self):
        ...
        return encode_utf8_if_py2(u'{}({} | {} | {} - {})'.format(
            self.__class__.__name__, self.model_id, self.metric,
            period.get('start'), period.get('end')))

    @classmethod
    def get(cls, deployment_id, metric=None, model_id=None, start_time=None, end_time=None,
            bucket_size=None):
    ...
    @classmethod
    def get_as_dataframe(cls, deployment_id, metrics, model_id=None,
        ...
        for metric_name in metrics:
            fetched = AccuracyOverTime.get(deployment_id, model_id=model_id, metric=metric_name,

...
from datarobot import Predictions, errors
        ...
        'predictions': [
            {
                ...
                'rowId': 0,
                'predictionValues': [
                    {'value': 0.311178247734139, 'label': 1.0},
                    {'value': 0.6888217522658611, 'label': 0.0},
                ],
                'predictionExplanationMetadata': {'shapRemainingTotal': -4.4638308071119235e-05},
...
def test_get_predictions_with_shap_explanations(
    ...
    assert predictions.shap_warnings[
               'mismatch_row_count'

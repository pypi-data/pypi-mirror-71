...
class Project(APIObject):
    ...
    feature_engineering_graphs: list, optional
        information about feature engineering graph such as id of the graph and linkage_keys used
        to connect relationships in the graph.
    ...
    _advanced_options_converter = t.Dict({
        ...
        t.Key('allowed_pairwise_interaction_groups',
              optional=True): t.List(t.List(t.String)) | t.Null(),
    ...
    _converter = t.Dict({
        ...
        t.Key('feature_engineering_graphs', optional=True): t.List(
            _feature_engineering_graph_converter, max_length=10),
    ...
    def __init__(self, id=None, project_name=None, mode=None, target=None,
                 ...
                 feature_engineering_graphs=None, credentials=None,
    ...
    @classmethod
    def create_from_dataset(cls, dataset_id, dataset_version_id=None, project_name=None, user=None,
                            password=None, credential_id=None, use_kerberos=None):
        """
    ...
    def set_target(self, target=None,
                   ...
                   target_type=None,
                   feature_engineering_graphs=None,
                   credentials=None,
        ...
        mode : str, optional
            ...
            * ``AUTOPILOT_MODE.QUICK``
            ...
            If unspecified, ``FULL_AUTO`` is used. If the ``MANUAL`` value is used, the model
        ...
        feature_engineering_graphs: list, optional
            information about feature engineering graph such as id of the graph and linkage_keys
            used to connect relationships in the graph.
        credentials: list, optional,
            a list of credentials for the feature engineering graphs.
        feature_engineering_prediction_point : str, optional
            additional aim parameter.
        ...
        if feature_engineering_graphs is not None:
            aim_payload['feature_engineering_graphs'] = feature_engineering_graphs
    ...
    def upload_dataset(self, sourcedata,
        ...
        sourcedata : str, file or pandas.DataFrame
            ...
            a publicly accessible URL (starting with ``http://``, ``https://``, ``file://``,
            or ``s3://``), or raw file content. If using a file on disk, the filename must
    ...
    def upload_dataset_from_data_source(
            self, data_source_id, username, password,
            max_wait=DEFAULT_MAX_WAIT, forecast_point=None,
            relax_known_in_advance_features_check=None, credentials=None,
            predictions_start_date=None, predictions_end_date=None, actual_value_column=None,
    ):
        """
    ...
    def get_association_featurelists(self):
        ...
        """
        url = '{}{}/featureAssociationFeaturelists/'.format(self._path, self.id)
    ...
    def create_type_transform_feature(self, name, parent_name, variable_type, replacement=None,
        ...
        if variable_type == VARIABLE_TYPE_TRANSFORM.CATEGORICAL:
            ...
            deprecation_warning('CATEGORICAL transform',
    ...
    def start_autopilot(self, featurelist_id):
        """Starts autopilot on provided featurelist, halting the current autopilot run. Will raise
        an error if autopilot has already started on this featurelist (whether via
        ``start_autopilot`` or ``set_target``.
    ...
    def train_datetime(self, blueprint_id, featurelist_id=None,
                       training_row_count=None, training_duration=None, source_project_id=None,
                       monotonic_increasing_featurelist_id=MONOTONICITY_FEATURELIST_DEFAULT,
                       monotonic_decreasing_featurelist_id=MONOTONICITY_FEATURELIST_DEFAULT,
    ...
    def share(self, access_list, send_notification=None,
        ...
        include_feature_discovery_entities : boolean, default ``False``
            ...
            related entities (feature engineering graphs and datasets) for a project
            with Feature Discovery enabled
    ...
    def create_interaction_feature(self, name, features, separator, max_wait=DEFAULT_MAX_WAIT):
        ...
        if len(features) != 2:
            msg = 'Exactly two categorical feature names required, got {}'.format(
                len(features)
            )
            raise ValueError(msg)

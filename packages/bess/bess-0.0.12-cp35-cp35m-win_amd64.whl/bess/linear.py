...
class bess_base:
    def __init__(self, algorithm_type, model_type, path_type, max_iter=20, exchange_num=0, is_warm_start=False,
                 sequence=None, lambda_sequence=None, s_min=None, s_max=None, K_max=None, epsilon=0.0001, lambda_min=0, lambda_max=0,
                 ic_type="aic",
                 is_cv=False, K=5, is_screening=False):
    ...
    def fit(self, X, y, is_weight=False, is_normal=True, weight=None, state=None):
        self.p = X.shape[1]
        n = X.shape[0]
        p = X.shape[1]
        ...
        if self.path_type_int == 1:
            if self.sequence is None:
                self.sequence = [(i+1) for i in range(min(p, int(n/np.log(n))))]
...
class PdasLm(bess_base):
    """
        ...
        >>> model.predict(x)
        """
    def __init__(self, max_iter=20, exchange_num=0, path_type="seq", is_warm_start=True, sequence=None, s_min=None, s_max=None,
                 K_max=None, epsilon=0.0001, ic_type="ebic", is_cv=False, K=5, is_screening=False
                 ):
        super(PdasLm, self).__init__(
            ...
            epsilon=epsilon, ic_type=ic_type, is_cv=is_cv, K=K, is_screening=is_screening)
        self.data_type = 1
...
class PdasLogistic(bess_base):
    ...
    def __init__(self, max_iter=20, exchange_num=0, path_type="seq", is_warm_start=True, coef0=0, sequence=None, s_min=None, s_max=None,
                 K_max=None, epsilon=0.0001, ic_type="ebic", is_cv=False, K=5, is_screening=False
                 ):

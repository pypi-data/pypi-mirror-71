...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '0.0.1-alpha.1592391861+77615ad0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 0.0.1-alpha.1592391861+77615ad0`
                """)
            else:
                raise

...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '0.0.1-alpha.1592249514+1fc89e28'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 0.0.1-alpha.1592249514+1fc89e28`
                """)
            else:
                raise

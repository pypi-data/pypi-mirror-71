...
from inforion.ionapi.MMS import AddItmBasic,MMS021,MMS021bulk,MMS021bulk2,CRS610bulk,CRS610,CRS610bulk2
...
def main():
    ...
    try:
        opts, args = getopt.getopt(argv, "h:u:f:m:i:o:s:e:", ["url", "ionfile","method","inputfile","outputfile","start","end"])
    ...
    if method == "checklogin":
        ...
        token=login(url,config)
        headers = header(config,token)
        return CRS610bulk(url,headers,inputfile,'CRS610MI',outputfile,1001,2000)

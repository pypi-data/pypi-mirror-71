...
def drilldown(grid, row='Total', col='Total', view='Default', output=None):
    return gridRequest({'GridId':getGridId(grid), 'DrilldownRow':row, 'DrilldownCol':col, 'DrilldownView':view}, output)

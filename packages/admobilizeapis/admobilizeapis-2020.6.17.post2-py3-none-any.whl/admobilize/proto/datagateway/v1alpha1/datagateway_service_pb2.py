...
_CREATEJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='device_ids', full_name='admobilize.datagateway.v1alpha1.CreateJobRequest.device_ids', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cms', full_name='admobilize.datagateway.v1alpha1.CreateJobRequest.cms', index=5,

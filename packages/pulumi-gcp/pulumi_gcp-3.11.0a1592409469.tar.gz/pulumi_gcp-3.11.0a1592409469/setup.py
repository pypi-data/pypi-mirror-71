...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.11.0-alpha.1592409469+708d0ed5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.11.0-alpha.1592409469+708d0ed5`
                """)
            else:
                raise

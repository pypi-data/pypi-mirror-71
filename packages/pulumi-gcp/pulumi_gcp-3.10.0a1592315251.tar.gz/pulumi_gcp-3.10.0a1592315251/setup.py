...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.10.0-alpha.1592315251+1fa0ce1c'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.10.0-alpha.1592315251+1fa0ce1c`
                """)
            else:
                raise

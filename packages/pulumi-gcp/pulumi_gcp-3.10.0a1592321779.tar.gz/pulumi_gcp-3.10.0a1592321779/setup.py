...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '3.10.0-alpha.1592321779+09cdfdc8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 3.10.0-alpha.1592321779+09cdfdc8`
                """)
            else:
                raise

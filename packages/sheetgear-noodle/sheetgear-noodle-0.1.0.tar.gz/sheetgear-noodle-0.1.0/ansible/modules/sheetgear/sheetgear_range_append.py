...
from sheetgear.bridge.xargs import (create_range_append_argspec, extract_range_append_args)
...
def main():
  ...
  module = AnsibleModule(argument_spec=create_range_append_argspec(), supports_check_mode=True)

  constructor_args, sheet_args, action_args = extract_range_append_args(module.params)
  ...
  try:
    _packet = SpreadsheetHandler(**constructor_args).openSheet(**sheet_args).append(**action_args)

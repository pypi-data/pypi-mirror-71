...
from sheetgear.bridge.xargs import (create_range_query_argspec, extract_range_query_args)
...
def main():
  ...
  module = AnsibleModule(argument_spec=create_range_query_argspec(), supports_check_mode=True)

  constructor_args, sheet_args, action_args = extract_range_query_args(module.params)
  ...
  try:
    _packet = SpreadsheetHandler(**constructor_args).openSheet(**sheet_args).delete_by_query(**action_args)

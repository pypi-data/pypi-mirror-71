...
class Handler:
    ...
    def shorteningService(self):
        ...
        shortening_services = str(pathlib.Path(__file__).parent.absolute()) + r'\data\shortening_services.txt'
    ...
    def SSLFinalState(self):
        ...
        if(havingIP==1):
            ...
            ssl_list = str(pathlib.Path(__file__).parent.absolute()) + r'\data\ssl_list.txt'
    ...
    def domainRegistration(self):
        edu_domains = str(pathlib.Path(__file__).parent.absolute()) + r'\data\edu_domains.txt'
    ...
    def rightClickDisabled(self):
        ...
        if('windows' in OS):
            chromedriver_windows = str(pathlib.Path(__file__).parent.absolute()) + r'\dependencies\windows\chromedriver.exe'
            driver = webdriver.Chrome(executable_path=chromedriver_windows, options=chrome_options)
        elif('linux' in OS):
            chromedriver_linux = str(pathlib.Path(__file__).parent.absolute()) + r'\dependencies\linux\chromedriver'
            driver = webdriver.Chrome(executable_path=chromedriver_linux, options=chrome_options)
        elif('darwin' in OS):
            chromedriver_macOS = str(pathlib.Path(__file__).parent.absolute()) = r'\dependencies\macOS\chromedriver'

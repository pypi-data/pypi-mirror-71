...
########################################## OPTIMIZING FUNCTIONS #########################
    def opt_Adadelta(self, lr):
      ...
      opt.minimize(self.get_loss, [self.WeightX, self.Bias, self.WeightY])
    ...
    def opt_GD(self,lr):
        with tf.GradientTape() as t:
            wx_grad, b_grad, wy_grad = t.gradient(self.get_loss(), [self.WeightX, self.Bias, self.WeightY] )

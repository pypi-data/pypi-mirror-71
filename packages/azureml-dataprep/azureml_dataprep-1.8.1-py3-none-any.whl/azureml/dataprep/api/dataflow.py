...
class Dataflow:
    ...
    def write_to_csv(self,
                     ...
                     na: str = 'NA',
                     error: str = 'ERROR',
                     cleanup_outputpath: bool = False) -> 'Dataflow':
        """
        ...
        :param cleanup_outputpath: Boolean to decide if output path(file/dir) should be cleaned up/deleted before we
        write gulp fastdev
        out the output in the specified path.
        ...
        if isinstance(directory_path, FileOutput):
            return self.add_step('Microsoft.DPrep.WriteToCsvBlock', {
                ...
                'na': na,
                'error': error,
                'cleanupOutputPath': cleanup_outputpath
            })
    ...
    def write_to_parquet(self,
        ...
        :param cleanup_outputpath: Boolean to decide if output path(file/dir) should be cleaned up
        (i.e. deleted if file/dir exists) before we write out the output in the specified path.
        :return: The modified Dataflow.
        """
    ...
    def write_to_preppy(self, directory_path: DataDestination, cleanup_outputpath: bool = False) -> 'Dataflow':
        """
        ...
        :param cleanup_outputpath: Boolean to decide if output path(file/dir) should be cleaned up/deleted before we write
        out the output in the specified path.        :return: The modified Dataflow.
        """
        if directory_path and isinstance(directory_path, str):
            directory_path = FileOutput.file_output_from_str(directory_path)

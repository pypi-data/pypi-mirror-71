...
class itkCheckerBoardImageFilterICF2(itk.itkImageToImageFilterBPython.itkImageToImageFilterICF2ICF2):
    ...
    \\sphinx \\sphinxexample{Filtering/ImageCompare/CombineTwoImagesWi
    thCheckerBoardPattern,Combine Two Images With Checker Board Pattern}
    \\endsphinx
...
def checker_board_image_filter_init_docstring():
    ...
    checker_board_image_filter.__doc__ += "Available Keyword Arguments:\n"

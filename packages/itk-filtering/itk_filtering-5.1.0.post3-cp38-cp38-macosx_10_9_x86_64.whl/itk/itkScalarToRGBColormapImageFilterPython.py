...
class itkScalarToRGBColormapImageFilterID2IRGBAUC2(itk.itkImageToImageFilterBPython.itkImageToImageFilterID2IRGBAUC2):
    ...
    See:  BinaryFunctionImageFilter TernaryFunctionImageFilter  \\sphinx
    \\sphinxexample{Filtering/Colormap/CreateACustomColormap, Create A
    Custom Colormap}
    \\sphinxexample{Filtering/Colormap/ApplyAColormapToAnImage,Apply A
    Colormap To An Image} \\endsphinx

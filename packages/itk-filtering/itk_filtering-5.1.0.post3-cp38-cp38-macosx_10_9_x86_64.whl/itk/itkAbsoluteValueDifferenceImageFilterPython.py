...
class itkAbsoluteValueDifferenceImageFilterID2ID2ID2(itk.itkBinaryGeneratorImageFilterPython.itkBinaryGeneratorImageFilterID2ID2ID2):
    ...
    \\sphinx
    \\sphinxexample{Filtering/ImageCompare/AbsValueOfTwoImages,Absolute
    Value Of Difference Between Two Images} \\endsphinx
...
def absolute_value_difference_image_filter_init_docstring():
    ...
    absolute_value_difference_image_filter.__doc__ += "Available Keyword Arguments:\n"

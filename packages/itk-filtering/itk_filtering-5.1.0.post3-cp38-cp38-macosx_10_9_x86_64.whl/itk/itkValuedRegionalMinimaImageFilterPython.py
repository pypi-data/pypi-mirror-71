...
class itkValuedRegionalMinimaImageFilterID2ID2(itkValuedRegionalMinimaImageFilterID2ID2_Superclass):
    ...
    See:   HMinimaImageFilter  \\sphinx
    \\sphinxexample{Filtering/MathematicalMorphology/ValuedR
    egionalMinimalImage,Valued Regional Minimal Image} \\endsphinx
...
def valued_regional_minima_image_filter_init_docstring():
    ...
    valued_regional_minima_image_filter.__doc__ += "Available Keyword Arguments:\n"
...
def valued_regional_extrema_image_filter_init_docstring():
    ...
    valued_regional_extrema_image_filter.__doc__ += "Available Keyword Arguments:\n"

...
class itkOtsuThresholdImageFilterID2ISS2(itk.itkHistogramThresholdImageFilterPython.itkHistogramThresholdImageFilterID2ISS2):
    ...
    See:   HistogramThresholdImageFilter  \\sphinx
    \\sphinxexample{Filtering/Thresholding/SeparateGroundUsi
    ngOtsu,Separate Foreround And Background Using Otsu Method}
    \\endsphinx
...
def otsu_threshold_image_filter_init_docstring():
    ...
    otsu_threshold_image_filter.__doc__ += "Available Keyword Arguments:\n"

...
class itkLiThresholdImageFilterID2ISS2(itk.itkHistogramThresholdImageFilterPython.itkHistogramThresholdImageFilterID2ISS2):
    ...
    \\sphinxexample{Filtering/Thresholding/DemonstrateThresh
    oldAlgorithms,Demonstrate Available Threshold Algorithms}
    \\endsphinx
...
def li_threshold_image_filter_init_docstring():
    ...
    li_threshold_image_filter.__doc__ += "Available Keyword Arguments:\n"

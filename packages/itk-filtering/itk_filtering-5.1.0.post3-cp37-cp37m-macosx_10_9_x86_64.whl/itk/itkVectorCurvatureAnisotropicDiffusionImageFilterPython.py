...
class itkVectorCurvatureAnisotropicDiffusionImageFilterICVF22ICVF22(itk.itkAnisotropicDiffusionImageFilterPython.itkAnisotropicDiffusionImageFilterICVF22ICVF22):
    ...
    See:  CurvatureNDAnisotropicDiffusionFunction  \\sphinx
    \\sphinxexample{Filtering/AnisotropicSmoothing/SmoothIma
    geWhilePreservingEdges2,Smooth Image While Preserving Edges
    (Curvature)} \\endsphinx
...
def vector_curvature_anisotropic_diffusion_image_filter_init_docstring():
    ...
    vector_curvature_anisotropic_diffusion_image_filter.__doc__ += "Available Keyword Arguments:\n"

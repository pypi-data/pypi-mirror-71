...
class itkBinaryMorphologicalOpeningImageFilterID2ID2SE2(itk.itkFlatStructuringElementPython.itkKernelImageFilterID2ID2SE2):
    ...
    GrayscaleErodeImageFilter  \\sphinx
    \\sphinxexample{Filtering/BinaryMathematicalMorphology/O
    peningBinaryImage,Opening A Binary Image} \\endsphinx
...
def binary_morphological_opening_image_filter_init_docstring():
    ...
    binary_morphological_opening_image_filter.__doc__ += "Available Keyword Arguments:\n"

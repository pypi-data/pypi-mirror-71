...
class itkFlatStructuringElement2(itk.itkNeighborhoodPython.itkNeighborhoodB2):
    ...
    \\sphinx \\sphinxexample{Filtering/MathematicalMorphology/ErodeBin
    aryImageUsingFlatStruct,Erode Binary Image Using Flat Structure
    Element} \\endsphinx \\sphinx \\sphinxexample{Filtering/Mathemat
    icalMorphology/GenerateStructureElementsWithAccurateArea,Generate
    Structuring Elements With Accurate Area} \\endsphinx

...
class itkDerivativeImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    \\sphinxexample{Filtering/ImageFeature/DerivativeImage,Apply A
    Filter Only To A Specified Region Of An Image}
    \\sphinxexample{Filtering/ImageFeature/RequesterRegion, Apply A
    Filter Only To A Specified Region Of An Image} \\endsphinx

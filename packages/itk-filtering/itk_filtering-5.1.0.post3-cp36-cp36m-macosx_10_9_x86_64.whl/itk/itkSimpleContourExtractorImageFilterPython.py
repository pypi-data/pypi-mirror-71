...
class itkSimpleContourExtractorImageFilterID2ID2(itk.itkBoxImageFilterPython.itkBoxImageFilterID2ID2):
    ...
    \\sphinx \\sphinxexample{Filtering/ImageFeature/ExtractContoursFro
    mImage,Extract Contours From Image} \\endsphinx See:  Image
...
def simple_contour_extractor_image_filter_init_docstring():
    ...
    simple_contour_extractor_image_filter.__doc__ += "Available Keyword Arguments:\n"

...
class itkGradientMagnitudeRecursiveGaussianImageFilterID2ID2(itk.itkInPlaceImageFilterAPython.itkInPlaceImageFilterID2ID2):
    ...
    \\sphinx \\sphinxexample{Filtering/ImageGradient/ComputeGradientMa
    gnitude,Compute Gradient Magnitude Of Grayscale Image} \\endsphinx
...
def gradient_magnitude_recursive_gaussian_image_filter_init_docstring():
    ...
    gradient_magnitude_recursive_gaussian_image_filter.__doc__ += "Available Keyword Arguments:\n"

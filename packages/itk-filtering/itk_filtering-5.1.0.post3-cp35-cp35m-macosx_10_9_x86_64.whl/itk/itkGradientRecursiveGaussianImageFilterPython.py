...
class itkGradientRecursiveGaussianImageFilterID2ICVF22(itk.itkImageToImageFilterBPython.itkImageToImageFilterID2ICVF22):
    ...
    \\sphinx \\sphinxexample{Filtering/ImageGradient/ApplyGradientRecu
    rsiveGaussianWithVectorInput,Apply
    GradientRecursiveGaussianImageFilter on Image with Vector type}
    \\sphinxexample{Filtering/ImageGradient/
    ImplementationOfSnakes,Implementation Of Snakes} \\endsphinx

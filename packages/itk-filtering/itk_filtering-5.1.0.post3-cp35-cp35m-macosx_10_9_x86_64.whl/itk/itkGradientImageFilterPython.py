...
class itkGradientImageFilterID2FF(itk.itkImageToImageFilterBPython.itkImageToImageFilterID2ICVF22):
    ...
    \\sphinxexample{Filtering/ImageGradient/GradientOfVector
    Image,Gradient Of Vector Image} \\sphinxexample{Filtering/ImageGradi
    ent/ComputeAndDisplayGradient,Compute And Display Gradient Of Image}
    \\endsphinx
...
def gradient_image_filter_init_docstring():
    ...
    gradient_image_filter.__doc__ += "Available Keyword Arguments:\n"

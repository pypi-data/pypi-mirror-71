...
class itkBinaryNotImageFilterISS2(itkBinaryNotImageFilterISS2_Superclass):
    ...
    \\sphinx
    \\sphinxexample{Filtering/LabelMap/InvertImageUsingBinaryNot,Invert
    Image Using Binary Not Operation} \\endsphinx
...
def binary_not_image_filter_init_docstring():
    ...
    binary_not_image_filter.__doc__ += "Available Keyword Arguments:\n"

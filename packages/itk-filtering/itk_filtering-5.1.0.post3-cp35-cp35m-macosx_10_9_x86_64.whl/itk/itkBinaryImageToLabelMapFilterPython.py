...
class itkBinaryImageToLabelMapFilterIUC2LM2(itk.ITKLabelMapBasePython.itkImageToImageFilterIUC2LM2):
    ...
    LabelMap, LabelObject  \\sphinx
    \\sphinxexample{Filtering/LabelMap/LabelBinaryRegionsInImage,Label
    Binary Regions In Image} \\endsphinx
...
def binary_image_to_label_map_filter_init_docstring():
    ...
    binary_image_to_label_map_filter.__doc__ += "Available Keyword Arguments:\n"

...
class itkSobelEdgeDetectionImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    \\sphinxexample{Filtering/ImageFeature/SobelEdgeDetectio
    nImageFilter,Sobel Edge Detection Image Filter} \\endsphinx
...
def sobel_edge_detection_image_filter_init_docstring():
    ...
    sobel_edge_detection_image_filter.__doc__ += "Available Keyword Arguments:\n"

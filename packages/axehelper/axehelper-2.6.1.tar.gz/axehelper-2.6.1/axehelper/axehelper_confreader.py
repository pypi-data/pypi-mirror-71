...
class AXEhelper_ConfReader:
    '''
    AXEhelper_ConfReader (using Python 3) reads aXe configuration files.
    obj = AXEhelper_ConfReader(conffile) to assign the configuration file

...
[boto3.ApiGatewayManagementApi 1.14.3](https://boto3.amazonaws.com/v1/documentation/api/1.14.3/reference/services/apigatewaymanagementapi.html#ApiGatewayManagementApi) service

...
tau_ref = 3.93E-9
frequency = 40E6
ref = Path('G:\\', 'SurfDrive', 'Data', '2019', '04', '29', '2019-04-10_14.25.59_reference_R6G.fli')
sam = Path('G:\\', 'SurfDrive', 'Data', '2019', '04', '29', '2019-04-09_15.51.21_sample_IsoP_Fors.fli')
ref = FliFile(ref)
sam = FliFile(sam)
refdat = ref.getdata()
samdat = sam.getdata()

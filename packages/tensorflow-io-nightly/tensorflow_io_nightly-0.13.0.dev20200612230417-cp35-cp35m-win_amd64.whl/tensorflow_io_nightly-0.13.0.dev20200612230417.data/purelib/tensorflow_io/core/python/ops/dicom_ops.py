...
class dicom_tags:  # pylint: disable=invalid-name
    ...
    OffsetoftheFirstDirectoryRecordoftheRootDirectoryEntity = int("00041200", 16)
    OffsetoftheLastDirectoryRecordoftheRootDirectoryEntity = int("00041202", 16)
    ...
    AnatomicLocationOfExaminingInstrumentCodeSequenceTrial = int("00082259", 16)
    AnatomicStructureSpaceOrRegionModifierCodeSequenceTrial = int("0008225A", 16)
    ...
    OphthalmicAxialLengthMeasurementsSegmentNameCodeSequence = int("00221101", 16)
    ...
    OphthalmicAxialLengthMeasurementsSegmentalLengthSequence = int("00221211", 16)
    OphthalmicAxialLengthMeasurementsLengthSummationSequence = int("00221212", 16)
    ...
    ReferencedOphthalmicAxialLengthMeasurementQCImageSequence = int("00221330", 16)
    ...
    WideFieldOphthalmicPhotographyQualityThresholdSequence = int("00221526", 16)
    ...
    GeneralizedDefectSensitivityDeviationAlgorithmSequence = int("00240067", 16)
    ...
    CorrectedLocalizedDeviationFromNormalProbabilityCalculated = int("00240080", 16)
    ...
    GeneralizedDefectCorrectedSensitivityDeviationProbabilityValue = int("00240104", 16)
    ...
    PerformedProcedureStepDiscontinuationReasonCodeSequence = int("00400281", 16)
    ...
    ResultingGeneralPurposePerformedProcedureStepsSequence = int("00404015", 16)
    ReferencedGeneralPurposeScheduledProcedureStepSequence = int("00404016", 16)
    ...
    ReferencedGeneralPurposeScheduledProcedureStepTransactionUID = int("00404023", 16)
    ...
    SegmentSurfaceGenerationAlgorithmIdentificationSequence = int("0066002D", 16)
    ...
    ImplantTemplateGroupMemberMatching2DCoordinatesSequence = int("00780070", 16)

...
---------------------- INPUT FILES ---------------------------------------------
"tuning_files/OC4Semi_tuning_fine_ElastoDyn.dat"  EDFile  - Name of file containing ElastoDyn input parameters (quoted string)
...
"hydrodyn_fine_temp.dat"  HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)

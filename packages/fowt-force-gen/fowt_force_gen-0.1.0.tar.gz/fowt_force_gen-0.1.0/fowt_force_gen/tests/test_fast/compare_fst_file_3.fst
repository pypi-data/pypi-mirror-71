...
---------------------- INPUT FILES ---------------------------------------------
"fast_input_files/OC4Semi_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
file1  BDBldFile(1)  - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"    BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
file3  BDBldFile(3)  - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"placeholder"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"fast_input_files/NRELOffshrBsline5MW_OC3Hywind_AeroDyn15.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"fast_input_files/OC4Semi_ServoDyn.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"placeholder"    HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
"unused"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
"placeholder"    MooringFile     - Name of file containing mooring system input parameters (quoted string)
...
False         SumPrint        - Print summary data to "<RootName>.sum" (flag)
      ...
      99999   ChkptTime       - Amount of time between creating checkpoint files for potential restart (s)
       0.05   DT_Out          - Time step for tabular output (s) (or "default")
        600   TStart          - Time to begin tabular output (s)

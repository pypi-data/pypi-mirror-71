...
---------------------- INPUT FILES ---------------------------------------------
"tuning_files/OC4Semi_tuning_rough_ElastoDyn.dat"  EDFile  - Name of file containing ElastoDyn input parameters (quoted string)
...
"hydrodyn_rough_temp.dat"  HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"unused"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
"moordyn_temp.dat"  MooringFile   - Name of file containing mooring system input parameters (quoted string)

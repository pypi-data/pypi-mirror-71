...
"tests/test_fast/test_fst_bulk/compare_inflowwind_11.4mps_180deg.dat"  InflowFile  - Name of file containing inflow wind input parameters (quoted string)
...
"tests/test_fast/test_fst_bulk/compare_hydrodyn_Climate1.dat"  HydroFile   - Name of file containing hydrodynamic input parameters (quoted string)
"unused"      SubFile         - Name of file containing sub-structural input parameters (quoted string)
"tests/test_fast/compare_md_file_1.dat"  MooringFile   - Name of file containing mooring system input parameters (quoted string)

...
class Pinterest:
    ...
    def follow(self, user_name: str) -> bool:
        try:
            ...
            follow_container = self.browser.find(By.XPATH, "//div[contains(@class, 'CreatorFollowButton step0')]")
            ...
            follow_button = self.browser.find(By.XPATH, "//div[contains(@class, 'tBJ dyH iFc yTZ pBj tg7 mWe')]", timeout=3) or self.browser.find(By.XPATH, "//div[contains(@class, 'tBJ dyH iFc yTZ erh tg7 mWe')]", timeout=3)

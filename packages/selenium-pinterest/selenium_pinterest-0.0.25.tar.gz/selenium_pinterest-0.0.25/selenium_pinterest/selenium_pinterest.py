...
class Pinterest:
    ...
    def follow(self, user_name: str) -> bool:
        try:
            ...
            follow_button = self.browser.find(By.XPATH, "//div[contains(@class, 'tBJ dyH iFc yTZ pBj tg7 mWe')]", follow_container, timeout=5) or self.browser.find(By.XPATH, "//div[contains(@class, 'tBJ dyH iFc yTZ erh tg7 mWe')]", follow_container, timeout=3)

...
def score_g_id(sta_ob_and_fos0,method,s = None,plot = None,save_path = None,show = False,dpi = 300,**kwargs):
    g = "id"
    sta_ob_and_fos1 = meteva.base.sele_by_dict(sta_ob_and_fos0,s = s)
    result,id_list= score(sta_ob_and_fos1,method,g = g,**kwargs)

...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '0.0.1-alpha.1592249754+018b181a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 0.0.1-alpha.1592249754+018b181a`
                """)
            else:
                raise

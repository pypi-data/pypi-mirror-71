...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '0.0.1-alpha.1592391347+271976fe'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 0.0.1-alpha.1592391347+271976fe`
                """)
            else:
                raise

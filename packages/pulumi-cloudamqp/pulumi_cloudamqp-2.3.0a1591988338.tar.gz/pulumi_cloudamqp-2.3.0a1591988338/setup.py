...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', '2.3.0-alpha.1591988338+f8e74a3d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp 2.3.0-alpha.1591988338+f8e74a3d`
                """)
            else:
                raise

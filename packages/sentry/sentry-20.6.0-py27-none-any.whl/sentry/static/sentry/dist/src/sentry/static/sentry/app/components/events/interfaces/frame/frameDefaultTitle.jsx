...
var FrameDefaultTitle = function (_a) {
    ...
    if (defined(frame.filename || frame.module)) {
        ...
        var enablePathTooltip = defined(frame.absPath) && frame.absPath !== pathName.value;
        ...
        if (frame.absPath && isUrl(frame.absPath)) {
            title.push(<ExternalLink href={frame.absPath} className="icon-open" key="share" onClick={handleExternalLink}/>);
        }
    ...
    if (defined(frame.origAbsPath)) {
        title.push(<Tooltip key="info-tooltip" title={<FrameDefaultTitleOriginalSourceInfo mapUrl={frame.mapUrl} map={frame.map}/>}>
...
//# sourceMappingURL=frameDefaultTitle.jsx.map
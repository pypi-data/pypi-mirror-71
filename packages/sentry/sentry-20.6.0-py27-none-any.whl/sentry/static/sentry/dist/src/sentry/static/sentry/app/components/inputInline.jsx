...
var InputInline = /** @class */ (function (_super) {
    ...
    InputInline.setValueOnEvent = function (event) {
        var text = event.target.innerText || event.currentTarget.innerText;
...
var Input = styled('div')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  min-width: 40px;\n  margin: 0;\n  border: 1px solid ", ";\n  outline: none;\n\n  line-height: inherit;\n  border-radius: ", ";\n  background: transparent;\n\n  &:focus,\n  &:active {\n    border: 1px solid ", ";\n    background-color: ", ";\n  }\n"], ["\n  min-width: 40px;\n  margin: 0;\n  border: 1px solid ", ";\n  outline: none;\n\n  line-height: inherit;\n  border-radius: ", ";\n  background: transparent;\n\n  &:focus,\n  &:active {\n    border: 1px solid ", ";\n    background-color: ", ";\n  }\n"])), function (p) { return (p.isHovering ? p.theme.borderDark : 'transparent'); }, space(0.5), function (p) { return (p.isDisabled ? 'transparent' : p.theme.gray300); }, function (p) { return (p.isDisabled ? 'transparent' : p.theme.gray300); });
var StyledIconEdit = styled(IconEdit)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  color: ", ";\n  margin-left: ", ";\n\n  &:hover {\n    cursor: pointer;\n  }\n"], ["\n  color: ", ";\n  margin-left: ", ";\n\n  &:hover {\n    cursor: pointer;\n  }\n"])), function (p) { return p.theme.gray500; }, space(0.5));

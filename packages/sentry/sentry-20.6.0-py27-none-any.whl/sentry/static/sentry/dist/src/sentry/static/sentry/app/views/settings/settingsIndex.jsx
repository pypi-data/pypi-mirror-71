              ...
              <HomePanelHeader>
                <HomeLinkIcon to={organizationSettingsUrl}>
                  {organization ? (<AvatarContainer>
                    ...
                    </AvatarContainer>) : (<HomeIcon color="green">
                      <IconStack size="lg"/>
                    </HomeIcon>)}
                  <OrganizationName>

...
var AvatarCropper = /** @class */ (function (_super) {
    ...
    AvatarCropper.prototype.render = function () {
        ...
        <div className="form-group">
          ...
          <UploadInput ref={this.file} type="file" accept="image/gif,image/jpeg,image/png" onChange={this.onSelectFile}/>
        </div>
      </React.Fragment>);
    };
...
var Resizer = styled('div')(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  border-radius: 5px;\n  width: 10px;\n  height: 10px;\n  position: absolute;\n  background-color: ", ";\n  cursor: ", ";\n  ", "\n"], ["\n  border-radius: 5px;\n  width: 10px;\n  height: 10px;\n  position: absolute;\n  background-color: ", ";\n  cursor: ", ";\n  ", "\n"])), function (p) { return p.theme.gray500; }, function (p) { return p.position + "-resize"; }, function (p) { return resizerPositions[p.position].map(function (pos) { return pos + ": -5px;"; }); });

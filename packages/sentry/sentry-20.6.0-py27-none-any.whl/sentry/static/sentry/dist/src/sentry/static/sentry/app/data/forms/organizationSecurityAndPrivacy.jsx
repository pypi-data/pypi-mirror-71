...
var organizationSecurityAndPrivacy = [
    {
        ...
        fields: [
            ...
            },
            {
                ...
                help: t('The list of relay public keys that should be trusted. Any relay in this list will be permitted to access org and project configs. Separate multiple entries with a newline.'),
                getValue: function (val) { return extractMultilineFields(val); },
                setValue: function (val) { return (val && typeof val.join === 'function' && val.join('\n')) || ''; },
                visible: function (_a) {
                    var features = _a.features;
...
//# sourceMappingURL=organizationSecurityAndPrivacy.jsx.map
...
export var GridHeadCell = styled('th')(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n  /* By default, a grid item cannot be smaller than the size of its content.\n     We override this by setting min-width to be 0. */\n  position: relative; /* Used by GridResizer */\n  height: ", "px;\n  display: flex;\n  align-items: center;\n  min-width: 24px;\n  padding: 0 ", ";\n\n  border-right: 1px solid transparent;\n  border-left: 1px solid transparent;\n  background-color: ", ";\n  color: ", ";\n\n  font-size: ", ";\n  font-weight: 600;\n  text-transform: uppercase;\n  user-select: none;\n\n  a,\n  div {\n    line-height: 1.1;\n    color: inherit;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    overflow: hidden;\n  }\n\n  &:first-child {\n    border-top-left-radius: ", ";\n  }\n\n  &:last-child {\n    border-top-right-radius: ", ";\n    border-right: none;\n  }\n\n  &:hover {\n    border-left-color: ", ";\n    border-right-color: ", ";\n  }\n"], ["\n  /* By default, a grid item cannot be smaller than the size of its content.\n     We override this by setting min-width to be 0. */\n  position: relative; /* Used by GridResizer */\n  height: ", "px;\n  display: flex;\n  align-items: center;\n  min-width: 24px;\n  padding: 0 ", ";\n\n  border-right: 1px solid transparent;\n  border-left: 1px solid transparent;\n  background-color: ", ";\n  color: ", ";\n\n  font-size: ", ";\n  font-weight: 600;\n  text-transform: uppercase;\n  user-select: none;\n\n  a,\n  div {\n    line-height: 1.1;\n    color: inherit;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n    overflow: hidden;\n  }\n\n  &:first-child {\n    border-top-left-radius: ", ";\n  }\n\n  &:last-child {\n    border-top-right-radius: ", ";\n    border-right: none;\n  }\n\n  &:hover {\n    border-left-color: ", ";\n    border-right-color: ", ";\n  }\n"])), GRID_HEAD_ROW_HEIGHT, space(2), function (p) { return p.theme.gray100; }, function (p) { return p.theme.gray600; }, function (p) { return p.theme.fontSizeSmall; }, function (p) { return p.theme.borderRadius; }, function (p) { return p.theme.borderRadius; }, function (p) { return (p.isFirst ? 'transparent' : p.theme.borderDark); }, function (p) { return p.theme.borderDark; });
/**
 * Create spacing/padding similar to GridHeadCellWrapper but
 * without interactive aspects.
 */
export var GridHeadCellStatic = styled('th')(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  height: ", "px;\n  display: flex;\n  align-items: center;\n  padding: 0 ", ";\n  background-color: ", ";\n  font-size: ", ";\n  font-weight: 600;\n  line-height: 1;\n  text-transform: uppercase;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n\n  &:first-child {\n    border-top-left-radius: ", ";\n    padding: ", " 0 ", " ", ";\n  }\n"], ["\n  height: ", "px;\n  display: flex;\n  align-items: center;\n  padding: 0 ", ";\n  background-color: ", ";\n  font-size: ", ";\n  font-weight: 600;\n  line-height: 1;\n  text-transform: uppercase;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n\n  &:first-child {\n    border-top-left-radius: ", ";\n    padding: ", " 0 ", " ", ";\n  }\n"])), GRID_HEAD_ROW_HEIGHT, space(2), function (p) { return p.theme.gray100; }, function (p) { return p.theme.fontSizeSmall; }, function (p) { return p.theme.borderRadius; }, space(1), space(1), space(3));
/**
...
export var GridResizer = styled('div')(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  position: absolute;\n  top: 0px;\n  right: -6px;\n  width: 11px;\n\n  height: ", "px;\n\n  padding-left: 5px;\n  padding-right: 5px;\n\n  cursor: col-resize;\n  z-index: ", ";\n\n  /**\n   * This element allows us to have a fat GridResizer that is easy to hover and\n   * drag, but still draws an appealing thin line for the border\n   */\n  &::after {\n    content: ' ';\n    display: block;\n    width: 100%; /* Equivalent to 1px */\n    height: 100%;\n  }\n\n  &:hover::after {\n    background-color: ", ";\n  }\n\n  /**\n   * Ensure that this rule is after :hover, otherwise it will flicker when\n   * the GridResizer is dragged\n   */\n  &:active::after,\n  &:focus::after {\n    background-color: ", ";\n  }\n\n  /**\n   * This element gives the resize handle a more visible knob to grab\n   */\n  &:hover::before {\n    position: absolute;\n    top: 0;\n    left: 2px;\n    content: ' ';\n    display: block;\n    width: 7px;\n    height: ", "px;\n    background-color: ", ";\n    opacity: 0.4;\n  }\n"], ["\n  position: absolute;\n  top: 0px;\n  right: -6px;\n  width: 11px;\n\n  height: ",
    ...
    return height;
}, Z_INDEX_GRID_RESIZER, function (p) { return p.theme.borderDark; }, function (p) { return p.theme.purple; }, GRID_HEAD_ROW_HEIGHT, function (p) { return p.theme.purple; });

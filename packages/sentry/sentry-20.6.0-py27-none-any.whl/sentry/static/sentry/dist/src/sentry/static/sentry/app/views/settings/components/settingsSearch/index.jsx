...
var SettingsSearch = /** @class */ (function (_super) {
    ...
    SettingsSearch.prototype.render = function () {
        var _this = this;
        return (<Search {...this.props} entryPoint="settings_search" minSearch={MIN_SEARCH_LENGTH} maxResults={MAX_RESULTS} renderInput={function (_a) {
...
var SearchInputIcon = styled(function (props) { return <InlineSvg src="icon-search" {...props}/>; })(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  color: ", ";\n  position: absolute;\n  left: 10px;\n  top: 8px;\n"], ["\n  color: ", ";\n  position: absolute;\n  left: 10px;\n  top: 8px;\n"])), function (p) { return p.theme.gray500; });
var SearchInput = styled('input')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  transition: border-color 0.15s ease;\n  font-size: 14px;\n  width: 260px;\n  line-height: 1;\n  padding: 5px 8px 4px 28px;\n  border: 1px solid ", ";\n  border-radius: 30px;\n  height: 28px;\n\n  box-shadow: inset ", ";\n\n  &:focus {\n    outline: none;\n    border: 1px solid ", ";\n  }\n\n  &::placeholder {\n    color: ", ";\n  }\n"], ["\n  transition: border-color 0.15s ease;\n  font-size: 14px;\n  width: 260px;\n  line-height: 1;\n  padding: 5px 8px 4px 28px;\n  border: 1px solid ", ";\n  border-radius: 30px;\n  height: 28px;\n\n  box-shadow: inset ", ";\n\n  &:focus {\n    outline: none;\n    border: 1px solid ", ";\n  }\n\n  &::placeholder {\n    color: ", ";\n  }\n"])), function (p) { return p.theme.borderDark; }, function (p) { return p.theme.dropShadowLight; }, function (p) { return p.theme.gray400; }, function (p) { return p.theme.gray500; });

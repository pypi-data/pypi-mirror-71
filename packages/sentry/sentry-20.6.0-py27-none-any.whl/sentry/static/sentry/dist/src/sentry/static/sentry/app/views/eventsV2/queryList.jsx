...
var QueryList = /** @class */ (function (_super) {
    ...
    QueryList.prototype.render = function () {
        ...
        <Pagination pageLinks={pageLinks} onCursor={function (cursor, path, query, direction) {
...
var MoreOptions = styled('span')(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  color: ", ";\n"], ["\n  display: flex;\n  color: ", ";\n"])), function (p) { return p.theme.gray700; });
var DropdownTarget = styled('div')(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n"], ["\n  display: flex;\n"])));
var StyledEmptyStateWarning = styled(EmptyStateWarning)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  grid-column: 1 / 4;\n"], ["\n  grid-column: 1 / 4;\n"])));

...
var IssueAlertOptions = /** @class */ (function (_super) {
    ...
    IssueAlertOptions.prototype.getDefaultState = function () {
        return __assign(__assign({}, _super.prototype.getDefaultState.call(this)), { conditions: [], intervalChoices: [], alertSetting: "" + Actions.CREATE_ALERT_LATER, metric: MetricValues.ERRORS, interval: '', threshold: '' });
    };
    ...
    IssueAlertOptions.prototype.getIssueAlertsChoices = function (hasProperlyLoadedConditions) {
        ...
        if (hasProperlyLoadedConditions) {
          ...
          <InlineSelectControl openMenuOnFocus value={this.state.metric} choices={this.getAvailableMetricChoices()} onChange={function (metric) { return _this.setStateAndUpdateParents({ metric: metric.value }); }} data-test-id="metric-select-control"/>
          {t('a unique error in')}
          <InlineSelectControl value={this.state.interval} openMenuOnFocus choices={this.state.intervalChoices} onChange={function (interval) {

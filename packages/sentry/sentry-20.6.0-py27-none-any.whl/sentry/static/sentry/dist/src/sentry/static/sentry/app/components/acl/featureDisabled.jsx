...
var FeatureDisabled = /** @class */ (function (_super) {
    ...
    FeatureDisabled.prototype.renderFeatureDisabled = function () {
        ...
        <FeatureDisabledMessage>
          {message}
          {!hideHelpToggle && (<HelpButton icon={showHelp ? 'icon-chevron-down' : 'icon-circle-info'} priority="link" size="xsmall" onClick={this.toggleHelp}>
              {t('Help')}
            </HelpButton>)}
        </FeatureDisabledMessage>
        {showDescription && (<HelpDescription>
            <p>
    ...
    FeatureDisabled.prototype.render = function () {
        ...
        return (<AlertComponent type="warning" icon="icon-lock">

...
var ActionButtons = function (_a) {
    ...
    var appDashboardButton = (<StyledButton size="small" icon="icon-stats" to={"/settings/" + org.slug + "/developer-settings/" + app.slug + "/dashboard/"}>
      {t('Dashboard')}
    </StyledButton>);
    var publishRequestButton = showPublish ? (<StyledButton disabled={!!disablePublishReason} title={disablePublishReason} icon="icon-upgrade" size="small" onClick={onPublish}>
      {t('Publish')}
    </StyledButton>) : null;

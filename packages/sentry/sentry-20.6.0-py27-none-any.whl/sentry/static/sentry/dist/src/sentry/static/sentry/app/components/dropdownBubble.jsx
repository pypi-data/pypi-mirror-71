...
var getMenuArrow = function (_a) {
    var menuWithArrow = _a.menuWithArrow, alignMenu = _a.alignMenu;
    if (!menuWithArrow) {
        return '';
    }
    var alignRight = alignMenu === 'right';
    return css(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    top: 32px;\n\n    &::before {\n      width: 0;\n      height: 0;\n      border-left: 9px solid transparent;\n      border-right: 9px solid transparent;\n      border-bottom: 9px solid rgba(52, 60, 69, 0.35);\n      content: '';\n      display: block;\n      position: absolute;\n      top: -9px;\n      left: 10px;\n      z-index: -2;\n      ", ";\n      ", ";\n    }\n\n    &:after {\n      width: 0;\n      height: 0;\n      border-left: 8px solid transparent;\n      border-right: 8px solid transparent;\n      border-bottom: 8px solid #fff;\n      content: '';\n      display: block;\n      position: absolute;\n      top: -8px;\n      left: 11px;\n      z-index: -1;\n      ", ";\n      ", ";\n    }\n  "], ["\n    top: 32px;\n\n    &::before {\n      width: 0;\n      height: 0;\n      border-left: 9px solid transparent;\n      border-right: 9px solid transparent;\n      border-bottom: 9px solid rgba(52, 60, 69, 0.35);\n      content: '';\n      display: block;\n      position: absolute;\n      top: -9px;\n      left: 10px;\n      z-index: -2;\n      ", ";\n      ", ";\n    }\n\n    &:after {\n      width: 0;\n      height: 0;\n      border-left: 8px solid transparent;\n      border-right: 8px solid transparent;\n      border-bottom: 8px solid #fff;\n      content: '';\n      display: block;\n      position: absolute;\n      top: -8px;\n      left: 11px;\n      z-index: -1;\n      ", ";\n      ", ";\n    }\n  "])), alignRight && 'left: auto;', alignRight && 'right: 10px;', alignRight && 'left: auto;', alignRight && 'right: 11px;');
};
var DropdownBubble = styled('div')(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  background: ", ";\n  border: 1px solid ", ";\n  position: absolute;\n  top: calc(100% - 1px);\n  ", ";\n  right: 0;\n  box-shadow: ", ";\n  overflow: hidden;\n\n  ", ";\n  ", ";\n\n  ", ";\n\n  /* This is needed to be able to cover e.g. pagination buttons, but also be\n   * below dropdown actor button's zindex */\n  z-index: ", ";\n\n  ", " & {\n    z-index: ", ";\n  }\n"], ["\n  background: ", ";\n  border: 1px solid ", ";\n  position: absolute;\n  top: calc(100% - 1px);\n  ", ";\n  right: 0;\n  box-shadow: ", ";\n  overflow: hidden;\n\n  ", ";\n  ", ";\n\n  ", ";\n\n  /* This is needed to be able to cover e.g. pagination buttons, but also be\n   * below dropdown actor button's zindex */\n  z-index: ", ";\n\n  " /* sc-selector */, " & {\n    z-index: ", ";\n  }\n"])), function (p) { return p.theme.background; }, function (p) { return p.theme.borderDark; }, function (p) { return (p.width ? "width: " + p.width : ''); }, function (p) { return p.theme.dropShadowLight; }, getMenuBorderRadius, function (_a) {

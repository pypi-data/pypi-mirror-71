...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.10.0-alpha.1592315664+71e30e0a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.10.0-alpha.1592315664+71e30e0a`
                """)
            else:
                raise

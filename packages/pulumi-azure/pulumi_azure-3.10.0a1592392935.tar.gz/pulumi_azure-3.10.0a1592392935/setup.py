...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.10.0-alpha.1592392935+77bd9e3b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.10.0-alpha.1592392935+77bd9e3b`
                """)
            else:
                raise

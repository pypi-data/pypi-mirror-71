...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.10.0-alpha.1592323459+f52655f7'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.10.0-alpha.1592323459+f52655f7`
                """)
            else:
                raise

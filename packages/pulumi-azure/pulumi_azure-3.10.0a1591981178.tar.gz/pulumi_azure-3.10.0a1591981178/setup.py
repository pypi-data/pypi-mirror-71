...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.10.0-alpha.1591981178+gb36166ba'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.10.0-alpha.1591981178+gb36166ba`
                """)
            else:
                raise

...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.9.0-alpha.1591894392+gad24a6b5'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.9.0-alpha.1591894392+gad24a6b5`
                """)
            else:
                raise

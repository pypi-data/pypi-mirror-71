...
def fetch_geoms_2d_by_inference_execution(
    ...
    df = process_pose_data.honeycomb_io.fetch_2d_pose_data_by_inference_execution(
...
def fetch_geoms_2d_by_time_span(
    ...
    logger.info('Fetching pose data')
    df = process_pose_data.honeycomb_io.fetch_2d_pose_data_by_time_span(
...
def create_geom_collection_2d_dict(
    ...
    pose_model_id = process_pose_data.honeycomb_io.extract_pose_model_id(df)
    logger.info('Fetching pose model info')
    pose_model_info = process_pose_data.honeycomb_io.fetch_pose_model_info(

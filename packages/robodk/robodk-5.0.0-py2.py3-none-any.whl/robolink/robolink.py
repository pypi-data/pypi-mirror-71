...
class Item():
    ...
    def setParam(self, param, value=''):
        ...
        :param str value: Parameter value (optional, not all commands require a value) 
        ...
        .. seealso:: :func:`~robolink.Robolink.Command` (Robolink), :func:`~robolink.Robolink.setParam` (Robolink: station parameter)
        """
        import json

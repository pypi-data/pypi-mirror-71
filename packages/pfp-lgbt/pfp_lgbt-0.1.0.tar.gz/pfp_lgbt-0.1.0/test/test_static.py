...
class Static(StaticTestCase):
    def test_static_byte(self):
        time.sleep(1)
        circle = self.client.imageStatic(sample_img, 'circle', 'solid', self.flag, 'png')
    ...
    def test_static_file(self):
        ...
        self.client.imageStatic('in.png', 'circle', 'solid', self.flag, 'png', 'out.png')

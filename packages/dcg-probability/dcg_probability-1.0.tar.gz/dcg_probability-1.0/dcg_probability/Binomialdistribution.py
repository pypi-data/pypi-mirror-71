...
class Binomial(Distribution):
    ...
    """
    def __init__(self, prob=.5, sample_size=50):
    ...
    def plot_bar(self):
        ...
        Returns:
            None
        """
        plt.bar(x = [0, 1], height = [(1.0 - self.p) * self.n, self.p * self.n])
    ...
    def pdf(self, k):
        ...
        """
        # return error if k is larger than sample size
        try:
            assert self.n >= k, 'k cannot be larger than sample size'
    ...
    def plot__histogram_pdf(self):
        ...
        plt.bar(x, y)
        plt.title('Binomial Distribution for positive trials of probability')

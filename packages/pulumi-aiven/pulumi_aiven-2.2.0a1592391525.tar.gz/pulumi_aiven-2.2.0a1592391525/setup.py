...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '2.2.0-alpha.1592391525+a1dfd549'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 2.2.0-alpha.1592391525+a1dfd549`
                """)
            else:
                raise

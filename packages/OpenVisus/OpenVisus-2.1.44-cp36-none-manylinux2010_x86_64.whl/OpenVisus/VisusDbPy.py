...
class Dataset(_object):
    ...
    def getField(self, name):
        return _VisusDbPy.Dataset_getField(self, name)
    ...
    def computeFilter(self, field, window_size=4096):
        return _VisusDbPy.Dataset_computeFilter(self, field, window_size)
    ...
    def testQuerySpeed(self, time, field, query_dim):
        return _VisusDbPy.Dataset_testQuerySpeed(self, time, field, query_dim)
    if _newclass:
        testSlabSpeed = staticmethod(_VisusDbPy.Dataset_testSlabSpeed)
    else:
        testSlabSpeed = _VisusDbPy.Dataset_testSlabSpeed
Dataset_swigregister = _VisusDbPy.Dataset_swigregister
Dataset_swigregister(Dataset)

def Dataset_testSlabSpeed(filename, dims, num_slabs, dtype, layout):
    return _VisusDbPy.Dataset_testSlabSpeed(filename, dims, num_slabs, dtype, layout)
Dataset_testSlabSpeed = _VisusDbPy.Dataset_testSlabSpeed
...
def LoadIdxDataset(url):
    return _VisusDbPy.LoadIdxDataset(url)
LoadIdxDataset = _VisusDbPy.LoadIdxDataset
...
class IdxMultipleAccess(Access):
    __swig_setmethods__ = {}
    for _s in [Access]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, IdxMultipleAccess, name, value)
    __swig_getmethods__ = {}
    for _s in [Access]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, IdxMultipleAccess, name)

    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_setmethods__["DATASET"] = _VisusDbPy.IdxMultipleAccess_DATASET_set
    __swig_getmethods__["DATASET"] = _VisusDbPy.IdxMultipleAccess_DATASET_get
    if _newclass:
        DATASET = _swig_property(_VisusDbPy.IdxMultipleAccess_DATASET_get, _VisusDbPy.IdxMultipleAccess_DATASET_set)
    __swig_setmethods__["CONFIG"] = _VisusDbPy.IdxMultipleAccess_CONFIG_set
    __swig_getmethods__["CONFIG"] = _VisusDbPy.IdxMultipleAccess_CONFIG_get
    if _newclass:
        CONFIG = _swig_property(_VisusDbPy.IdxMultipleAccess_CONFIG_get, _VisusDbPy.IdxMultipleAccess_CONFIG_set)
    __swig_setmethods__["configs"] = _VisusDbPy.IdxMultipleAccess_configs_set
    __swig_getmethods__["configs"] = _VisusDbPy.IdxMultipleAccess_configs_get
    if _newclass:
        configs = _swig_property(_VisusDbPy.IdxMultipleAccess_configs_get, _VisusDbPy.IdxMultipleAccess_configs_set)
    __swig_setmethods__["thread_pool"] = _VisusDbPy.IdxMultipleAccess_thread_pool_set
    __swig_getmethods__["thread_pool"] = _VisusDbPy.IdxMultipleAccess_thread_pool_get
    if _newclass:
        thread_pool = _swig_property(_VisusDbPy.IdxMultipleAccess_thread_pool_get, _VisusDbPy.IdxMultipleAccess_thread_pool_set)
    __swig_destroy__ = _VisusDbPy.delete_IdxMultipleAccess
    __del__ = lambda self: None

    def createDownAccess(self, name, fieldname):
        return _VisusDbPy.IdxMultipleAccess_createDownAccess(self, name, fieldname)

    def readBlock(self, BLOCKQUERY):
        return _VisusDbPy.IdxMultipleAccess_readBlock(self, BLOCKQUERY)

    def writeBlock(self, BLOCKQUERY):
        return _VisusDbPy.IdxMultipleAccess_writeBlock(self, BLOCKQUERY)
IdxMultipleAccess_swigregister = _VisusDbPy.IdxMultipleAccess_swigregister
IdxMultipleAccess_swigregister(IdxMultipleAccess)

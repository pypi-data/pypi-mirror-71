...
class Dataset(object):
    ...
    @staticmethod
    def testSlabSpeed(filename, dims, num_slabs, dtype, layout):
...
class IdxMultipleAccess(Access):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    DATASET = property(_VisusDbPy.IdxMultipleAccess_DATASET_get, _VisusDbPy.IdxMultipleAccess_DATASET_set)
    CONFIG = property(_VisusDbPy.IdxMultipleAccess_CONFIG_get, _VisusDbPy.IdxMultipleAccess_CONFIG_set)
    configs = property(_VisusDbPy.IdxMultipleAccess_configs_get, _VisusDbPy.IdxMultipleAccess_configs_set)
    thread_pool = property(_VisusDbPy.IdxMultipleAccess_thread_pool_get, _VisusDbPy.IdxMultipleAccess_thread_pool_set)
...
# Register IdxMultipleAccess in _VisusDbPy:
_VisusDbPy.IdxMultipleAccess_swigregister(IdxMultipleAccess)

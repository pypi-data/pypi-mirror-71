    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                logger.exception("Stream timeout error")
                eos = True
                if window_func:
            ...
            assert (process_results is not None) or not self._return_type or eos or self._eos

            if self._return_type and (process_results is not None):

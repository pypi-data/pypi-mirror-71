...
class TagRefRequest(object):
    ...
    def __init__(self, search=None, tag=None, propagation=None, label=None, id=None, action=None, collection=None, partition_filter=None, propagated=None, creation_time=None, offset=None):
        """

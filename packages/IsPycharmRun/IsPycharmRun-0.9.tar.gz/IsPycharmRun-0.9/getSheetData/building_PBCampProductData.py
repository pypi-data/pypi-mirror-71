...
class PBCampProductSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBCampProductCollect(self.idColumnIndex - 1)

    def PBCampProductCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/building.xlsx")
        table = data.sheet_by_name("PBCampProduct")
        rowNum = table.nrows
        colNum = table.ncols

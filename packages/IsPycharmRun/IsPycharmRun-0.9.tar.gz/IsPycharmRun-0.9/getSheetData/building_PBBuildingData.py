...
class PBBuildingSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBBuildingCollect(self.idColumnIndex - 1)

    def PBBuildingCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/building.xlsx")
        table = data.sheet_by_name("PBBuilding")
        rowNum = table.nrows
        colNum = table.ncols

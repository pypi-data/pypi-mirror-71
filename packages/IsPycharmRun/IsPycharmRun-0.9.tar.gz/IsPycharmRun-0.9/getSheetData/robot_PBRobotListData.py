...
class PBRobotListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBRobotListCollect(self.idColumnIndex - 1)

    def PBRobotListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/robot.xlsx")
        table = data.sheet_by_name("PBRobotList")
        rowNum = table.nrows
        colNum = table.ncols

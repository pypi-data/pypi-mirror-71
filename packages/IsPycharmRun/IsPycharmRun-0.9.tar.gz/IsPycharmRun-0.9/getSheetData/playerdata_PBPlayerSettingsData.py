...
class PBPlayerSettingsSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBPlayerSettingsCollect(self.idColumnIndex - 1)

    def PBPlayerSettingsCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/playerdata.xlsx")
        table = data.sheet_by_name("PBPlayerSettings")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBDirtyFilterListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDirtyFilterListCollect(self.idColumnIndex - 1)

    def PBDirtyFilterListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/dirtyfilter.xlsx")
        table = data.sheet_by_name("PBDirtyFilterList")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBCampBuildingSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBCampBuildingCollect(self.idColumnIndex - 1)

    def PBCampBuildingCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/building.xlsx")
        table = data.sheet_by_name("PBCampBuilding")
        rowNum = table.nrows
        colNum = table.ncols

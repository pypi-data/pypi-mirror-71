...
class ConfStorySheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.ConfStoryCollect(self.idColumnIndex - 1)

    def ConfStoryCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/cinema.xlsx")
        table = data.sheet_by_name("ConfStory")
        rowNum = table.nrows
        colNum = table.ncols

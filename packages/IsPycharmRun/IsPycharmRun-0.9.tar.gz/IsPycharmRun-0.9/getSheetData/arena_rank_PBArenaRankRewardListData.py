...
class PBArenaRankRewardListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBArenaRankRewardListCollect(self.idColumnIndex - 1)

    def PBArenaRankRewardListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/arena_rank.xlsx")
        table = data.sheet_by_name("PBArenaRankRewardList")
        rowNum = table.nrows
        colNum = table.ncols

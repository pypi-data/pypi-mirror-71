...
class tips_ChineseSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.tips_ChineseCollect(self.idColumnIndex - 1)

    def tips_ChineseCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_tips.xlsx")
        table = data.sheet_by_name("tips_Chinese")
        rowNum = table.nrows
        colNum = table.ncols

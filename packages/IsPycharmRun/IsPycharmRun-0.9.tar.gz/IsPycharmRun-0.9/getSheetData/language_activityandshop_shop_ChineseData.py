...
class shop_ChineseSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.shop_ChineseCollect(self.idColumnIndex - 1)

    def shop_ChineseCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_activityandshop.xlsx")
        table = data.sheet_by_name("shop_Chinese")
        rowNum = table.nrows
        colNum = table.ncols

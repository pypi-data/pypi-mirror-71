...
class heroChip_ChineseSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.heroChip_ChineseCollect(self.idColumnIndex - 1)

    def heroChip_ChineseCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_item.xlsx")
        table = data.sheet_by_name("heroChip_Chinese")
        rowNum = table.nrows
        colNum = table.ncols

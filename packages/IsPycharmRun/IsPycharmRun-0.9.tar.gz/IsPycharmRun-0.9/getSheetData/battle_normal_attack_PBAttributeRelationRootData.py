...
class PBAttributeRelationRootSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBAttributeRelationRootCollect(self.idColumnIndex - 1)

    def PBAttributeRelationRootCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/battle_normal_attack.xlsx")
        table = data.sheet_by_name("PBAttributeRelationRoot")
        rowNum = table.nrows
        colNum = table.ncols

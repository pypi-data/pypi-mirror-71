...
class PBRobotWeaponListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBRobotWeaponListCollect(self.idColumnIndex - 1)

    def PBRobotWeaponListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/robot.xlsx")
        table = data.sheet_by_name("PBRobotWeaponList")
        rowNum = table.nrows
        colNum = table.ncols

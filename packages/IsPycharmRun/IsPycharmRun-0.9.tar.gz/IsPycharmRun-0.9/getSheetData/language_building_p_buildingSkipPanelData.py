...
class p_buildingSkipPanelSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.p_buildingSkipPanelCollect(self.idColumnIndex - 1)

    def p_buildingSkipPanelCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_building.xlsx")
        table = data.sheet_by_name("p_buildingSkipPanel")
        rowNum = table.nrows
        colNum = table.ncols

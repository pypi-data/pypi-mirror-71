...
class PBDropGroup=ItemSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDropGroup=ItemCollect(self.idColumnIndex - 1)

    def PBDropGroup=ItemCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/drop_group.xlsx")
        table = data.sheet_by_name("PBDropGroup=Item")
        rowNum = table.nrows
        colNum = table.ncols

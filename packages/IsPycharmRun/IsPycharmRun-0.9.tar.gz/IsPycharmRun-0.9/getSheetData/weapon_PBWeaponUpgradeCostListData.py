...
class PBWeaponUpgradeCostListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBWeaponUpgradeCostListCollect(self.idColumnIndex - 1)

    def PBWeaponUpgradeCostListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/weapon.xlsx")
        table = data.sheet_by_name("PBWeaponUpgradeCostList")
        rowNum = table.nrows
        colNum = table.ncols

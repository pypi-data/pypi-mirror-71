...
class PBRobotHeroListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBRobotHeroListCollect(self.idColumnIndex - 1)

    def PBRobotHeroListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/robot.xlsx")
        table = data.sheet_by_name("PBRobotHeroList")
        rowNum = table.nrows
        colNum = table.ncols

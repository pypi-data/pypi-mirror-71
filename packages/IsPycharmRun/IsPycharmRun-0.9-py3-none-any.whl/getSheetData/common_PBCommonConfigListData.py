...
class PBCommonConfigListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBCommonConfigListCollect(self.idColumnIndex - 1)

    def PBCommonConfigListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/common.xlsx")
        table = data.sheet_by_name("PBCommonConfigList")
        rowNum = table.nrows
        colNum = table.ncols

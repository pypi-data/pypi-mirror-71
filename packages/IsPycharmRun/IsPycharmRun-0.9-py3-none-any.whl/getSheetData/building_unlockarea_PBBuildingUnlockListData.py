...
class PBBuildingUnlockListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBBuildingUnlockListCollect(self.idColumnIndex - 1)

    def PBBuildingUnlockListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/building_unlockarea.xlsx")
        table = data.sheet_by_name("PBBuildingUnlockList")
        rowNum = table.nrows
        colNum = table.ncols

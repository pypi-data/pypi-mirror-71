...
class PBDragonAdditionListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDragonAdditionListCollect(self.idColumnIndex - 1)

    def PBDragonAdditionListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/dragon.xlsx")
        table = data.sheet_by_name("PBDragonAdditionList")
        rowNum = table.nrows
        colNum = table.ncols

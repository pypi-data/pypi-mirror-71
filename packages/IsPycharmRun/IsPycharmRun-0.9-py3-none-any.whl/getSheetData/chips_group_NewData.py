...
class NewSheetData:
    def __init__(self, idColumnIndex):
        ...
        self.dict = self.NewCollect(self.idColumnIndex - 1)

    def NewCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/chips_group.xlsx")
        table = data.sheet_by_name("New")
        rowNum = table.nrows
        colNum = table.ncols

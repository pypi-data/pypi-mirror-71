...
class PBShopLuckyCandidateListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBShopLuckyCandidateListCollect(self.idColumnIndex - 1)

    def PBShopLuckyCandidateListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/shop.xlsx")
        table = data.sheet_by_name("PBShopLuckyCandidateList")
        rowNum = table.nrows
        colNum = table.ncols

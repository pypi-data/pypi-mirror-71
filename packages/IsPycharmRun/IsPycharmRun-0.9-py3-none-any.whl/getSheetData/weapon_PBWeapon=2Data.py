...
class PBWeapon=2SheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBWeapon=2Collect(self.idColumnIndex - 1)

    def PBWeapon=2Collect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/weapon.xlsx")
        table = data.sheet_by_name("PBWeapon=2")
        rowNum = table.nrows
        colNum = table.ncols

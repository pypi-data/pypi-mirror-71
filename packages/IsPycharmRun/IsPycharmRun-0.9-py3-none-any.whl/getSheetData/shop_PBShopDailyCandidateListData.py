...
class PBShopDailyCandidateListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBShopDailyCandidateListCollect(self.idColumnIndex - 1)

    def PBShopDailyCandidateListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/shop.xlsx")
        table = data.sheet_by_name("PBShopDailyCandidateList")
        rowNum = table.nrows
        colNum = table.ncols

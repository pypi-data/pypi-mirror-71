...
class PBQuestEntranceListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBQuestEntranceListCollect(self.idColumnIndex - 1)

    def PBQuestEntranceListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/quest.xlsx")
        table = data.sheet_by_name("PBQuestEntranceList")
        rowNum = table.nrows
        colNum = table.ncols

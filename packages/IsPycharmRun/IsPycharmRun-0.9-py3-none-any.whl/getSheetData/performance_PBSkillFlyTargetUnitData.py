...
class PBSkillFlyTargetUnitSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBSkillFlyTargetUnitCollect(self.idColumnIndex - 1)

    def PBSkillFlyTargetUnitCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/performance.xlsx")
        table = data.sheet_by_name("PBSkillFlyTargetUnit")
        rowNum = table.nrows
        colNum = table.ncols

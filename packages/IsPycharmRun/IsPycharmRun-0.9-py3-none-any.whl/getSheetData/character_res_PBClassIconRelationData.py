...
class PBClassIconRelationSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBClassIconRelationCollect(self.idColumnIndex - 1)

    def PBClassIconRelationCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/character_res.xlsx")
        table = data.sheet_by_name("PBClassIconRelation")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBArenaSeasonCnfListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBArenaSeasonCnfListCollect(self.idColumnIndex - 1)

    def PBArenaSeasonCnfListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/arena_rank.xlsx")
        table = data.sheet_by_name("PBArenaSeasonCnfList")
        rowNum = table.nrows
        colNum = table.ncols

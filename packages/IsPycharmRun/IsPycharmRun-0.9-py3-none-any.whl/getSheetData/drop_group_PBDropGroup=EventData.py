...
class PBDropGroup=EventSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDropGroup=EventCollect(self.idColumnIndex - 1)

    def PBDropGroup=EventCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/drop_group.xlsx")
        table = data.sheet_by_name("PBDropGroup=Event")
        rowNum = table.nrows
        colNum = table.ncols

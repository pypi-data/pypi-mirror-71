...
class PBTaskGroupSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBTaskGroupCollect(self.idColumnIndex - 1)

    def PBTaskGroupCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/task.xlsx")
        table = data.sheet_by_name("PBTaskGroup")
        rowNum = table.nrows
        colNum = table.ncols

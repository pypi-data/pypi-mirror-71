...
class p_BattlePanelSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.p_BattlePanelCollect(self.idColumnIndex - 1)

    def p_BattlePanelCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_panel.xlsx")
        table = data.sheet_by_name("p_BattlePanel")
        rowNum = table.nrows
        colNum = table.ncols

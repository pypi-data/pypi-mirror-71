...
class PBActionSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBActionCollect(self.idColumnIndex - 1)

    def PBActionCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/action.xlsx")
        table = data.sheet_by_name("PBAction")
        rowNum = table.nrows
        colNum = table.ncols

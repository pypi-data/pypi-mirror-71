...
class p_changeNamePanelSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.p_changeNamePanelCollect(self.idColumnIndex - 1)

    def p_changeNamePanelCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_changename.xlsx")
        table = data.sheet_by_name("p_changeNamePanel")
        rowNum = table.nrows
        colNum = table.ncols

...
class NormalPlayerDataSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.NormalPlayerDataCollect(self.idColumnIndex - 1)

    def NormalPlayerDataCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_playerdata.xlsx")
        table = data.sheet_by_name("NormalPlayerData")
        rowNum = table.nrows
        colNum = table.ncols

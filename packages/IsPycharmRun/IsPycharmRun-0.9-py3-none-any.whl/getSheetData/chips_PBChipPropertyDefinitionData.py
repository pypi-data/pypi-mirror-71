...
class PBChipPropertyDefinitionSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBChipPropertyDefinitionCollect(self.idColumnIndex - 1)

    def PBChipPropertyDefinitionCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/chips.xlsx")
        table = data.sheet_by_name("PBChipPropertyDefinition")
        rowNum = table.nrows
        colNum = table.ncols

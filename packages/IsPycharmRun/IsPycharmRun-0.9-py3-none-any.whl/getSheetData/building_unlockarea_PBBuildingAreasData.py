...
class PBBuildingAreasSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBBuildingAreasCollect(self.idColumnIndex - 1)

    def PBBuildingAreasCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/building_unlockarea.xlsx")
        table = data.sheet_by_name("PBBuildingAreas")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBLotteryListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBLotteryListCollect(self.idColumnIndex - 1)

    def PBLotteryListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/drop_card.xlsx")
        table = data.sheet_by_name("PBLotteryList")
        rowNum = table.nrows
        colNum = table.ncols

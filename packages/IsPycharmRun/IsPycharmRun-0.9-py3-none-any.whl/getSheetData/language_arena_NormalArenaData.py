...
class NormalArenaSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.NormalArenaCollect(self.idColumnIndex - 1)

    def NormalArenaCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_arena.xlsx")
        table = data.sheet_by_name("NormalArena")
        rowNum = table.nrows
        colNum = table.ncols

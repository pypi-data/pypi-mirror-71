...
class UnlockSysSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.UnlockSysCollect(self.idColumnIndex - 1)

    def UnlockSysCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_common.xlsx")
        table = data.sheet_by_name("UnlockSys")
        rowNum = table.nrows
        colNum = table.ncols

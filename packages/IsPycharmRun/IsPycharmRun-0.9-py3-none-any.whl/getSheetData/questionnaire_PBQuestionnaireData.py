...
class PBQuestionnaireSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBQuestionnaireCollect(self.idColumnIndex - 1)

    def PBQuestionnaireCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/questionnaire.xlsx")
        table = data.sheet_by_name("PBQuestionnaire")
        rowNum = table.nrows
        colNum = table.ncols

...
class portrait_ChineseSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.portrait_ChineseCollect(self.idColumnIndex - 1)

    def portrait_ChineseCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_plot.xlsx")
        table = data.sheet_by_name("portrait_Chinese")
        rowNum = table.nrows
        colNum = table.ncols

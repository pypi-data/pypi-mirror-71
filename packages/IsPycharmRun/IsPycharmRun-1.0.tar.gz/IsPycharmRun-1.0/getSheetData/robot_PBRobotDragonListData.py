...
class PBRobotDragonListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBRobotDragonListCollect(self.idColumnIndex - 1)

    def PBRobotDragonListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/robot.xlsx")
        table = data.sheet_by_name("PBRobotDragonList")
        rowNum = table.nrows
        colNum = table.ncols

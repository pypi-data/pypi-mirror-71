...
class p_herosystemPaneSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.p_herosystemPaneCollect(self.idColumnIndex - 1)

    def p_herosystemPaneCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_hero.xlsx")
        table = data.sheet_by_name("p_herosystemPane")
        rowNum = table.nrows
        colNum = table.ncols

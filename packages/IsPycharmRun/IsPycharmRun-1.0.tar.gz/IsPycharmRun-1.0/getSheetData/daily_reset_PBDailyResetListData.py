...
class PBDailyResetListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDailyResetListCollect(self.idColumnIndex - 1)

    def PBDailyResetListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/daily_reset.xlsx")
        table = data.sheet_by_name("PBDailyResetList")
        rowNum = table.nrows
        colNum = table.ncols

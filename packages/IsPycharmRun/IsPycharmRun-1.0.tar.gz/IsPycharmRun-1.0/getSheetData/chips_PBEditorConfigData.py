...
class PBEditorConfigSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBEditorConfigCollect(self.idColumnIndex - 1)

    def PBEditorConfigCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/chips.xlsx")
        table = data.sheet_by_name("PBEditorConfig")
        rowNum = table.nrows
        colNum = table.ncols

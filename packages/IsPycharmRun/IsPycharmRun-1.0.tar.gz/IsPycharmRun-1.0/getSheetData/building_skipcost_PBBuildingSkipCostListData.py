...
class PBBuildingSkipCostListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBBuildingSkipCostListCollect(self.idColumnIndex - 1)

    def PBBuildingSkipCostListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/building_skipcost.xlsx")
        table = data.sheet_by_name("PBBuildingSkipCostList")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBDragonCriticalListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDragonCriticalListCollect(self.idColumnIndex - 1)

    def PBDragonCriticalListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/dragon.xlsx")
        table = data.sheet_by_name("PBDragonCriticalList")
        rowNum = table.nrows
        colNum = table.ncols

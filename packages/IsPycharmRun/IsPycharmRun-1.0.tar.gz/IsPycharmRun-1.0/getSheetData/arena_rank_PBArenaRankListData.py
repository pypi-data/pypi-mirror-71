...
class PBArenaRankListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBArenaRankListCollect(self.idColumnIndex - 1)

    def PBArenaRankListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/arena_rank.xlsx")
        table = data.sheet_by_name("PBArenaRankList")
        rowNum = table.nrows
        colNum = table.ncols

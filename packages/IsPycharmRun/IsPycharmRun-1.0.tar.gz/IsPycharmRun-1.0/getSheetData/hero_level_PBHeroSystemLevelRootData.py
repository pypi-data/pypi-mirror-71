...
class PBHeroSystemLevelRootSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBHeroSystemLevelRootCollect(self.idColumnIndex - 1)

    def PBHeroSystemLevelRootCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/hero_level.xlsx")
        table = data.sheet_by_name("PBHeroSystemLevelRoot")
        rowNum = table.nrows
        colNum = table.ncols

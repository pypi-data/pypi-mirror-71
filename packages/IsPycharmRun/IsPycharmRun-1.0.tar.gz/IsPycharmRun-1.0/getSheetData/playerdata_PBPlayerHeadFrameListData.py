...
class PBPlayerHeadFrameListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBPlayerHeadFrameListCollect(self.idColumnIndex - 1)

    def PBPlayerHeadFrameListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/playerdata.xlsx")
        table = data.sheet_by_name("PBPlayerHeadFrameList")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBMailSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBMailCollect(self.idColumnIndex - 1)

    def PBMailCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/mail.xlsx")
        table = data.sheet_by_name("PBMail")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBBaseDevInfoListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBBaseDevInfoListCollect(self.idColumnIndex - 1)

    def PBBaseDevInfoListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/device_info.xlsx")
        table = data.sheet_by_name("PBBaseDevInfoList")
        rowNum = table.nrows
        colNum = table.ncols

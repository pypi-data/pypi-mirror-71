...
class PBDungeonEnvironmentSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDungeonEnvironmentCollect(self.idColumnIndex - 1)

    def PBDungeonEnvironmentCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_combat.xlsx")
        table = data.sheet_by_name("PBDungeonEnvironment")
        rowNum = table.nrows
        colNum = table.ncols

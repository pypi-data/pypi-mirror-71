...
class PBShopDailyCandidateRuleListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBShopDailyCandidateRuleListCollect(self.idColumnIndex - 1)

    def PBShopDailyCandidateRuleListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/shop.xlsx")
        table = data.sheet_by_name("PBShopDailyCandidateRuleList")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBLevelCostRootSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBLevelCostRootCollect(self.idColumnIndex - 1)

    def PBLevelCostRootCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/hero_level.xlsx")
        table = data.sheet_by_name("PBLevelCostRoot")
        rowNum = table.nrows
        colNum = table.ncols

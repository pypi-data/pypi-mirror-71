...
class PBPlayerLevelListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBPlayerLevelListCollect(self.idColumnIndex - 1)

    def PBPlayerLevelListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/playerlevel.xlsx")
        table = data.sheet_by_name("PBPlayerLevelList")
        rowNum = table.nrows
        colNum = table.ncols

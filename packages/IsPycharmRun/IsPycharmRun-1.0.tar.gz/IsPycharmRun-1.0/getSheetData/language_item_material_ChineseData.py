...
class material_ChineseSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.material_ChineseCollect(self.idColumnIndex - 1)

    def material_ChineseCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_item.xlsx")
        table = data.sheet_by_name("material_Chinese")
        rowNum = table.nrows
        colNum = table.ncols

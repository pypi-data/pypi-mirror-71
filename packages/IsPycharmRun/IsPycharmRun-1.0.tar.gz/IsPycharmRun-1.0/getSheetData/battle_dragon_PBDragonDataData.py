...
class PBDragonDataSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDragonDataCollect(self.idColumnIndex - 1)

    def PBDragonDataCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/battle_dragon.xlsx")
        table = data.sheet_by_name("PBDragonData")
        rowNum = table.nrows
        colNum = table.ncols

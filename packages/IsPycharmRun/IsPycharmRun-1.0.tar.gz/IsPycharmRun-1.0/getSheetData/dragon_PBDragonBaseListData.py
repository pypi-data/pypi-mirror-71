...
class PBDragonBaseListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDragonBaseListCollect(self.idColumnIndex - 1)

    def PBDragonBaseListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/dragon.xlsx")
        table = data.sheet_by_name("PBDragonBaseList")
        rowNum = table.nrows
        colNum = table.ncols

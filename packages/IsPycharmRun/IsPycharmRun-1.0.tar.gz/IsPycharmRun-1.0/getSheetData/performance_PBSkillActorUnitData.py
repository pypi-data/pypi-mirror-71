...
class PBSkillActorUnitSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBSkillActorUnitCollect(self.idColumnIndex - 1)

    def PBSkillActorUnitCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/performance.xlsx")
        table = data.sheet_by_name("PBSkillActorUnit")
        rowNum = table.nrows
        colNum = table.ncols

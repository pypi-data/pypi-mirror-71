...
class PBShopProductSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBShopProductCollect(self.idColumnIndex - 1)

    def PBShopProductCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/shop.xlsx")
        table = data.sheet_by_name("PBShopProduct")
        rowNum = table.nrows
        colNum = table.ncols

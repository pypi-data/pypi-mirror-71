...
class Task_DescribeSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.Task_DescribeCollect(self.idColumnIndex - 1)

    def Task_DescribeCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_dragon.xlsx")
        table = data.sheet_by_name("Task_Describe")
        rowNum = table.nrows
        colNum = table.ncols

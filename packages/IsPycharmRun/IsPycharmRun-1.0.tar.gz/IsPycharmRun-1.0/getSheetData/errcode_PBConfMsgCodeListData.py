...
class PBConfMsgCodeListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBConfMsgCodeListCollect(self.idColumnIndex - 1)

    def PBConfMsgCodeListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/errcode.xlsx")
        table = data.sheet_by_name("PBConfMsgCodeList")
        rowNum = table.nrows
        colNum = table.ncols

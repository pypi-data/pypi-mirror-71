...
class ChineseSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.ChineseCollect(self.idColumnIndex - 1)

    def ChineseCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/diff/diff_language.xlsx")
        table = data.sheet_by_name("Chinese")
        rowNum = table.nrows
        colNum = table.ncols

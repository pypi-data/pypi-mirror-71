...
class dailyeventsSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.dailyeventsCollect(self.idColumnIndex - 1)

    def dailyeventsCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_dailyevents.xlsx")
        table = data.sheet_by_name("dailyevents")
        rowNum = table.nrows
        colNum = table.ncols

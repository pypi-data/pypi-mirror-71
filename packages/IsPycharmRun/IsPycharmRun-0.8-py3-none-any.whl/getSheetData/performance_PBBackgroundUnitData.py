...
class PBBackgroundUnitSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBBackgroundUnitCollect(self.idColumnIndex - 1)

    def PBBackgroundUnitCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/performance.xlsx")
        table = data.sheet_by_name("PBBackgroundUnit")
        rowNum = table.nrows
        colNum = table.ncols

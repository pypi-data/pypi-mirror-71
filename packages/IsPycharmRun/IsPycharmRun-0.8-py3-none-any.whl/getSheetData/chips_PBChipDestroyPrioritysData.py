...
class PBChipDestroyPrioritysSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBChipDestroyPrioritysCollect(self.idColumnIndex - 1)

    def PBChipDestroyPrioritysCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/chips.xlsx")
        table = data.sheet_by_name("PBChipDestroyPrioritys")
        rowNum = table.nrows
        colNum = table.ncols

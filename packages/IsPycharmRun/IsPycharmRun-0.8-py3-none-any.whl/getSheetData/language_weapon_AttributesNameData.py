...
class AttributesNameSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.AttributesNameCollect(self.idColumnIndex - 1)

    def AttributesNameCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_weapon.xlsx")
        table = data.sheet_by_name("AttributesName")
        rowNum = table.nrows
        colNum = table.ncols

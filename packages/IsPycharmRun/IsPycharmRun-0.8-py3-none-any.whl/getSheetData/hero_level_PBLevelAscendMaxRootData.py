...
class PBLevelAscendMaxRootSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBLevelAscendMaxRootCollect(self.idColumnIndex - 1)

    def PBLevelAscendMaxRootCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/hero_level.xlsx")
        table = data.sheet_by_name("PBLevelAscendMaxRoot")
        rowNum = table.nrows
        colNum = table.ncols

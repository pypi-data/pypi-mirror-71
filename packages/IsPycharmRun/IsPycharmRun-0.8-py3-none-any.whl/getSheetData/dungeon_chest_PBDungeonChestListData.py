...
class PBDungeonChestListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDungeonChestListCollect(self.idColumnIndex - 1)

    def PBDungeonChestListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/dungeon_chest.xlsx")
        table = data.sheet_by_name("PBDungeonChestList")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBWeaponConfigSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBWeaponConfigCollect(self.idColumnIndex - 1)

    def PBWeaponConfigCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/battle_weapon_chips.xlsx")
        table = data.sheet_by_name("PBWeaponConfig")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBAscendCostRootSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBAscendCostRootCollect(self.idColumnIndex - 1)

    def PBAscendCostRootCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/hero_level.xlsx")
        table = data.sheet_by_name("PBAscendCostRoot")
        rowNum = table.nrows
        colNum = table.ncols

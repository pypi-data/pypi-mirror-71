...
class MailDataSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.MailDataCollect(self.idColumnIndex - 1)

    def MailDataCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_mail.xlsx")
        table = data.sheet_by_name("MailData")
        rowNum = table.nrows
        colNum = table.ncols

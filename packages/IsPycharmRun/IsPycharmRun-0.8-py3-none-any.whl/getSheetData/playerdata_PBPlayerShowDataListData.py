...
class PBPlayerShowDataListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBPlayerShowDataListCollect(self.idColumnIndex - 1)

    def PBPlayerShowDataListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/playerdata.xlsx")
        table = data.sheet_by_name("PBPlayerShowDataList")
        rowNum = table.nrows
        colNum = table.ncols

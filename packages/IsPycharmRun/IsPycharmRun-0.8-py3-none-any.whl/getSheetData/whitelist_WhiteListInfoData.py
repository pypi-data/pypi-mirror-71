...
class WhiteListInfoSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.WhiteListInfoCollect(self.idColumnIndex - 1)

    def WhiteListInfoCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/whitelist.xlsx")
        table = data.sheet_by_name("WhiteListInfo")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBPlayerTitleListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBPlayerTitleListCollect(self.idColumnIndex - 1)

    def PBPlayerTitleListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/player_title.xlsx")
        table = data.sheet_by_name("PBPlayerTitleList")
        rowNum = table.nrows
        colNum = table.ncols

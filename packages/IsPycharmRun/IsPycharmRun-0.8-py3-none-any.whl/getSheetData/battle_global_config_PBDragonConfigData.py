...
class PBDragonConfigSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDragonConfigCollect(self.idColumnIndex - 1)

    def PBDragonConfigCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/battle_global_config.xlsx")
        table = data.sheet_by_name("PBDragonConfig")
        rowNum = table.nrows
        colNum = table.ncols

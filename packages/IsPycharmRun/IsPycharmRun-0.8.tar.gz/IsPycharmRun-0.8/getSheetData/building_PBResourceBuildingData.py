...
class PBResourceBuildingSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBResourceBuildingCollect(self.idColumnIndex - 1)

    def PBResourceBuildingCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/building.xlsx")
        table = data.sheet_by_name("PBResourceBuilding")
        rowNum = table.nrows
        colNum = table.ncols

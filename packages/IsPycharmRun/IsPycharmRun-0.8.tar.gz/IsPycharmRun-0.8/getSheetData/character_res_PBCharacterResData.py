...
class PBCharacterResSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBCharacterResCollect(self.idColumnIndex - 1)

    def PBCharacterResCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/character_res.xlsx")
        table = data.sheet_by_name("PBCharacterRes")
        rowNum = table.nrows
        colNum = table.ncols

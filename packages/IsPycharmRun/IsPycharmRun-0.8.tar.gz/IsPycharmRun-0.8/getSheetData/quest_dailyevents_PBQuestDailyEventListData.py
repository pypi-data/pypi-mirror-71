...
class PBQuestDailyEventListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBQuestDailyEventListCollect(self.idColumnIndex - 1)

    def PBQuestDailyEventListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/quest_dailyevents.xlsx")
        table = data.sheet_by_name("PBQuestDailyEventList")
        rowNum = table.nrows
        colNum = table.ncols

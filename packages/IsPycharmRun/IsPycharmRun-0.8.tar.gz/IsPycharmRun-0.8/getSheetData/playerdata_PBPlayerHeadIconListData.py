...
class PBPlayerHeadIconListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBPlayerHeadIconListCollect(self.idColumnIndex - 1)

    def PBPlayerHeadIconListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/playerdata.xlsx")
        table = data.sheet_by_name("PBPlayerHeadIconList")
        rowNum = table.nrows
        colNum = table.ncols

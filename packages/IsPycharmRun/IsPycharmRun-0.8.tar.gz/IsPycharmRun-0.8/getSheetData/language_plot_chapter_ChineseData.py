...
class chapter_ChineseSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.chapter_ChineseCollect(self.idColumnIndex - 1)

    def chapter_ChineseCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_plot.xlsx")
        table = data.sheet_by_name("chapter_Chinese")
        rowNum = table.nrows
        colNum = table.ncols

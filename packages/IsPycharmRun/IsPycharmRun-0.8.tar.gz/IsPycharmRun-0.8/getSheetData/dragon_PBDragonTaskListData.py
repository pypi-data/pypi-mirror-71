...
class PBDragonTaskListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDragonTaskListCollect(self.idColumnIndex - 1)

    def PBDragonTaskListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/dragon.xlsx")
        table = data.sheet_by_name("PBDragonTaskList")
        rowNum = table.nrows
        colNum = table.ncols

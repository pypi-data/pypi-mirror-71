...
class PBChipShowLayersSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBChipShowLayersCollect(self.idColumnIndex - 1)

    def PBChipShowLayersCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/chips.xlsx")
        table = data.sheet_by_name("PBChipShowLayers")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBGameSysUnlockListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBGameSysUnlockListCollect(self.idColumnIndex - 1)

    def PBGameSysUnlockListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/unlock_system.xlsx")
        table = data.sheet_by_name("PBGameSysUnlockList")
        rowNum = table.nrows
        colNum = table.ncols

...
class obstacle_name_ChineseSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.obstacle_name_ChineseCollect(self.idColumnIndex - 1)

    def obstacle_name_ChineseCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_plot.xlsx")
        table = data.sheet_by_name("obstacle_name_Chinese")
        rowNum = table.nrows
        colNum = table.ncols

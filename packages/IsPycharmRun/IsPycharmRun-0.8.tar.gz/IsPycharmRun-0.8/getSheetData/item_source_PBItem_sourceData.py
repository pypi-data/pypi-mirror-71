...
class PBItem_sourceSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBItem_sourceCollect(self.idColumnIndex - 1)

    def PBItem_sourceCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/item_source.xlsx")
        table = data.sheet_by_name("PBItem_source")
        rowNum = table.nrows
        colNum = table.ncols

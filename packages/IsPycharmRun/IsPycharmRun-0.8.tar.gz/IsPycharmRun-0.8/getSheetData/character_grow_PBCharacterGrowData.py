...
class PBCharacterGrowSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBCharacterGrowCollect(self.idColumnIndex - 1)

    def PBCharacterGrowCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/character_grow.xlsx")
        table = data.sheet_by_name("PBCharacterGrow")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBWeaponUpgradeListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBWeaponUpgradeListCollect(self.idColumnIndex - 1)

    def PBWeaponUpgradeListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/weapon.xlsx")
        table = data.sheet_by_name("PBWeaponUpgradeList")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBWeaponIntensifyListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBWeaponIntensifyListCollect(self.idColumnIndex - 1)

    def PBWeaponIntensifyListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/weapon.xlsx")
        table = data.sheet_by_name("PBWeaponIntensifyList")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBWorldMapListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBWorldMapListCollect(self.idColumnIndex - 1)

    def PBWorldMapListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/dungeon.xlsx")
        table = data.sheet_by_name("PBWorldMapList")
        rowNum = table.nrows
        colNum = table.ncols

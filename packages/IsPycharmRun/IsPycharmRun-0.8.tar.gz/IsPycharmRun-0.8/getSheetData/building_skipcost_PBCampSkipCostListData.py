...
class PBCampSkipCostListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBCampSkipCostListCollect(self.idColumnIndex - 1)

    def PBCampSkipCostListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/building_skipcost.xlsx")
        table = data.sheet_by_name("PBCampSkipCostList")
        rowNum = table.nrows
        colNum = table.ncols

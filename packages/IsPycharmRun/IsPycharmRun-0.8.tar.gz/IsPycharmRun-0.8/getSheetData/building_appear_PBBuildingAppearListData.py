...
class PBBuildingAppearListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBBuildingAppearListCollect(self.idColumnIndex - 1)

    def PBBuildingAppearListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/building_appear.xlsx")
        table = data.sheet_by_name("PBBuildingAppearList")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBActivityListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBActivityListCollect(self.idColumnIndex - 1)

    def PBActivityListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/activity.xlsx")
        table = data.sheet_by_name("PBActivityList")
        rowNum = table.nrows
        colNum = table.ncols

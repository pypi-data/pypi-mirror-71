...
class error_ChineseSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.error_ChineseCollect(self.idColumnIndex - 1)

    def error_ChineseCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_errcode.xlsx")
        table = data.sheet_by_name("error_Chinese")
        rowNum = table.nrows
        colNum = table.ncols

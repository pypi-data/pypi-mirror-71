...
class PBLotteryCardGroupSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBLotteryCardGroupCollect(self.idColumnIndex - 1)

    def PBLotteryCardGroupCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/drop_card.xlsx")
        table = data.sheet_by_name("PBLotteryCardGroup")
        rowNum = table.nrows
        colNum = table.ncols

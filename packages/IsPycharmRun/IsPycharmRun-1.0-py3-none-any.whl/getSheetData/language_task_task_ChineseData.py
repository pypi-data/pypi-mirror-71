...
class task_ChineseSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.task_ChineseCollect(self.idColumnIndex - 1)

    def task_ChineseCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/Language/language_task.xlsx")
        table = data.sheet_by_name("task_Chinese")
        rowNum = table.nrows
        colNum = table.ncols

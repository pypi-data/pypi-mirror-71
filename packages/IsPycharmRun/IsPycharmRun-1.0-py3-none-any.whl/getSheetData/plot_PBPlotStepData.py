...
class PBPlotStepSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBPlotStepCollect(self.idColumnIndex - 1)

    def PBPlotStepCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/plot.xlsx")
        table = data.sheet_by_name("PBPlotStep")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBSevenDayLoginListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBSevenDayLoginListCollect(self.idColumnIndex - 1)

    def PBSevenDayLoginListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/sevenday_login_reward.xlsx")
        table = data.sheet_by_name("PBSevenDayLoginList")
        rowNum = table.nrows
        colNum = table.ncols

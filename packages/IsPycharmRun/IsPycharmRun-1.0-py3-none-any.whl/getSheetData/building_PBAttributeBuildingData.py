...
class PBAttributeBuildingSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBAttributeBuildingCollect(self.idColumnIndex - 1)

    def PBAttributeBuildingCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/building.xlsx")
        table = data.sheet_by_name("PBAttributeBuilding")
        rowNum = table.nrows
        colNum = table.ncols

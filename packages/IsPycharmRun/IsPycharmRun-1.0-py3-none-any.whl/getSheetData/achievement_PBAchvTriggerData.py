...
class PBAchvTriggerSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBAchvTriggerCollect(self.idColumnIndex - 1)

    def PBAchvTriggerCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/achievement.xlsx")
        table = data.sheet_by_name("PBAchvTrigger")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBBattleGlobalConfigRootSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBBattleGlobalConfigRootCollect(self.idColumnIndex - 1)

    def PBBattleGlobalConfigRootCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/battle_global_config.xlsx")
        table = data.sheet_by_name("PBBattleGlobalConfigRoot")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBChipDefinitionSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBChipDefinitionCollect(self.idColumnIndex - 1)

    def PBChipDefinitionCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/chips.xlsx")
        table = data.sheet_by_name("PBChipDefinition")
        rowNum = table.nrows
        colNum = table.ncols

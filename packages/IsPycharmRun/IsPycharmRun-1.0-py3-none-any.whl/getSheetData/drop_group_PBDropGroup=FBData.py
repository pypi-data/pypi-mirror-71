...
class PBDropGroup=FBSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDropGroup=FBCollect(self.idColumnIndex - 1)

    def PBDropGroup=FBCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/drop_group.xlsx")
        table = data.sheet_by_name("PBDropGroup=FB")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBShockUnitSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBShockUnitCollect(self.idColumnIndex - 1)

    def PBShockUnitCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/performance.xlsx")
        table = data.sheet_by_name("PBShockUnit")
        rowNum = table.nrows
        colNum = table.ncols

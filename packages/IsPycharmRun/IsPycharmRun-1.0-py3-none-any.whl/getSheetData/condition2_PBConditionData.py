...
class PBConditionSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBConditionCollect(self.idColumnIndex - 1)

    def PBConditionCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/condition2.xlsx")
        table = data.sheet_by_name("PBCondition")
        rowNum = table.nrows
        colNum = table.ncols

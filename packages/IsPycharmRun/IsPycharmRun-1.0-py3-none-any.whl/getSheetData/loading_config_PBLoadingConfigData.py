...
class PBLoadingConfigSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBLoadingConfigCollect(self.idColumnIndex - 1)

    def PBLoadingConfigCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/loading_config.xlsx")
        table = data.sheet_by_name("PBLoadingConfig")
        rowNum = table.nrows
        colNum = table.ncols

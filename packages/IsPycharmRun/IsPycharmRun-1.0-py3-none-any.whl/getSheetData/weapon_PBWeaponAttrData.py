...
class PBWeaponAttrSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBWeaponAttrCollect(self.idColumnIndex - 1)

    def PBWeaponAttrCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/weapon.xlsx")
        table = data.sheet_by_name("PBWeaponAttr")
        rowNum = table.nrows
        colNum = table.ncols

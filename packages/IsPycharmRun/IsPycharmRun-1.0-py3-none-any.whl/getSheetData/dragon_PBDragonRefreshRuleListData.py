...
class PBDragonRefreshRuleListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDragonRefreshRuleListCollect(self.idColumnIndex - 1)

    def PBDragonRefreshRuleListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/dragon.xlsx")
        table = data.sheet_by_name("PBDragonRefreshRuleList")
        rowNum = table.nrows
        colNum = table.ncols

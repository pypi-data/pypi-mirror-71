...
class PBWeaponIntensifyCostIDSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBWeaponIntensifyCostIDCollect(self.idColumnIndex - 1)

    def PBWeaponIntensifyCostIDCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/weapon.xlsx")
        table = data.sheet_by_name("PBWeaponIntensifyCostID")
        rowNum = table.nrows
        colNum = table.ncols

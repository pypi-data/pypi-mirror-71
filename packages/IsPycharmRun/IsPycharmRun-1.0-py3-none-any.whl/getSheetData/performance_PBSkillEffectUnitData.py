...
class PBSkillEffectUnitSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBSkillEffectUnitCollect(self.idColumnIndex - 1)

    def PBSkillEffectUnitCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/performance.xlsx")
        table = data.sheet_by_name("PBSkillEffectUnit")
        rowNum = table.nrows
        colNum = table.ncols

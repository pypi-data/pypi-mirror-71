...
class PBShopNormalCandidateListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBShopNormalCandidateListCollect(self.idColumnIndex - 1)

    def PBShopNormalCandidateListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/shop.xlsx")
        table = data.sheet_by_name("PBShopNormalCandidateList")
        rowNum = table.nrows
        colNum = table.ncols

...
class PBDragonRefreshCostListSheetData:
    def __init__(self, idColumnIndex):
        self.idColumnIndex = idColumnIndex
        self.dict = self.PBDragonRefreshCostListCollect(self.idColumnIndex - 1)

    def PBDragonRefreshCostListCollect(self, idColumnIndex):
        data = xlrd.open_workbook(r"/Users/shiboxuan/testTools/getSheetData/conf/excel/dragon.xlsx")
        table = data.sheet_by_name("PBDragonRefreshCostList")
        rowNum = table.nrows
        colNum = table.ncols

...
class TestBase(object):
    ...
    def __init__(self):
        self.working_path = r"D:\Automation\venus\master\venus" #os.environ["working_path"]
...
a = TestBase()
a.list_test_in_one_file(r"D:\Automation\venus\master\venus\testcase\tahoe\lba\io_testcases\02_io\test_atomic_normal.py")
pass
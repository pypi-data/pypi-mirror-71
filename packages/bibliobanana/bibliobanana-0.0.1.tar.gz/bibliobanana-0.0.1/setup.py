...
with open("README.md", "r", encoding='utf-8') as fh:
    ...
    # Stupid bug doesn't allow for whitespace in examples, so just remove them.
    long_description = long_description[:long_description.find("## Example 1")]
    long_description += "For example, please see: https://github.com/esdalmaijer/bibliobanana"

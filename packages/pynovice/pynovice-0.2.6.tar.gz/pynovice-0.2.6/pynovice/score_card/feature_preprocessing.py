...
if __name__ == '__main__':
    ...
    feature_generator = FeatureGenerator(auto_fill_missing=True)
    aa=feature_generator.fit_transform(df_fields,df_label,category_fields=['field1'])
    ...
    fields_json = {'field1':4, 'field232':5, 'aa':9}

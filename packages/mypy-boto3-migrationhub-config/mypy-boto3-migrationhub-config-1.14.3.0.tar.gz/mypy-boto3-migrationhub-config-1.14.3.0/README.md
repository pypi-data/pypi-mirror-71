...
[boto3.MigrationHubConfig 1.14.3](https://boto3.amazonaws.com/v1/documentation/api/1.14.3/reference/services/migrationhub-config.html#MigrationHubConfig) service

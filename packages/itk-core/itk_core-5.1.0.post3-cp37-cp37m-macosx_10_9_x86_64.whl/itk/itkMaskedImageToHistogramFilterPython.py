...
class itkMaskedImageToHistogramFilterICF2ISS2(itk.itkImageToHistogramFilterPython.itkImageToHistogramFilterICF2):
    ...
    \\sphinx \\sphinxexample{Numerics/Statistics/ComputeHistogramOfMas
    kedRegion,Compute Histogram Of Masked Region In Image} \\endsphinx
...
def masked_image_to_histogram_filter_init_docstring():
    ...
    masked_image_to_histogram_filter.__doc__ += "Available Keyword Arguments:\n"

...
class itkMeshFileReaderMD2(itk.itkMeshSourcePython.itkMeshSourceMD2):
    ...
    Wanlin Zhu. Uviversity of New South Wales, Australia.  \\sphinx
    \\sphinxexample{IO/Mesh/WriteMesh,Write Mesh}
    \\sphinxexample{IO/Mesh/ReadMesh,Read Mesh} \\endsphinx
...
def mesh_file_reader_init_docstring():
    ...
    mesh_file_reader.__doc__ += "Available Keyword Arguments:\n"

...
class itkCovariantVectorD2(itk.itkFixedArrayPython.itkFixedArrayD2):
    ...
    See:   Matrix  \\sphinx
    \\sphinxexample{Core/Common/CreateACovariantVector,Create a
    CovariantVector}
    \\sphinxexample{Core/Common/CovariantVectorNorm,Covariant Vector
    Norm} \\sphinxexample{Core/Common/CovariantVectorDotProduct,
    Covariant Vector Dot Product} \\endsphinx

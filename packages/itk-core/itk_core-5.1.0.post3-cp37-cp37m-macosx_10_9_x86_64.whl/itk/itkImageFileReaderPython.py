...
class itkImageFileReaderICF2(itk.itkImageSourcePython.itkImageSourceICF2):
    ...
    See:   ImageIOBase  \\sphinx
    \\sphinxexample{Core/Common/ReadWriteVectorImage,Read Write Vector
    Image} \\sphinxexample{IO/ImageBase/ReadUnknownImageType, Read
    Unknown Image Type} \\sphinxexample{IO/ImageBase/ReadAnImage,Read An
    Image} \\endsphinx

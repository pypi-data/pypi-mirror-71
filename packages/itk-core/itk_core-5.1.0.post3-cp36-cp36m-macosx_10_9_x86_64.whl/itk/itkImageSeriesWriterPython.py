...
class itkImageSeriesWriterICF2ICF2(itk.ITKCommonBasePython.itkProcessObject):
    ...
    See:   ImageSeriesReader  \\sphinx
    \\sphinxexample{IO/ImageBase/Creade3DFromSeriesOf2D,Creade 3D Volume
    From Series Of 2D Images} \\endsphinx
...
def image_series_writer_init_docstring():
    ...
    image_series_writer.__doc__ += "Available Keyword Arguments:\n"

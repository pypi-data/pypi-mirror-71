...
class itkLinearInterpolateImageFunctionICVF22D(itk.itkInterpolateImageFunctionPython.itkInterpolateImageFunctionICVF22D):
    ...
    See:  VectorLinearInterpolateImageFunction  \\sphinx
    \\sphinxexample{Core/ImageFunction/LinearlyInterpolatePo
    sitionInImage,Linearly Interpolate Position In Image} \\endsphinx

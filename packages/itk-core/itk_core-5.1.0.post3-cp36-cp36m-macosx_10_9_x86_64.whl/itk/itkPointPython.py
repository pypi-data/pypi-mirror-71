...
class itkPointD2(itk.itkFixedArrayPython.itkFixedArrayD2):
    ...
    See:   Matrix  \\sphinx
    \\sphinxexample{Core/Common/DistanceBetweenPoints,Distance between
    two points}
    \\sphinxexample{Core/Common/DistanceBetweenIndices,Distance between
    two indices} \\endsphinx

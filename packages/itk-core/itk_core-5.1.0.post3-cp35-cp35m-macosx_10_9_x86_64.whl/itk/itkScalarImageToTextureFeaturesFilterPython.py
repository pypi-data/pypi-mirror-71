...
class itkScalarImageToTextureFeaturesFilterID2(itk.ITKCommonBasePython.itkProcessObject):
    ...
    \\sphinx
    \\sphinxexample{Numerics/Statistics/ComputeTextureFeatures,Compute
    Texture Features} \\endsphinx
...
def scalar_image_to_texture_features_filter_init_docstring():
    ...
    scalar_image_to_texture_features_filter.__doc__ += "Available Keyword Arguments:\n"

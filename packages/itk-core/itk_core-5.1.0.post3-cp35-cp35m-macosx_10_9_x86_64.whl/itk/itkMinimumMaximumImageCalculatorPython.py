...
class itkMinimumMaximumImageCalculatorID2(itk.ITKCommonBasePython.itkObject):
    ...
    \\sphinx \\sphinxexample{Core/Common/FindMaxAndMinInImage,Find Max
    And Min In Image}
    \\sphinxexample{Developer/OilPaintingImageFilter,Multi-threaded oil
    painting image filter} \\endsphinx

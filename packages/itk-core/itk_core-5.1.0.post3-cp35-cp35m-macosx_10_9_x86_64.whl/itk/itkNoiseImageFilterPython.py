...
class itkNoiseImageFilterID2ID2(itk.itkBoxImageFilterPython.itkBoxImageFilterID2ID2):
    ...
    \\sphinxexample{Filtering/ImageFilterBase/ComputerLocalNoise,Compute
    Local Noise In Image} \\endsphinx
...
def noise_image_filter_init_docstring():
    ...
    noise_image_filter.__doc__ += "Available Keyword Arguments:\n"

...
class Config(metaclass=aurcore.util.Singleton):
    ...
    def __init__(self, name=""):
        ...
        if not (self.config_dir / "base.toml").exists():
            with (self.config_dir / "base.toml").open("w") as f:
                yaml.safe_dump({"prefix": ".."}, f)

        with (self.config_dir / "base.toml").open("r") as f:
    ...
    def _write_config_file(self, config_id, data):
        local_config_path: pl.Path = self.config_dir / f"{config_id}.toml"

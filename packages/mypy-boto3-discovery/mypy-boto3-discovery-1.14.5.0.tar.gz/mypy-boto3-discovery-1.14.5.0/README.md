...
[boto3.ApplicationDiscoveryService 1.14.5](https://boto3.amazonaws.com/v1/documentation/api/1.14.5/reference/services/discovery.html#ApplicationDiscoveryService) service

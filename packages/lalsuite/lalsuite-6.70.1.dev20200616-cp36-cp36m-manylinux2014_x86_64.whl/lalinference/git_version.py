...
id = "5c945656d20f005248e02da1b308b18f9c136b10"
date = "2020-06-12 15:22:10 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "5c945656d20f005248e02da1b308b18f9c136b10":
        return
    msg = "Program id (5c945656d20f005248e02da1b308b18f9c136b10) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":

...
from table.columns import DatetimeColumn, Column, ActionColumn
...
# def CompareColumn(*args, **kwargs):
#     """ Cria os botões de ação no final da linha da Table que pode ser para:
#             Comparação de versão usando reversion.
#     """
#
#     links = kwargs.get('links', [])
#     view = kwargs.get('view', 'versionViewCompare')
#
#     links += [FontAwesomeLink(text='Comprar Últimas Versões', viewname=view,
#                               args=(Accessor('id'),),
#                               span_fa='random', span_tip='Comprar Últimas Versões'), ]
#

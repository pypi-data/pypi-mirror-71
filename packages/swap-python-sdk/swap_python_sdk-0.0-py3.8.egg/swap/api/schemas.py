...
class ProgressUpdateSchema(Schema):
    ...
    notification_detail_url = fields.Str()
    notification_message_url = fields.Str()
    notification_trigger_timestamp = fields.Str()
    notification_type = fields.Str()
    offer_execution_request_to_cancel = fields.Str()
    output_data = fields.Nested(OutputDataSchema)
    permissible_service_provider_uuid = fields.Str()
    publish_time = fields.Str()
    results_dataset = fields.Nested(ResultsDatasetSchema)
    service_catalogue_uuid = fields.Str()
    service_offer_description = fields.Str()
    service_offer_name = fields.Str()

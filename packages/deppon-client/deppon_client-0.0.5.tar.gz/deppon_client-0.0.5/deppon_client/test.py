...
accessKey = '9128d7aed1aa04f6caaa1b379040b4b0b'  # 网关授权的AK密钥，从配置文件中获取，保存时必须做加密处理，读取后解密操作。
accessSecret = '3a61ae18e81048b6b6012d20a0e54535'  # 网关授权的SK密钥，从配置文件中获取，保存时必须做加密处理，读取后解密操作。
SysAccessKey = 'wbdUk1WqB1Rgwdw5Ig0ptKA1q0vZC5Ko'  # 被请求服务授权的AK密钥，从配置文件中获取，保存时必须做加密处理，读取后解密操作。
SysAccessSecret = 'j9hfxwu7TaIw2GmAvvic2H8tPzMwa2ju'  # 被请求服务授权的SK密钥，从配置文件中获取，保存时必须做加密处理，读取后解密操作。
...
if __name__ == u'__main__':
    ...
    queryString = {'1': '123'}
    res = get_sys_change(AuthObj, 'http://ams.deppontest.com:8000/amsc/message/', queryString)

...
class SegAppCharParseF1Metric(MetricBase):
    ...
    def evaluate(self, gold_word_pairs, gold_label_word_pairs, head_preds, label_preds, seq_len,
                 pun_masks):
        """
...
class CWSMetric(MetricBase):
    ...
    def evaluate(self, seg_targets, seg_masks, label_preds, seq_len):
        """
...
class ParserMetric(MetricBase):
    ...
    def evaluate(self, head_preds, label_preds, heads, labels, seq_len=None):

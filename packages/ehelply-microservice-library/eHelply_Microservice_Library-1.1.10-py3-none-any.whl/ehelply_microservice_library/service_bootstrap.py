...
from ehelply_microservice_library.utils.constants.constants_time import *
...
# The name of the environment variable that holds the gatekeeper key
...
class ServiceBootstrap(Bootstrap):
    ...
    def get_service_package_path(self) -> Path:
        ...
        Returns:
            str: Path of ehelply-package.json file
    ...
    def get_access_nodes(self) -> List[NodeCreate]:
        ...
        Returns:
            List[NodeCreate]: Nodes to be used throughout this service

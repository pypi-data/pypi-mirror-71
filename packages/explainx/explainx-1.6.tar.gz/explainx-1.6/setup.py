...
setup(
  ...
  description = 'Explain any Black-Box Machine Learning Model with explainX.ai : Fast, Scalable & State-of-the-art Explainable AI Platform.',   # Give a short description about your library
  ...
  download_url = 'https://github.com/explainX/explainx/archive/v_10.zip',    # I explain this later on
  ...
  classifiers=[
    ...
    package_data={'explainx':["lib/*", "datasets/*","tutorials/*"] },
)

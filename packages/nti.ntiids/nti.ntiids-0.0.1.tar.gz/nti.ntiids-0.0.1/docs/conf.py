# -*- coding: utf-8 -*-
#
# nti.ntiids documentation build configuration file, created by
...
rqmt = pkg_resources.require('nti.ntiids')[0]
...
latex_documents = [
    (master_doc, 'ntintiids.tex', u'nti.ntiids Documentation',
...
man_pages = [
    (master_doc, 'ntintiids', u'nti.ntiids Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ntintiids', u'nti.ntiids Documentation',
     author, 'ntintiids', 'One line description of project.',
     'Miscellaneous'),
]
...
extlinks = {
    'issue': ('https://github.com/NextThought/nti.ntiids/issues/%s',
              'issue #'),
    'pr': ('https://github.com/NextThought/nti.ntiids/pull/%s',
           'pull request #')}

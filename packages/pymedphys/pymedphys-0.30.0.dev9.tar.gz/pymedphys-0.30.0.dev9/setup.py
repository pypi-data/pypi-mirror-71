...
['pymedphys',
 ...
 'pymedphys.tests.labs.paulking.film',
 'pymedphys.tests.labs.paulking.test_coll',
...
{'': ['*'],
 ...
 'pymedphys.tests.dicom': ['data/anonymise/*', 'data/rtplan/*', 'scratch/*'],
 'pymedphys.tests.e2e': ['cypress/*',
                         'cypress/integration/streamlit/*',
                         'cypress/plugins/*',
                         'cypress/support/*'],
 'pymedphys.tests.labs.paulking.film': ['data/*'],
 'pymedphys.tests.tpscompare': ['data/baselines/*', 'data/measurements/*']}

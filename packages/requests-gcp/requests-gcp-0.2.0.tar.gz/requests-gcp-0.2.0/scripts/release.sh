...
sed -i.bak "s/version =.*/version = '$VERSION'/g" ./requestsgcp/version.py
echo "Updated version on ./requestsgcp/version.py to $VERSION"
...
echo "Committing..."
git add ./requestsgcp/version.py
...
# Package requestsgcp
rm -rf dist/ build/ requestsgcp.egg-info/
python3 setup.py sdist bdist_wheel
# Upload requestsgcp to PyPi
twine upload dist/*

...
- **saw** - How to install Kqlmagic on a Secure Access Workstation (saw).<br>
<br>
...
- Secure Access Workstation (saw) is limiting which python modules are allowed. {Constants.MAGIC_PACKAGE_NAME} replace some of the modules with similar modules that are allowed on 'saw'.<br>
To install {Constants.MAGIC_PACKAGE_NAME} on 'saw' you must set environment variable **{Constants.MAGIC_CLASS_NAME_UPPER}_INSTALL** to 'saw', before the 'pip' command is executed.<br>
<br>

## Windows install example
```
{Constants.MAGIC_CLASS_NAME_UPPER}_INSTALL=saw
pip install {Constants.MAGIC_PACKAGE_NAME}
```
<br>

## Linux install example
```
{Constants.MAGIC_CLASS_NAME_UPPER}_INSTALL=saw pip install {Constants.MAGIC_PACKAGE_NAME}
```
<br>

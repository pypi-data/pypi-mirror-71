...
# $Id: generate_finding_charts.py 249364 2020-01-22 16:08:10Z jpritcha $
from __future__ import print_function

_VERSION_ = "$Revision: 249364 $"
...
"""
    ...
    group.add_option("--bk_lam", dest="bk_lam", metavar="BK_LAM", help="Description of the WL coverage of the custom background image/survey [optional]", default=None)

...
if CODE_BUILD_IN_PROGRESS:
    ...
    sub_class = empty_class

# Way we use to include easydaq.DAQDevice subclass:
#import easydaq
#class Server32(HTTPServer, easydaq.DAQDevice):

###############################################################################

# Declare Server32 class
class Server32(HTTPServer, sub_class):

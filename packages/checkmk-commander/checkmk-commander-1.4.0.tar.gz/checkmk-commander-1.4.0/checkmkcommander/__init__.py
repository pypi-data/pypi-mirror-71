...
class Chk:
    ...
    host = None
    service = None
    browser_hostname = 'x-www-browser http://wiki.example.com/?q=HOSTNAME'
    ...
    def validate_config(self):
        ...
        if not os.path.isfile(self.config_path):
            ...
            config.set('main', 'browser_hostname', self.browser_hostname)
        ...
        # Load existing
            ...
            self.browser_hostname = config.get('main', 'browser_hostname',
                fallback=self.browser_hostname)
    ...
    def open_browser_hostname(self):
        ...
        cmd = self.browser_hostname.replace('HOSTNAME', self.target)

...
from qoalai.object_detector.detector_utils_b import *
...
class Yolo(ObjectDetector):
    ...
    def build_net(self, input_tensor, 
        ...
        with tf.variable_scope('yolo_v3_model'):
            self.build_yolov3_net(inputs=input_tensor, 
    ...
    def optimize(self, subdivisions, 
        ...
        for i in range(iterations):
            ...
            for j in range (subdivisions):
                ...
                print ("> Train sub", j, ': iou: ', round(iou_avg*100, 3), 
                        'obj acc: ', round(obj_acc*100, 3), 'noobj acc: ', round(noobj_acc*100, 3), 
                        'class acc: ', round(class_acc*100, 3))
            ...
            print ('eph: ', i, 'ttl loss: ', round(total, 2), 'obj loss: ', round(obj*100, 2), \
                    'noobj loss: ', round(noobj*100, 2), 'ctr loss: ', round(ctr*100, 2), 'size loss: ',
                     round(size*100, 2),  round(class_l*100, 2), sign)

...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.3.0-alpha.1592391689+c6b8e809'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.3.0-alpha.1592391689+c6b8e809`
                """)
            else:
                raise

...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', '2.3.0-alpha.1592239400+3dfa83f0'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul 2.3.0-alpha.1592239400+3dfa83f0`
                """)
            else:
                raise

...
from tlclient.trader.pb_msg import Exchange, Side, OrderType, OffsetFlag
...
valid_exchange =        {'sse': ExchangeID.SSE, 'sze': ExchangeID.SZE, 'hk': ExchangeID.HK,
                         ...
                         'ine': ExchangeID.INE, 'czce': ExchangeID.CZCE}
...
class SampleClient(Client):
    def __init__(self, config_file):
        ...
        curve_server_key = config_dict['curve_server_key']
        Client.__init__(self, name=client_name, env_name=environment, addr=master_address, curve_server_key=curve_server_key)

# -*- coding: utf-8 -*-
#
# nti.intid documentation build configuration file, created by
...
rqmt = pkg_resources.require('nti.intid')[0]
...
latex_documents = [
    (master_doc, 'ntiintid.tex', u'nti.intid Documentation',
...
man_pages = [
    (master_doc, 'ntiintid', u'nti.intid Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ntiintid', u'nti.intid Documentation',
     author, 'ntiintid', 'One line description of project.',
     'Miscellaneous'),
]

...
setuptools.setup(
    ...
    url='https://github.com/drmingdrmer/k3fs',
    keywords=['fs', 'file', 'dir'],
    python_requires='>=3.0',

    install_requires=['semantic_version~=2.8.5', 'jinja2~=2.11.2', 'PyYAML~=5.3.1', 'sphinx~=3.1.0', 'psutil~=5.6.7', 'k3confloader~=0.1.0', 'k3time~=0.1.3', 'k3ut~=0.1.7', 'k3thread~=0.1.0'],
    classifiers=[

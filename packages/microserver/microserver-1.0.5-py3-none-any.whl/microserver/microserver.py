...
class MicroServer:
    ...
    def __init__(self, data_dir, ip='INADDR_LOOPBACK', port=glb.DEFAULT_SERVER_PORT, s_port=glb.DEFAULT_SSL_SERVER_PORT, delay=glb.DEFAULT_SERVER_DELAY,
                 timeout=None, useSSL=False, sslKey='ssl/server.pem', sslCert='ssl/server.crt',
                 clientVerify=False, hooks='', lookupKey='{PATH}', both=False, verbose=True, clientCA="/etc/ssl/certs/ca-certificates.crt"):

...
class GAN():
    ...
    def fit(self,
        ...
        for epoch in range(epochs):
            ...
            for image_batch in dataset:
                generated_images, target_images = self.train_step(
                    image_batch, batch_size, step, max_outputs, file_writer)
    ...
    @tf.function
    def train_step(self, target_images, batch_size, step, max_outputs,
                   file_writer):
        ...
        with file_writer.as_default():
            ...
            with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
                ...
                disc_generated = self.discriminator(generated_images,
                                                    training=True)

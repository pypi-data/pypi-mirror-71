...
from micropm4py.log.xes_import_traces_file_minimal_dfg import imp_dfg_file
from micropm4py.log.xes_import_traces_file_minimal_it import get_it_from_file, get_nxt_trace

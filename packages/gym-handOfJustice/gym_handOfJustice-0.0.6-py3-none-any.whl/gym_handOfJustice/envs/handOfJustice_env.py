...
class HandOfJusticeEnv(gym.Env):
    ...
    def __init__(self,cap=cv2.VideoCapture(0),mod="Direct",epsilon=150,preprocess=None,resolution=(56,56,3)):
        ...
        self.res=resolution
        self.observation_space = spaces.Box(0,2.55,shape=(self.res[0]*2,self.res[1],self.res[2]))
    ...
    def step(self,action):
        ...
        return np.append(self.target,self.getImage(flag=True),axis=0), -1*error , done, {}

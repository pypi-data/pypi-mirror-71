...
def test_eval(string_generator, sample, l_suffix, r_suffix):
    generated = generate_sample_for_all_states(string_generator, sample, l_suffix, r_suffix)
...
def test_suffix():
    ...
    l_suffix = "_l_suffix"
    r_suffix = "_r_suffix"
    generated = generate_sample_for_all_states(correct, MATCHING_SAMPLE, l_suffix, r_suffix)

    expected_df_format = get_expected_df_format(correct)
...
def test_string_column():
    ...
    correct = mbsg.CorrectBaseStringGenerator(MOCK_CONFIG)
    l_suffix = "_l_suffix"
    generated = generate_sample_for_all_states(correct, STRING_COLUMN_SAMPLE, l_suffix, "_r_suffix")

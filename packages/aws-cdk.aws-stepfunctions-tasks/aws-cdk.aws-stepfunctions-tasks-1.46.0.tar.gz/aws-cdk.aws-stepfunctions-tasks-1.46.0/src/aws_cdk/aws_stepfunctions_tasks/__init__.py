...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.BatchContainerOverrides", jsii_struct_bases=[], name_mapping={'command': 'command', 'environment': 'environment', 'gpu_count': 'gpuCount', 'instance_type': 'instanceType', 'memory': 'memory', 'vcpus': 'vcpus'})
class BatchContainerOverrides():
    def __init__(self, *, command: typing.Optional[typing.List[str]]=None, environment: typing.Optional[typing.Mapping[str, str]]=None, gpu_count: typing.Optional[jsii.Number]=None, instance_type: typing.Optional[aws_cdk.aws_ec2.InstanceType]=None, memory: typing.Optional[aws_cdk.core.Size]=None, vcpus: typing.Optional[jsii.Number]=None) -> None:
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.BatchJobDependency", jsii_struct_bases=[], name_mapping={'job_id': 'jobId', 'type': 'type'})
...
class BatchSubmitJob(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.BatchSubmitJob"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, job_definition: aws_cdk.aws_batch.IJobDefinition, job_name: str, job_queue: aws_cdk.aws_batch.IJobQueue, array_size: typing.Optional[jsii.Number]=None, attempts: typing.Optional[jsii.Number]=None, container_overrides: typing.Optional["BatchContainerOverrides"]=None, depends_on: typing.Optional[typing.List["BatchJobDependency"]]=None, payload: typing.Optional[aws_cdk.aws_stepfunctions.TaskInput]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.BatchSubmitJobProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'job_definition': 'jobDefinition', 'job_name': 'jobName', 'job_queue': 'jobQueue', 'array_size': 'arraySize', 'attempts': 'attempts', 'container_overrides': 'containerOverrides', 'depends_on': 'dependsOn', 'payload': 'payload'})
class BatchSubmitJobProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, job_definition: aws_cdk.aws_batch.IJobDefinition, job_name: str, job_queue: aws_cdk.aws_batch.IJobQueue, array_size: typing.Optional[jsii.Number]=None, attempts: typing.Optional[jsii.Number]=None, container_overrides: typing.Optional["BatchContainerOverrides"]=None, depends_on: typing.Optional[typing.List["BatchJobDependency"]]=None, payload: typing.Optional[aws_cdk.aws_stepfunctions.TaskInput]=None) -> None:
...
class EmrAddStep(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrAddStep"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster_id: str, jar: str, name: str, action_on_failure: typing.Optional["ActionOnFailure"]=None, args: typing.Optional[typing.List[str]]=None, main_class: typing.Optional[str]=None, properties: typing.Optional[typing.Mapping[str, str]]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrAddStepProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'cluster_id': 'clusterId', 'jar': 'jar', 'name': 'name', 'action_on_failure': 'actionOnFailure', 'args': 'args', 'main_class': 'mainClass', 'properties': 'properties'})
class EmrAddStepProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, cluster_id: str, jar: str, name: str, action_on_failure: typing.Optional["ActionOnFailure"]=None, args: typing.Optional[typing.List[str]]=None, main_class: typing.Optional[str]=None, properties: typing.Optional[typing.Mapping[str, str]]=None) -> None:
...
class EmrCancelStep(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrCancelStep"):
    """A Step Functions Task to to cancel a Step on an EMR Cluster.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster_id: str, step_id: str, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrCancelStepProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'cluster_id': 'clusterId', 'step_id': 'stepId'})
class EmrCancelStepProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, cluster_id: str, step_id: str) -> None:
...
class EmrCreateCluster(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrCreateCluster"):
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, instances: "InstancesConfigProperty", name: str, additional_info: typing.Optional[str]=None, applications: typing.Optional[typing.List["ApplicationConfigProperty"]]=None, auto_scaling_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, bootstrap_actions: typing.Optional[typing.List["BootstrapActionConfigProperty"]]=None, cluster_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, configurations: typing.Optional[typing.List["ConfigurationProperty"]]=None, custom_ami_id: typing.Optional[str]=None, ebs_root_volume_size: typing.Optional[aws_cdk.core.Size]=None, kerberos_attributes: typing.Optional["KerberosAttributesProperty"]=None, log_uri: typing.Optional[str]=None, release_label: typing.Optional[str]=None, scale_down_behavior: typing.Optional["EmrClusterScaleDownBehavior"]=None, security_configuration: typing.Optional[str]=None, service_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, tags: typing.Optional[typing.Mapping[str, str]]=None, visible_to_all_users: typing.Optional[bool]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
    ...
    class CloudWatchAlarmDefinitionProperty():
        def __init__(self, *, comparison_operator: "EmrCreateCluster.CloudWatchAlarmComparisonOperator", metric_name: str, period: aws_cdk.core.Duration, dimensions: typing.Optional[typing.List["EmrCreateCluster.MetricDimensionProperty"]]=None, evaluation_periods: typing.Optional[jsii.Number]=None, namespace: typing.Optional[str]=None, statistic: typing.Optional["EmrCreateCluster.CloudWatchAlarmStatistic"]=None, threshold: typing.Optional[jsii.Number]=None, unit: typing.Optional["EmrCreateCluster.CloudWatchAlarmUnit"]=None) -> None:
    ...
    @jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrCreateCluster.VolumeSpecificationProperty", jsii_struct_bases=[], name_mapping={'volume_size': 'volumeSize', 'volume_type': 'volumeType', 'iops': 'iops'})
    class VolumeSpecificationProperty():
        def __init__(self, *, volume_size: aws_cdk.core.Size, volume_type: "EmrCreateCluster.EbsBlockDeviceVolumeType", iops: typing.Optional[jsii.Number]=None) -> None:
            """EBS volume specifications such as volume type, IOPS, and size (GiB) that will be requested for the EBS volume attached to an EC2 instance in the cluster.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrCreateClusterProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'instances': 'instances', 'name': 'name', 'additional_info': 'additionalInfo', 'applications': 'applications', 'auto_scaling_role': 'autoScalingRole', 'bootstrap_actions': 'bootstrapActions', 'cluster_role': 'clusterRole', 'configurations': 'configurations', 'custom_ami_id': 'customAmiId', 'ebs_root_volume_size': 'ebsRootVolumeSize', 'kerberos_attributes': 'kerberosAttributes', 'log_uri': 'logUri', 'release_label': 'releaseLabel', 'scale_down_behavior': 'scaleDownBehavior', 'security_configuration': 'securityConfiguration', 'service_role': 'serviceRole', 'tags': 'tags', 'visible_to_all_users': 'visibleToAllUsers'})
class EmrCreateClusterProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, instances: "EmrCreateCluster.InstancesConfigProperty", name: str, additional_info: typing.Optional[str]=None, applications: typing.Optional[typing.List["EmrCreateCluster.ApplicationConfigProperty"]]=None, auto_scaling_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, bootstrap_actions: typing.Optional[typing.List["EmrCreateCluster.BootstrapActionConfigProperty"]]=None, cluster_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, configurations: typing.Optional[typing.List["EmrCreateCluster.ConfigurationProperty"]]=None, custom_ami_id: typing.Optional[str]=None, ebs_root_volume_size: typing.Optional[aws_cdk.core.Size]=None, kerberos_attributes: typing.Optional["EmrCreateCluster.KerberosAttributesProperty"]=None, log_uri: typing.Optional[str]=None, release_label: typing.Optional[str]=None, scale_down_behavior: typing.Optional["EmrCreateCluster.EmrClusterScaleDownBehavior"]=None, security_configuration: typing.Optional[str]=None, service_role: typing.Optional[aws_cdk.aws_iam.IRole]=None, tags: typing.Optional[typing.Mapping[str, str]]=None, visible_to_all_users: typing.Optional[bool]=None) -> None:
...
class EmrModifyInstanceFleetByName(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrModifyInstanceFleetByName"):
    """A Step Functions Task to to modify an InstanceFleet on an EMR Cluster.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster_id: str, instance_fleet_name: str, target_on_demand_capacity: jsii.Number, target_spot_capacity: jsii.Number, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param cluster_id: The ClusterId to update.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrModifyInstanceFleetByNameProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'cluster_id': 'clusterId', 'instance_fleet_name': 'instanceFleetName', 'target_on_demand_capacity': 'targetOnDemandCapacity', 'target_spot_capacity': 'targetSpotCapacity'})
class EmrModifyInstanceFleetByNameProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, cluster_id: str, instance_fleet_name: str, target_on_demand_capacity: jsii.Number, target_spot_capacity: jsii.Number) -> None:
...
class EmrModifyInstanceGroupByName(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrModifyInstanceGroupByName"):
    """A Step Functions Task to to modify an InstanceGroup on an EMR Cluster.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster_id: str, instance_group: "InstanceGroupModifyConfigProperty", instance_group_name: str, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param cluster_id: The ClusterId to update.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrModifyInstanceGroupByNameProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'cluster_id': 'clusterId', 'instance_group': 'instanceGroup', 'instance_group_name': 'instanceGroupName'})
class EmrModifyInstanceGroupByNameProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, cluster_id: str, instance_group: "EmrModifyInstanceGroupByName.InstanceGroupModifyConfigProperty", instance_group_name: str) -> None:
...
class EmrSetClusterTerminationProtection(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrSetClusterTerminationProtection"):
    """A Step Functions Task to to set Termination Protection on an EMR Cluster.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster_id: str, termination_protected: bool, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
        :param cluster_id: The ClusterId to update.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrSetClusterTerminationProtectionProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'cluster_id': 'clusterId', 'termination_protected': 'terminationProtected'})
class EmrSetClusterTerminationProtectionProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, cluster_id: str, termination_protected: bool) -> None:
...
class EmrTerminateCluster(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrTerminateCluster"):
    """A Step Functions Task to terminate an EMR Cluster.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, cluster_id: str, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.EmrTerminateClusterProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'cluster_id': 'clusterId'})
class EmrTerminateClusterProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, cluster_id: str) -> None:
...
class ISageMakerTask(aws_cdk.aws_iam.IGrantable, jsii.compat.Protocol):
...
class _ISageMakerTaskProxy(jsii.proxy_for(aws_cdk.aws_iam.IGrantable)):
    """Task to train a machine learning model using Amazon SageMaker.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.ResourceConfig", jsii_struct_bases=[], name_mapping={'instance_count': 'instanceCount', 'instance_type': 'instanceType', 'volume_size': 'volumeSize', 'volume_encryption_key': 'volumeEncryptionKey'})
class ResourceConfig():
    def __init__(self, *, instance_count: jsii.Number, instance_type: aws_cdk.aws_ec2.InstanceType, volume_size: aws_cdk.core.Size, volume_encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None) -> None:
...
class SageMakerCreateTrainingJob(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.SageMakerCreateTrainingJob"):
    """Class representing the SageMaker Create Training Job task.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, algorithm_specification: "AlgorithmSpecification", input_data_config: typing.List["Channel"], output_data_config: "OutputDataConfig", training_job_name: str, hyperparameters: typing.Optional[typing.Mapping[str, typing.Any]]=None, resource_config: typing.Optional["ResourceConfig"]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, stopping_condition: typing.Optional["StoppingCondition"]=None, tags: typing.Optional[typing.Mapping[str, str]]=None, vpc_config: typing.Optional["VpcConfig"]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.SageMakerCreateTrainingJobProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'algorithm_specification': 'algorithmSpecification', 'input_data_config': 'inputDataConfig', 'output_data_config': 'outputDataConfig', 'training_job_name': 'trainingJobName', 'hyperparameters': 'hyperparameters', 'resource_config': 'resourceConfig', 'role': 'role', 'stopping_condition': 'stoppingCondition', 'tags': 'tags', 'vpc_config': 'vpcConfig'})
class SageMakerCreateTrainingJobProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, algorithm_specification: "AlgorithmSpecification", input_data_config: typing.List["Channel"], output_data_config: "OutputDataConfig", training_job_name: str, hyperparameters: typing.Optional[typing.Mapping[str, typing.Any]]=None, resource_config: typing.Optional["ResourceConfig"]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, stopping_condition: typing.Optional["StoppingCondition"]=None, tags: typing.Optional[typing.Mapping[str, str]]=None, vpc_config: typing.Optional["VpcConfig"]=None) -> None:
...
class SageMakerCreateTransformJob(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.SageMakerCreateTransformJob"):
    """Class representing the SageMaker Create Training Job task.

    stability
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, model_name: str, transform_input: "TransformInput", transform_job_name: str, transform_output: "TransformOutput", batch_strategy: typing.Optional["BatchStrategy"]=None, environment: typing.Optional[typing.Mapping[str, str]]=None, max_concurrent_transforms: typing.Optional[jsii.Number]=None, max_payload: typing.Optional[aws_cdk.core.Size]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, tags: typing.Optional[typing.Mapping[str, str]]=None, transform_resources: typing.Optional["TransformResources"]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.SageMakerCreateTransformJobProps", jsii_struct_bases=[aws_cdk.aws_stepfunctions.TaskStateBaseProps], name_mapping={'comment': 'comment', 'heartbeat': 'heartbeat', 'input_path': 'inputPath', 'integration_pattern': 'integrationPattern', 'output_path': 'outputPath', 'result_path': 'resultPath', 'timeout': 'timeout', 'model_name': 'modelName', 'transform_input': 'transformInput', 'transform_job_name': 'transformJobName', 'transform_output': 'transformOutput', 'batch_strategy': 'batchStrategy', 'environment': 'environment', 'max_concurrent_transforms': 'maxConcurrentTransforms', 'max_payload': 'maxPayload', 'role': 'role', 'tags': 'tags', 'transform_resources': 'transformResources'})
class SageMakerCreateTransformJobProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, model_name: str, transform_input: "TransformInput", transform_job_name: str, transform_output: "TransformOutput", batch_strategy: typing.Optional["BatchStrategy"]=None, environment: typing.Optional[typing.Mapping[str, str]]=None, max_concurrent_transforms: typing.Optional[jsii.Number]=None, max_payload: typing.Optional[aws_cdk.core.Size]=None, role: typing.Optional[aws_cdk.aws_iam.IRole]=None, tags: typing.Optional[typing.Mapping[str, str]]=None, transform_resources: typing.Optional["TransformResources"]=None) -> None:
...
class StepFunctionsStartExecution(aws_cdk.aws_stepfunctions.TaskStateBase, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-stepfunctions-tasks.StepFunctionsStartExecution"):
    """A Step Functions Task to call StartExecution on another state machine.
    ...
    :stability: experimental
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, state_machine: aws_cdk.aws_stepfunctions.IStateMachine, input: typing.Optional[aws_cdk.aws_stepfunctions.TaskInput]=None, name: typing.Optional[str]=None, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None) -> None:
        """
        :param scope: -
        :param id: -
...
class StepFunctionsStartExecutionProps(aws_cdk.aws_stepfunctions.TaskStateBaseProps):
    def __init__(self, *, comment: typing.Optional[str]=None, heartbeat: typing.Optional[aws_cdk.core.Duration]=None, input_path: typing.Optional[str]=None, integration_pattern: typing.Optional[aws_cdk.aws_stepfunctions.IntegrationPattern]=None, output_path: typing.Optional[str]=None, result_path: typing.Optional[str]=None, timeout: typing.Optional[aws_cdk.core.Duration]=None, state_machine: aws_cdk.aws_stepfunctions.IStateMachine, input: typing.Optional[aws_cdk.aws_stepfunctions.TaskInput]=None, name: typing.Optional[str]=None) -> None:
        """Properties for StartExecution.
...
@jsii.data_type(jsii_type="@aws-cdk/aws-stepfunctions-tasks.TransformResources", jsii_struct_bases=[], name_mapping={'instance_count': 'instanceCount', 'instance_type': 'instanceType', 'volume_encryption_key': 'volumeEncryptionKey'})
class TransformResources():
    def __init__(self, *, instance_count: jsii.Number, instance_type: aws_cdk.aws_ec2.InstanceType, volume_encryption_key: typing.Optional[aws_cdk.aws_kms.IKey]=None) -> None:
        """ML compute instances for the transform job.

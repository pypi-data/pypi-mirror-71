from helpers.global_vars import standard_parameters
...
def get_filters_and_sort_from_request(request_meth):
    """
    Get request meth from webix (example of structure: "GET http://127.0.0.1:9000/?price[gte]=10&price[lte]=100&limit=20&offset=100&sort_by=desc[name],asc[email]&locale=pt-PT")
    ...
    for parameter, value in request_meth.items():
        ...
        if not value or (parameter in standard_parameters):
            continue

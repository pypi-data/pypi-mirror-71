...
(self.webpackJsonp=self.webpackJsonp||[]).push([[37],{207:function(e,t,i){"use strict";i.d(t,"a",function(){return a});var n=i(10);const r=new WeakMap,a=Object(n.f)(e=>t=>{const i=r.get(t);if(void 0===e&&t instanceof n.a){if(void 0!==i||!r.has(t)){const e=t.committer.name;t.committer.element.removeAttribute(e)}}else e!==i&&t.setValue(e);r.set(t,e)})},220:function(e,t,i){"use strict";i.d(t,"b",function(){return n}),i.d(t,"a",function(){return r});const n=(e,t)=>e<t?-1:e>t?1:0,r=(e,t)=>n(e.toLowerCase(),t.toLowerCase())},278:function(e,t,i){"use strict";i.d(t,"a",function(){return a});const n=[60,60,24,7],r=["second","minute","hour","day"];function a(e,t,i={}){let a=((i.compareTime||new Date).getTime()-e.getTime())/1e3;const o=a>=0?"past":"future";let s;a=Math.abs(a);for(let c=0;c<n.length;c++){if(a<n[c]){a=Math.floor(a),s=t(`ui.components.relative_time.duration.${r[c]}`,"count",a);break}a/=n[c]}return void 0===s&&(s=t("ui.components.relative_time.duration.week","count",a=Math.floor(a))),!1===i.includeTense?s:t(`ui.components.relative_time.${o}`,"time",s)}},290:function(e,t,i){"use strict";var n=i(3),r=i(31),a=i(278),o=i(206);customElements.define("ha-relative-time",class extends(Object(o.a)(r.a)){static get properties(){return{hass:Object,datetime:{type:String,observer:"datetimeChanged"},datetimeObj:{type:Object,observer:"datetimeObjChanged"},parsedDateTime:Object}}constructor(){super(),this.updateRelative=this.updateRelative.bind(this)}connectedCallback(){super.connectedCallback(),this.updateInterval=setInterval(this.updateRelative,6e4)}disconnectedCallback(){super.disconnectedCallback(),clearInterval(this.updateInterval)}datetimeChanged(e){this.parsedDateTime=e?new Date(e):null,this.updateRelative()}datetimeObjChanged(e){this.parsedDateTime=e,this.updateRelative()}updateRelative(){const e=Object(n.a)(this);this.parsedDateTime?e.innerHTML=Object(a.a)(this.parsedDateTime,this.localize):e.innerHTML=this.localize("ui.components.relative_time.never")}})},305:function(e,t,i){"use strict";var n=i(4),r=i(31),a=i(204),o=i(125);i(290),i(219);customElements.define("state-info",class extends r.a{static get template(){return n.a`
    ...
    `}}]}},n.a)}}]);
//# sourceMappingURL=chunk.433b6fe80541d98e5d42.js.map
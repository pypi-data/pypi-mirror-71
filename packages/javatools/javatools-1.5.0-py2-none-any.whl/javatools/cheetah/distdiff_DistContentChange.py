...
__CHEETAH_srcLastModified__ = 'Fri Jun 21 12:21:35 2019'
...
class distdiff_DistContentChange(change_Change):
    ...
    def description(self, **KWS):
        ...
        ## CHEETAH: generated from #block description at line 3, col 1.
        trans = KWS.get("trans")
...
''')
        _v = VFFSL(SL,"escape",False)(VFFSL(SL,"change.entry",True)) # u'$escape($change.entry)' on line 5, col 1
...
if not hasattr(distdiff_DistContentChange, '_initCheetahAttributes'):
    templateAPIClass = getattr(distdiff_DistContentChange,

...
__CHEETAH_srcLastModified__ = 'Fri Jun 21 12:16:25 2019'
...
class subreport(change_SuperChange):
    ...
    def description(self, **KWS):
        ...
        ## CHEETAH: generated from #block description at line 4, col 1.
        trans = KWS.get("trans")
...
<h2 id="''')
        _v = VFFSL(SL,"change.__class__.__name__",True) # u'$change.__class__.__name__' on line 5, col 9
        if _v is not None: write(_filter(_v, rawExpr=u'$change.__class__.__name__'))
        write(u'''">''')
        _v = VFFSL(SL,"change.label",True) # u'$change.label' on line 5, col 37
        if _v is not None: write(_filter(_v, rawExpr=u'$change.label'))
        write(u'''</h2>

<div class="description">
''')
        _v = VFFSL(SL,"escape",False)(VFN(VFFSL(SL,"change",True),"get_description",False)()) # u'$escape($change.get_description())' on line 8, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$escape($change.get_description())'))
        write(u'''
</div>
''')
        write(u'''
...
if not hasattr(subreport, '_initCheetahAttributes'):
    templateAPIClass = getattr(subreport,

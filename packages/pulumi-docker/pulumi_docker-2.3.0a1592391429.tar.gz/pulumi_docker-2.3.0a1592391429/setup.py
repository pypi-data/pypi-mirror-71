...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v2.3.0-alpha.1592391429+g2028df6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v2.3.0-alpha.1592391429+g2028df6`
                """)
            else:
                raise

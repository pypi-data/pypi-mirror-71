...
setup(
  ...
  version = '1.3.1.2',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/Lemon-Chad/sxPDK/archive/v_1.3.1.2.zip',    # I explain this later on

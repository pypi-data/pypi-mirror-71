...
if __name__ == "__main__":
    ...
    # Change the model to use more general information to work effectively.

    # For example: 
    # name, subcategories, category, abbreviation, and metatype can be a more consistent use of connection than all other things.  

...
class AllocationStatsVariates(BaseModel):
    ...
    def get_model(self) -> AllocationModel:
        return AllocationModel(
              rolling_mean_3         = self.zero_complex(self.rolling_mean_3.get()),
              rolling_mean_5         = self.zero_complex(self.rolling_mean_5.get()),
              rolling_mean_7         = self.zero_complex(self.rolling_mean_7.get()),
              rolling_mean_10        = self.zero_complex(self.rolling_mean_10.get()),
              ...
              rolling_sem_10         = self.zero_complex(self.rolling_sem_10.get()),
              rolling_var_3          = self.zero_complex(self.rolling_var_3.get()),
              rolling_var_5          = self.zero_complex(self.rolling_var_5.get()),
              rolling_var_7          = self.zero_complex(self.rolling_var_7.get()),
              rolling_var_10         = self.zero_complex(self.rolling_var_10.get()),
              auto_regression_2      = self.zero_complex(self.auto_regression_3.get()),
              auto_regression_4      = self.zero_complex(self.auto_regression_4.get()),
              auto_regression_6      = self.zero_complex(self.auto_regression_5.get()),
              pct_filled_2           = self.zero_complex(self.mean_pct_filled_2.get()),
              pct_filled_4           = self.zero_complex(self.mean_pct_filled_4.get()),
              pct_filled_6           = self.zero_complex(self.mean_pct_filled_6.get()),
              auto_corr_pct_filled_2 = self.zero_complex(self.auto_corr_pct_filled_2.get()),
              auto_corr_pct_filled_4 = self.zero_complex(self.auto_corr_pct_filled_4.get()),

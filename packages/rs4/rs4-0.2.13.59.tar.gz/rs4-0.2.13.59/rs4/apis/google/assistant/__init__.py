...
def register_device (device_model_id, project_id = None):
...
# conversation ------------------------------------------
def _request (audio_source, lang = 'ko-KR', output_audio_file = None, once = True, display = True, verbose = False, *args, **kwargs):
...
def send_wav (input_audio_file, lang = 'ko-KR', output_audio_file = None, once = True, display = True, verbose = False, *args, **kwargs):
    ...
    return _request (audio_source, lang, output_audio_file, once, display, verbose, *args, **kwargs)
...
def use_device (device, lang = 'ko-KR', output_audio_file = None, once = True, display = True, verbose = False, *args, **kwargs):
    ...
    resp = _request (audio_source, lang, output_audio_file, once, display, verbose, *args, **kwargs)
    audio_source.close ()
    return resp

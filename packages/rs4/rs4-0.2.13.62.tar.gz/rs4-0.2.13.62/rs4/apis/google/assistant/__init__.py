...
# conversation ------------------------------------------
def _request (audio_source, lang, output_audio_file, display, verbose, timeout):
...
def send_wav (input_audio_file, lang = 'ko-KR', output_audio_file = None, display = True, verbose = False, timeout = DEFAULT_GRPC_DEADLINE):
    audio_source = audio_helpers.WaveSource (
        open(input_audio_file, 'rb'),
        sample_rate=audio_sample_rate,
        sample_width=audio_sample_width
    )
    return _request (audio_source, lang, output_audio_file, display, verbose, timeout)

def use_device (device, lang = 'ko-KR', output_audio_file = None, display = True, verbose = False, timeout = DEFAULT_GRPC_DEADLINE):
    ...
    resp = _request (audio_source, lang, output_audio_file, display, verbose, timeout)
    audio_source.close ()
    return resp

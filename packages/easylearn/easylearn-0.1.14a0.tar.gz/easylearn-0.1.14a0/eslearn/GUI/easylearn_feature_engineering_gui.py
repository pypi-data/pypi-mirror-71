...
# Form implementation generated from reading ui file 'D:/My_Codes/easylearn-fmri/eslearn/GUI/V2/easylearn_feature_engineering_gui.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radioButton_demean = QtWidgets.QRadioButton(self.groupBox_preprocessing_method)
        ...
        self.radioButton_ica = QtWidgets.QRadioButton(self.groupBox_dimension_reduction)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lineEdit_ica_components = QtWidgets.QLineEdit(self.to_ica)
        self.lineEdit_ica_components.setObjectName("lineEdit_ica_components")
        self.gridLayout_6.addWidget(self.lineEdit_ica_components, 0, 1, 1, 1)
        self.label_ica_components = QtWidgets.QLabel(self.to_ica)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_ica_components.sizePolicy().hasHeightForWidth())
        self.label_ica_components.setSizePolicy(sizePolicy)
        self.label_ica_components.setObjectName("label_ica_components")
        self.gridLayout_6.addWidget(self.label_ica_components, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_ica_components.setText(_translate("MainWindow", "0.80, 0.90"))
        self.label_ica_components.setText(_translate("MainWindow", "Components"))

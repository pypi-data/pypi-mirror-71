...
def distributionMotifsAuto(G : nx.Graph, 
    ...
    for head in grouped_request.keys():
        ...
        for motif in grouped_request[head]:
            key = motif
            if key not in total_results[head]:
                try:
                    if int(key) in total_results[head]:
                        key = int(key)
                    else:
...
def var4Motifs(G : nx.Graph, 
    ...
    **Warning: This is an experimental feature. The formulas used by this function
    might be flawed.**
    ...
    motifprops[:, 1] = [
            2 * (1-p0) * (1-p2)**2 * (1-p1)**3 * p1**3,
            2 * p0     * (1-p2)**2 * (1-p1)**3 * p1**3,
            2 * (1-p0) * p2**2     * (1-p1)**3 * p1**3,
            2 * p0     * p2**2     * (1-p1)**3 * p1**3,
            
            (1-p0) * (1-p2)**2 * (p1**4 * (1-p1)**2 + p1**2 * (1-p1)**4),
            p0     * (1-p2)**2 * (p1**4 * (1-p1)**2 + p1**2 * (1-p1)**4),
            (1-p0) * p2**2     * (p1**4 * (1-p1)**2 + p1**2 * (1-p1)**4),
            p0     * p2**2     * (p1**4 * (1-p1)**2 + p1**2 * (1-p1)**4),
            ...
            (1-p0) * (1-p2)**2 * (2 * p1**5 * (1-p1) + 4 * p1**4 * (1-p1)**2),
            p0     * (1-p2)**2 * (2 * p1**5 * (1-p1) + 4 * p1**4 * (1-p1)**2),
            (1-p0) * p2**2     * (2 * p1**5 * (1-p1) + 4 * p1**4 * (1-p1)**2),
            p0     * p2**2     * (2 * p1**5 * (1-p1) + 4 * p1**4 * (1-p1)**2),
            
            p0 * (1-p2)**2 * (4 * p1**2 * (1-p1)**4 + 2 * p1 * (1-p1)**5),
            p0 * p2**2     * (4 * p1**2 * (1-p1)**4 + 2 * p1 * (1-p1)**5),
            p0 * (1-p2)**2 * 2 * p1**3 * (1-p1)**3,
            p0 * p2**2     * 2 * p1**3 * (1-p1)**3,
            
            (1-p0) * (1-p2)**2 * (4 * p1**2 * (1-p1)**4 + 2 * p1 * (1-p1)**5),
            (1-p0) * p2**2     * (4 * p1**2 * (1-p1)**4 + 2 * p1 * (1-p1)**5),
            (1-p0) * (1-p2)**2 * 2 * p1**3 * (1-p1)**3,
            (1-p0) * p2**2     * 2 * p1**3 * (1-p1)**3
            ]
    # one top node and two bottom nodes overlapping
    # 6 relevant cross-level edges
    motifprops[:, 2] = [
            2 * (1-p2) * (1-p0)**2 * (1-p1)**3 * p1**3,
            2 * p2     * (1-p0)**2 * (1-p1)**3 * p1**3,
            2 * (1-p2) * p0**2     * (1-p1)**3 * p1**3,
            2 * p2     * p0**2     * (1-p1)**3 * p1**3,
            
            (1-p2) * (1-p0)**2 * (p1**4 * (1-p1)**2 + p1**2 * (1-p1)**4),
            p2     * (1-p0)**2 * (p1**4 * (1-p1)**2 + p1**2 * (1-p1)**4),
            (1-p2) * p0**2     * (p1**4 * (1-p1)**2 + p1**2 * (1-p1)**4),
            p2     * p0**2     * (p1**4 * (1-p1)**2 + p1**2 * (1-p1)**4),
            ...
            (1-p2) * (1-p0)**2 * (2 * p1**5 * (1-p1) + 4 * p1**4 * (1-p1)**2),
            p2     * (1-p0)**2 * (2 * p1**5 * (1-p1) + 4 * p1**4 * (1-p1)**2),
            (1-p2) * p0**2     * (2 * p1**5 * (1-p1) + 4 * p1**4 * (1-p1)**2),
            p2     * p0**2     * (2 * p1**5 * (1-p1) + 4 * p1**4 * (1-p1)**2),
            
            p2 * (1-p0)**2 * (4 * p1**2 * (1-p1)**4 + 2 * p1 * (1-p1)**5),
            p2 * p0**2     * (4 * p1**2 * (1-p1)**4 + 2 * p1 * (1-p1)**5),
            p2 * (1-p0)**2 * 2 * p1**3 * (1-p1)**3,
            p2 * p0**2     * 2 * p1**3 * (1-p1)**3,
            
            (1-p2) * (1-p0)**2 * (4 * p1**2 * (1-p1)**4 + 2 * p1 * (1-p1)**5),
            (1-p2) * p0**2     * (4 * p1**2 * (1-p1)**4 + 2 * p1 * (1-p1)**5),
            (1-p2) * (1-p0)**2 * 2 * p1**3 * (1-p1)**3,
            (1-p2) * p0**2     * 2 * p1**3 * (1-p1)**3
            ]
    ...
    motifprops[:, 4] = numpy.divide(expectations_squared, factors, where=(factors!=0))
    ...
    motifprops[:, 5] = numpy.divide(expectations_squared, factors, where=(factors!=0))

...
)
{
    ...
    for (i1 = 0; i1 < 2048; i1 += 4) {
        ...
        sgn_perm0 = (-(sgn_perm0 & 0x1ULL)) & 0xffffffffffffULL;
        v00 ^= sgn_perm0;
...
// using the Benes network given by 'benes_mask'. All small   
// integers are negated if bit 0 of 'sign' is set.
sgn_perm1 = (-(sgn_perm1 & 0x1ULL)) & 0xffffffffffffULL;
v10 ^= sgn_perm1;
...
// using the Benes network given by 'benes_mask'. All small   
// integers are negated if bit 0 of 'sign' is set.
sgn_perm2 = (-(sgn_perm2 & 0x1ULL)) & 0xffffffffffffULL;
v20 ^= sgn_perm2;
...
// using the Benes network given by 'benes_mask'. All small   
// integers are negated if bit 0 of 'sign' is set.
sgn_perm3 = (-(sgn_perm3 & 0x1ULL)) & 0xffffffffffffULL;
v30 ^= sgn_perm3;

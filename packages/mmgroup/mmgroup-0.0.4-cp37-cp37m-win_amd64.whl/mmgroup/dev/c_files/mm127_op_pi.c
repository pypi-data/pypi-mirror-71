...
)
{
    ...
    for (i1 = 0; i1 < 2048; i1 += 4) {
        ...
        sgn_perm0 = (-(sgn_perm0 & 0x1ULL)) & 0x7f7f7f7f7f7f7f7fULL;
        v00 ^= sgn_perm0;
        v01 ^= sgn_perm0;
        v02 ^= sgn_perm0;
...
// using the Benes network given by 'benes_mask'. All small   
// integers are negated if bit 0 of 'sign' is set.
sgn_perm1 = (-(sgn_perm1 & 0x1ULL)) & 0x7f7f7f7f7f7f7f7fULL;
v10 ^= sgn_perm1;
v11 ^= sgn_perm1;
v12 ^= sgn_perm1;
...
// using the Benes network given by 'benes_mask'. All small   
// integers are negated if bit 0 of 'sign' is set.
sgn_perm2 = (-(sgn_perm2 & 0x1ULL)) & 0x7f7f7f7f7f7f7f7fULL;
v20 ^= sgn_perm2;
v21 ^= sgn_perm2;
v22 ^= sgn_perm2;
...
// using the Benes network given by 'benes_mask'. All small   
// integers are negated if bit 0 of 'sign' is set.
sgn_perm3 = (-(sgn_perm3 & 0x1ULL)) & 0x7f7f7f7f7f7f7f7fULL;
v30 ^= sgn_perm3;
v31 ^= sgn_perm3;
v32 ^= sgn_perm3;

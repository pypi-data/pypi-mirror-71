...
class ReconciliationsApi(object):
    ...
    def reconcile_inline_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['sort_by', 'start', 'limit', 'filter', 'inline_valuations_reconciliation_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def reconcile_valuation_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['sort_by', 'start', 'limit', 'filter', 'valuations_reconciliation_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

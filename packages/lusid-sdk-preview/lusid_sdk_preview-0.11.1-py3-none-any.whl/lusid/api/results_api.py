...
class ResultsApi(object):
    ...
    def get_results_with_http_info(self, entity_scope, entity_code, calculation_scope, calculation_code, effective_at, **kwargs):  # noqa: E501
        ...
        if ('effective_at' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `effective_at` when calling `get_results`")  # noqa: E501
    ...
    def upsert_results(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param CreateResults create_results: The details of what to upsert
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def upsert_results_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['create_results']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'create_results' in local_var_params:
            body_params = local_var_params['create_results']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501

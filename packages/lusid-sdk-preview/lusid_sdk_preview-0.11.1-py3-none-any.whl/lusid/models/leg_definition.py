...
class LegDefinition(object):
    ...
    def __init__(self, rate_or_spread=None, index_convention=None, stub_type=None, pay_receive=None, notional_exchange_type=None, conventions=None):  # noqa: E501
        """
        LegDefinition - a model defined in OpenAPI

        :param rate_or_spread:  Is there either a fixed rate (non-zero) or spread to be paid over the value of the leg.
        :type rate_or_spread: float
        :param index_convention: 
        :type index_convention: lusid.IndexConvention
        :param stub_type:  The available values are: Front, Back, Both (required)
        :type stub_type: str
        :param pay_receive:  The available values are: NotDefined, Pay, Receive (required)
        :type pay_receive: str
        :param notional_exchange_type:  The available values are: None, Initial, Final, Both (required)
    ...
    def stub_type(self):
        ...
        The available values are: Front, Back, Both  # noqa: E501
    ...
    def stub_type(self, stub_type):
        ...
        allowed_values = ["Front", "Back", "Both"]  # noqa: E501
        if stub_type not in allowed_values:
            raise ValueError(
                "Invalid value for `stub_type` ({0}), must be one of {1}"  # noqa: E501
                .format(stub_type, allowed_values)
            )
    ...
    def pay_receive(self, pay_receive):
        ...
        if pay_receive not in allowed_values:
            raise ValueError(
                "Invalid value for `pay_receive` ({0}), must be one of {1}"  # noqa: E501
                .format(pay_receive, allowed_values)
            )
    ...
    def notional_exchange_type(self):
        ...
        The available values are: None, Initial, Final, Both  # noqa: E501

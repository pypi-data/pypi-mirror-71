...
class VersionedResourceListOfOutputTransaction(object):
    ...
    def __init__(self, version=None, values=None, href=None, links=None):  # noqa: E501
        """
        ...
        :type values: list[lusid.OutputTransaction]
        :param href: 
        :type href: str
        :param links: 

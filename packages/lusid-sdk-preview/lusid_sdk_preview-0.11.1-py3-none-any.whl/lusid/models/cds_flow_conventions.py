...
class CdsFlowConventions(object):
    ...
    def __init__(self, roll_frequency=None, currency=None, payment_frequency=None, day_count_convention=None, roll_convention=None, holiday_calendars=None):  # noqa: E501
        """
        ...
        :param day_count_convention:  The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, Invalid (required)
        :type day_count_convention: str
        :param roll_convention:  The available values are: NoAdjustment, None, Previous, P, Following, F, ModifiedPrevious, MP, ModifiedFollowing, MF, EndOfMonth, EOM, EndOfMonthPrevious, EOMP, EndOfMonthFollowing, EOMF, Invalid (required)
    ...
    def day_count_convention(self):
        ...
        The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, Invalid  # noqa: E501
    ...
    def roll_convention(self):
        ...
        The available values are: NoAdjustment, None, Previous, P, Following, F, ModifiedPrevious, MP, ModifiedFollowing, MF, EndOfMonth, EOM, EndOfMonthPrevious, EOMP, EndOfMonthFollowing, EOMF, Invalid  # noqa: E501
    ...
    def holiday_calendars(self):
        """Gets the holiday_calendars of this CdsFlowConventions.  # noqa: E501

        An array of strings denoting holiday calendars that apply to generation and payment.  # noqa: E501

        :return: The holiday_calendars of this CdsFlowConventions.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def holiday_calendars(self, holiday_calendars):
        """Sets the holiday_calendars of this CdsFlowConventions.

        An array of strings denoting holiday calendars that apply to generation and payment.  # noqa: E501

        :param holiday_calendars: The holiday_calendars of this CdsFlowConventions.  # noqa: E501
        :type: list[str]
        """

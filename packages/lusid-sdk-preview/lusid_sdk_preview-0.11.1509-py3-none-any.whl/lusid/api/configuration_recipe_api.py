...
class ConfigurationRecipeApi(object):
    ...
    def delete_configuration_recipe_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '0.11.1'
    ...
    def list_configuration_recipes(self, scope, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_configuration_recipes(scope, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope of the Configuration Recipes to list (required)
        :param datetime as_at: The asAt datetime at which to list the Configuration Recipes. Defaults to latest if not specified.
        :param str filter: Expression to filter the result set.              For example, to filter on code, use \"value.code eq 'string'\"              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_configuration_recipes_with_http_info(scope, **kwargs)  # noqa: E501

    def list_configuration_recipes_with_http_info(self, scope, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] List the set of Configuration Recipes  # noqa: E501

        List the set of  configuration recipes at the specified date/time and scope  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_configuration_recipes_with_http_info(scope, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'as_at', 'filter']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_configuration_recipes_for_all_scopes(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] List the set of Configuration Recipes from all scopes  # noqa: E501

        List the set of configuration recipes at the specified date/time across all the scopes and allowing filtering (e.g. filter by scope)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_configuration_recipes_for_all_scopes(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_configuration_recipes_for_all_scopes_with_http_info(**kwargs)  # noqa: E501

    def list_configuration_recipes_for_all_scopes_with_http_info(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] List the set of Configuration Recipes from all scopes  # noqa: E501

        List the set of configuration recipes at the specified date/time across all the scopes and allowing filtering (e.g. filter by scope)  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_configuration_recipes_for_all_scopes_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_configuration_recipes_for_all_scopes" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def upsert_configuration_recipe(self, scope, upsert_recipe_request, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_configuration_recipe(scope, upsert_recipe_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str scope: The scope to use when updating or inserting the Configuration Recipe. (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.upsert_configuration_recipe_with_http_info(scope, upsert_recipe_request, **kwargs)  # noqa: E501

    def upsert_configuration_recipe_with_http_info(self, scope, upsert_recipe_request, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Upsert a Configuration Recipe. This creates or updates the data in Lusid.  # noqa: E501

        Update or insert one Configuration Recipe in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted Configuration Recipe or failure message if unsuccessful                It is important to always check to verify success (or failure).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upsert_configuration_recipe_with_http_info(scope, upsert_recipe_request, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scope', 'upsert_recipe_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')

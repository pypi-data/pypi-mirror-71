...
class MarketDataKeyRule(object):
    ...
    def __init__(self, key=None, supplier=None, data_scope=None, quote_type=None, field=None, quote_interval=None, as_at=None, price_source=None):  # noqa: E501
        """
        ...
        :type key: str
        :param supplier:  The available values are: DataScope, Lusid, Isda, Client, Edi, TraderMade, FactSet (required)
        :type supplier: str

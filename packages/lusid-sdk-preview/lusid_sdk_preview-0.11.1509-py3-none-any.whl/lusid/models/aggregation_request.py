...
class AggregationRequest(object):
    ...
    def __init__(self, recipe_id=None, inline_recipe=None, as_at=None, effective_from=None, effective_at=None, metrics=None, group_by=None, filters=None, limit=None, sort=None, report_ccy=None):  # noqa: E501
        """

...
class PricingOptions(object):
    ...
    def __init__(self, model_selection=None, use_instrument_type_to_determine_pricer=None, allow_any_instruments_with_sec_uid_to_price_off_lookup=None, allow_partially_successful_evaluation=None, produce_separate_result_for_linear_otc_legs=None, enable_use_of_cached_unit_results=None, window_valuation_on_instrument_start_end=None, remove_contingent_cashflows_in_payment_diary=None, use_child_sub_holding_keys_for_portfolio_expansion=None):  # noqa: E501
        """

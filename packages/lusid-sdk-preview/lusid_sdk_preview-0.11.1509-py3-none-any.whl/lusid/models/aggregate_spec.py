...
class AggregateSpec(object):
    ...
    def __init__(self, key=None, op=None):  # noqa: E501
        ...
        :param key:  The key that uniquely identifies the property. It has the format {domain}/{scope}/{code}.
        :type key: str
        :param op:  The available values are: Sum, Proportion, Average, Count, Min, Max, Value
        :type op: str

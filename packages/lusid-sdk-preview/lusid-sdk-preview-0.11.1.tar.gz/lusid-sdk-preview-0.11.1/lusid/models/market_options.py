...
class MarketOptions(object):
    ...
    attribute_map = {
        ...
        'manifest_level_of_detail': 'manifestLevelOfDetail'
    }
    ...
    required_map = {
        ...
        'manifest_level_of_detail': 'optional'
    }

    def __init__(self, default_supplier=None, default_instrument_code_type=None, default_scope=None, attempt_to_infer_missing_fx=None, manifest_level_of_detail=None):  # noqa: E501
        """
        MarketOptions - a model defined in OpenAPI

        :param default_supplier:  The available values are: DataScope, Lusid, Isda, Client, Edi, TraderMade, FactSet
        :type default_supplier: str
        :param default_instrument_code_type:  The available values are: LusidInstrumentId, Figi, RIC, QuotePermId, Isin, CurrencyPair
        ...
        :param manifest_level_of_detail:  The available values are: None, Full
        :type manifest_level_of_detail: str
        ...
        self._manifest_level_of_detail = None
        ...
        if manifest_level_of_detail is not None:
            self.manifest_level_of_detail = manifest_level_of_detail

    @property
    def default_supplier(self):
        """Gets the default_supplier of this MarketOptions.  # noqa: E501

        The available values are: DataScope, Lusid, Isda, Client, Edi, TraderMade, FactSet  # noqa: E501
    ...
    def default_instrument_code_type(self):
        ...
        The available values are: LusidInstrumentId, Figi, RIC, QuotePermId, Isin, CurrencyPair  # noqa: E501
    ...
    @property
    def manifest_level_of_detail(self):
        """Gets the manifest_level_of_detail of this MarketOptions.  # noqa: E501

        The available values are: None, Full  # noqa: E501

        :return: The manifest_level_of_detail of this MarketOptions.  # noqa: E501
        :rtype: str
        """
        return self._manifest_level_of_detail

    @manifest_level_of_detail.setter
    def manifest_level_of_detail(self, manifest_level_of_detail):
        """Sets the manifest_level_of_detail of this MarketOptions.

        The available values are: None, Full  # noqa: E501

        :param manifest_level_of_detail: The manifest_level_of_detail of this MarketOptions.  # noqa: E501
        :type: str
        """
        allowed_values = ["None", "Full"]  # noqa: E501
        if manifest_level_of_detail not in allowed_values:
            raise ValueError(
                "Invalid value for `manifest_level_of_detail` ({0}), must be one of {1}"  # noqa: E501
                .format(manifest_level_of_detail, allowed_values)
            )

        self._manifest_level_of_detail = manifest_level_of_detail

...
class GetInstrumentsResponse(object):
    ...
    def __init__(self, href=None, values=None, failed=None, links=None):  # noqa: E501
        ...
        :param failed:  The identifiers which did not resolve to an instrument along with the nature of the failure.
    ...
    def failed(self):
        ...
        The identifiers which did not resolve to an instrument along with the nature of the failure.  # noqa: E501

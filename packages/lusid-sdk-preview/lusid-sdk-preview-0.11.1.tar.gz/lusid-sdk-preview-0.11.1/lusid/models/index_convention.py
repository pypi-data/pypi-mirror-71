...
class IndexConvention(object):
    ...
    def __init__(self, fixing_reference=None, name=None, publication_day_lag=None, payment_tenor=None, day_count_convention=None, currency=None):  # noqa: E501
        """
    ...
    @property
    def name(self):
        """Gets the name of this IndexConvention.  # noqa: E501

        The name of the index convention  # noqa: E501

        :return: The name of this IndexConvention.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this IndexConvention.

        The name of the index convention  # noqa: E501

        :param name: The name of this IndexConvention.  # noqa: E501
        :type: str
        """
        if name is None:

...
class OrdersApi(object):
    ...
    def upsert_order_properties(self, scope, **kwargs):  # noqa: E501
        ...
        :param list[UpsertOrderPropertiesRequest] upsert_order_properties_request: A collection of order property upsert requests.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def upsert_order_properties_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'upsert_order_properties_request']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'upsert_order_properties_request' in local_var_params:
            body_params = local_var_params['upsert_order_properties_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['text/plain', 'application/json', 'text/json'])  # noqa: E501

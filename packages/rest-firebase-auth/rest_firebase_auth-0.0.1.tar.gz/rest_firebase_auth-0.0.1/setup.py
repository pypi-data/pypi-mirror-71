...
name = 'rest_firebase_auth'
version = get_version('rest_firebase_auth')
package = 'rest_firebase_auth'
...
url = 'https://github.com/rahulkhairnarr/rest_firebase_auth'
...
if sys.argv[-1] == 'publish':
    ...
    shutil.rmtree('dist')
    shutil.rmtree('build')
    shutil.rmtree('rest_firebase_auth.egg-info')

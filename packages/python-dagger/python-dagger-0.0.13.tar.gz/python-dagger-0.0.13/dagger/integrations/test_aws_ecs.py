...
class TestAWSECSIntegration(unittest.TestCase):
    ...
    def test_wrapFunction(self, mock_main, mock_request_get):
        ...
        mock_dagger_api.createTask.assert_called_with(
            ...
            task_metadata={
                'task_id': '3c319a48-91d2-4ec5-9973-123412341234',
                'region': None,
                'execution_env': None,
            ...
            task_logs={
                'type': 'aws_cloudwatch',
                'data': {
                    'log_group_name': '/ecs/test-task-definition-family',
                    'log_stream_name': 'ecs/test-container-name/3c319a48-91d2-4ec5-9973-123412341234'
                }
            },
            task_system='aws_ecs'
        )

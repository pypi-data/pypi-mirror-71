...
if __name__ == "__main__":
    ...
    WDS_CONTRACT_COL_ID = "f3a73732-8484-4242-908b-5f5a3faee535"

    query = "Exclusions for Financial Insolvency"
    results = get_search_results(
        wds, environment_id=WDS_ENV_ID, collection_id=WDS_CONTRACT_COL_ID, query=query, return_passage_flag=False)
    print (results)
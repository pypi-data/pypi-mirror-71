...
@LastEditTime: 2020-06-18 20:13:31
...
class BaseModel:
    ...
    def is_transaction(self):
        ...
        @last_editors: ChenXiaolei
        """
        if hasattr(self, "db_transaction") and self.db_transaction and "is_transaction" in self.db_transaction and self.db_transaction.is_transaction == True:
            return True
        return False

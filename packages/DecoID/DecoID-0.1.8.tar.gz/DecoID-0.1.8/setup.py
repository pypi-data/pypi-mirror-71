...
setup(
  ...
  packages = ["DecoID","DecoID.customDBpy","DecoID.MS2Search"],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/e-stan/DecoID/archive/v0.1.8.tar.gz',    # I explain this later on

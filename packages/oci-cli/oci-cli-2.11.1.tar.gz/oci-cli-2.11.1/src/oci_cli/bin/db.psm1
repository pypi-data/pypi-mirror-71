...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        'db' = 'autonomous-container-database autonomous-data-warehouse autonomous-data-warehouse-backup autonomous-database autonomous-database-backup autonomous-database-wallet autonomous-db-preview-version autonomous-db-version autonomous-exadata-infrastructure autonomous-exadata-infrastructure-shape backup backup-destination console-connection data-guard-association database db-home exadata-infrastructure external-backup-job gi-version maintenance-run node patch patch-history system system-shape version vm-cluster vm-cluster-network'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db database create-from-database' = 'admin-password backup-tde-password database-id db-name db-system-id from-json help max-wait-seconds point-in-time-recovery-timestamp wait-for-state wait-interval-seconds'

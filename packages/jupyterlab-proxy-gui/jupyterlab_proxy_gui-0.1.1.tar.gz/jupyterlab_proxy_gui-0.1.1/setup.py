"""
Setup Module to setup Python Handlers for the jupyterlab-proxy-gui extension.
"""
import os
...
jstargets = [
    os.path.join(HERE, "lib", "jupyterlab-proxy-gui.js"),
]
...
setup_args = dict(
    name=name,
    version=version,
    url="https://github.com/VK/jupyterlab-proxy-gui",

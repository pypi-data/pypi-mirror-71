...
from worker.wellbore.model.drillstring_components import Pipe, Bit, Agitator, PDM, MWD, RSS
...
class Drillstring(SectionsMixin):
    ...
    def find_section_at_measured_depth(self, measured_depth: float) -> Union[Pipe, None]:
        """
        This method returns the pipe at the given measured depth.
        :return:
        """

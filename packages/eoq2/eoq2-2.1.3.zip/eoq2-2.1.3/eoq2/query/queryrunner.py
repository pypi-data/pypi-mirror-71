from .query import QrySegTypes,QryMetaSegTypes,QryIdxTypes,ObjSeg,Qry
from ..util.error import EoqError

from ..util.util import ApplyToAllElements,ApplyToAllElementsInA,ApplyToAllElementsInB,ApplyToAllListsOfElementsInA,ApplyToSimilarElementStrutures,ApplyToSimilarListsOfObjects,IsList,IsListOfObjects,Terminator,Determinate

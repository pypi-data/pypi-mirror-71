...
class IAlarm(_IResource_72f7ee7e, jsii.compat.Protocol):
...
class _IAlarmProxy(jsii.proxy_for(_IResource_72f7ee7e)):
    """Represents a CloudWatch Alarm.
...
class Alarm(_Resource_884d0774, metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.aws_cloudwatch.Alarm"):

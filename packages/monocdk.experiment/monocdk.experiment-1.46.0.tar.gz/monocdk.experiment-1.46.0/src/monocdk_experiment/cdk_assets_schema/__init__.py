...
class AssetManifestSchema(metaclass=jsii.JSIIMeta, jsii_type="monocdk-experiment.cdk_assets_schema.AssetManifestSchema"):
...
@jsii.data_type(jsii_type="monocdk-experiment.cdk_assets_schema.AwsDestination", jsii_struct_bases=[], name_mapping={'assume_role_arn': 'assumeRoleArn', 'assume_role_external_id': 'assumeRoleExternalId', 'region': 'region'})
...
@jsii.data_type(jsii_type="monocdk-experiment.cdk_assets_schema.DockerImageAsset", jsii_struct_bases=[], name_mapping={'destinations': 'destinations', 'source': 'source'})
...
@jsii.data_type(jsii_type="monocdk-experiment.cdk_assets_schema.DockerImageDestination", jsii_struct_bases=[AwsDestination], name_mapping={'assume_role_arn': 'assumeRoleArn', 'assume_role_external_id': 'assumeRoleExternalId', 'region': 'region', 'image_tag': 'imageTag', 'repository_name': 'repositoryName'})
...
@jsii.data_type(jsii_type="monocdk-experiment.cdk_assets_schema.DockerImageSource", jsii_struct_bases=[], name_mapping={'directory': 'directory', 'docker_build_args': 'dockerBuildArgs', 'docker_build_target': 'dockerBuildTarget', 'docker_file': 'dockerFile'})
...
@jsii.data_type(jsii_type="monocdk-experiment.cdk_assets_schema.FileAsset", jsii_struct_bases=[], name_mapping={'destinations': 'destinations', 'source': 'source'})
class FileAsset():
...
@jsii.enum(jsii_type="monocdk-experiment.cdk_assets_schema.FileAssetPackaging")
...
@jsii.data_type(jsii_type="monocdk-experiment.cdk_assets_schema.FileDestination", jsii_struct_bases=[AwsDestination], name_mapping={'assume_role_arn': 'assumeRoleArn', 'assume_role_external_id': 'assumeRoleExternalId', 'region': 'region', 'bucket_name': 'bucketName', 'object_key': 'objectKey'})
...
@jsii.data_type(jsii_type="monocdk-experiment.cdk_assets_schema.FileSource", jsii_struct_bases=[], name_mapping={'path': 'path', 'packaging': 'packaging'})
class FileSource():
...
@jsii.data_type(jsii_type="monocdk-experiment.cdk_assets_schema.ManifestFile", jsii_struct_bases=[], name_mapping={'version': 'version', 'docker_images': 'dockerImages', 'files': 'files'})
class ManifestFile():

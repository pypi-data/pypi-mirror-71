...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.generate_appliance_qualities()
        self.generate_autonome_activity_statements()
        self.generate_business_forms()
        self.generate_contributions()
        self.generate_dependent_qualities()
        self.generate_dependent_rights()
        # TODO: discounts?
        self.generate_family_tax_discount_statements()
        self.generate_legals()
        self.generate_categories_pause()
        self.generate_payrollmode()
        self.generate_pretences()
        self.generate_prime_marriage_statements()
        self.generate_revenue_bases()
        self.generate_revenue_types()
        self.generate_taxes()
        self.generate_categories_timesheet()
        self.generate_titles()
        self.generate_uniform_booking_classification_system()
    ...
    def generate_family_tax_discount_statements(self):
        """
    ...
    def generate_uniform_booking_classification_system(self):
        """
    ...
    def generate_autonome_activity_statements(self):
        """
    ...
    def generate_dependent_qualities(self):
        """
    ...
    def generate_dependent_rights(self):
        """
        Laki-Studio eltartott jogosultság törzs generálása
        :return:
        """
    ...
    def generate_appliance_qualities(self):
        """
    ...
    def generate_prime_marriage_statements(self):
        """
    ...
    def generate_simplified_burden_sharing_contribution_tax_limits(self):
        ...
        :return:
        """
        SimplifiedBurdenSharingContributionTaxLimit.objects.all().delete()
    ...
    def generate_revenue_types(self):
        """

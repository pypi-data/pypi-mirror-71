...
from .pluginbase import AbstractDevice, AbstractImplementation, Visibility


class PluginManager:
    """Provides access to all intances of both
    `infoten.pluginbase.AbstractDevice` and
    `infoten.pluginbase.AbstractImplementation` in the infoTEN system.
    """
    ...
    def dev(self) -> AbstractDevice:
        """The currently-selected `infoten.pluginbase.AbstractDevice`
        instance.
        """
    ...
    def all_devs(self) -> List[object]:
        ...
        `infoten.pluginbase.AbstractDevice` present in the system.
        """
    ...
    def all_imps(self) -> List[object]:
        """A list of all instances of
        `infoten.pluginbase.AbstractImplementation` present in the
        system.
        """
    ...
    def devs(self, visibility: Visibility) -> List[object]:
        ...
        `infoten.pluginbase.AbstractDevice` that have the specified
        `infoten.pluginbase.Visibility`.
        """

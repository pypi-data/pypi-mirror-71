...
class AbstractPluginEntity(ABC):
    ...
    def name(self) -> str:
        ...
        `infoten.plugin.base.AbstractImplementation` bound to a specific
...
class AbstractDevice(AbstractPluginEntity):
    ...
    def imp_names(self) -> List[str]:
        """The names of all `infoten.plugin.base.AbstractImplementation`
    ...
    def add_imp(self, imp: AbstractImplementation):
        ...
        ValueError
            ...
            `infoten.plugin.base.AbstractDevice` already has an instance
            of `infoten.plugin.base.AbstractImplementation` with the
            same value for `infoten.plugin.base.AbstractImplementation.name`.
        """
    ...
    def status(self) -> bool:
        """Returns the status of an `infoten.plugin.base.AbstractDevice`
        ...
        then the instance of `infoten.plugin.base.AbstractDevice` itself
        is True.

...
class classObj(_object):
    ...
    if _newclass:
        isfallback = _swig_property(_mapscript.classObj_isfallback_get, _mapscript.classObj_isfallback_set)
...
class layerObj(_object):
    ...
    if _newclass:
        rendermode = _swig_property(_mapscript.layerObj_rendermode_get, _mapscript.layerObj_rendermode_set)
...
class mapObj(_object):
    ...
    if _newclass:
        sldurl = _swig_property(_mapscript.mapObj_sldurl_get, _mapscript.mapObj_sldurl_set)

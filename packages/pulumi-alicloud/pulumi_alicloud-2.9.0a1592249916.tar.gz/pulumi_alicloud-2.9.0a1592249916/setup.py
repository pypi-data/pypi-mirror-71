...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '2.9.0-alpha.1592249916+78adcfbd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 2.9.0-alpha.1592249916+78adcfbd`
                """)
            else:
                raise

...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '0.0.1-alpha.1592316338+12cab2ba'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 0.0.1-alpha.1592316338+12cab2ba`
                """)
            else:
                raise

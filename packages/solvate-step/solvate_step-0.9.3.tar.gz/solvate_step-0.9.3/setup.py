...
"""
solvate_step
A step in a SEAMM flowchart for solvating a system using Packmol
"""
...
setup(
    ...
    url='https://github.com/molssi-seam/solvate_step',
    ...
    packages=find_packages(include=['solvate_step']),
    ...
    entry_points={
        'org.molssi.seamm': [
            'Solvate = solvate_step:SolvateStep',
        ],
        'org.molssi.seamm.tk': [
            'Solvate = solvate_step:SolvateStep',
        ],

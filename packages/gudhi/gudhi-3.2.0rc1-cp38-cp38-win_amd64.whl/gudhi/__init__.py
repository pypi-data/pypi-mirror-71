...
__debug_info__ =     "Pybind11 version 2.5.0\n" \
    ...
    "CGAL header only version 5.00.2.090\n" \
    "GMP_LIBRARIES = c:/vcpkg/installed/x64-windows/lib/mpir.lib\n" \
    "MPFR_LIBRARIES = C:/vcpkg/installed/x64-windows/lib/mpfr.lib\n" \


__all__ = ['bottleneck', 'off_reader', 'simplex_tree', 'rips_complex', 'cubical_complex', 'periodic_cubical_complex', 'persistence_graphical_tools', 'reader_utils', 'witness_complex', 'strong_witness_complex', 'nerve_gic', 'subsampling', 'tangential_complex', 'alpha_complex', 'euclidean_witness_complex', 'euclidean_strong_witness_complex',  'hera', 'representations', 'wasserstein', 'point_cloud', 'weighted_rips_complex', ]

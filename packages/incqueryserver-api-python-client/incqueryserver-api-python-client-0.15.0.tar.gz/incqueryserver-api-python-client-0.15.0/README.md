...
with iqs_client.ApiClient(configuration) as api_client:
    ...
    api_instance = iqs_client.AnalysisApi(api_client)
    analysis_configuration_identifier = iqs_client.AnalysisConfigurationIdentifier() # AnalysisConfigurationIdentifier |  (optional)

    try:
        # Delete analysis configuration
        api_response = api_instance.delete_model_analysis_configuration(analysis_configuration_identifier=analysis_configuration_identifier)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling AnalysisApi->delete_model_analysis_configuration: %s\n" % e)

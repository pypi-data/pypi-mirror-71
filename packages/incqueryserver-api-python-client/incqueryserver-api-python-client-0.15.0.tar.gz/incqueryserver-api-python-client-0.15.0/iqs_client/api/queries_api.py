...
class QueriesApi(object):
    ...
    def register_queries_from_model(self, revision_descriptor, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.register_queries_from_model_with_http_info(revision_descriptor, **kwargs)  # noqa: E501
            return data
    ...
    def register_queries_from_model_with_http_info(self, revision_descriptor, **kwargs):  # noqa: E501
        ...
        if ('revision_descriptor' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `revision_descriptor` when calling `register_queries_from_model`")  # noqa: E501
    ...
    def register_queries_plain_text_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if 'query_name' in local_var_params:

...
class ValidationApi(object):
    ...
    def validate_revision(self, revision_descriptor, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.validate_revision_with_http_info(revision_descriptor, **kwargs)  # noqa: E501
            return data
    ...
    def validate_revision_with_http_info(self, revision_descriptor, **kwargs):  # noqa: E501
        ...
        if ('revision_descriptor' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `revision_descriptor` when calling `validate_revision`")  # noqa: E501

...
class RevisionStatistics(object):
    ...
    def __init__(self, element_store_size=None, element_store_tuples=None, direct_instances_store_size=None, attribute_store_size=None, attribute_store_tuples=None, reference_store_size=None, reference_store_tuples=None, merged_unique_elements=None, merged_load_cost=None):  # noqa: E501
    ...
    def merged_unique_elements(self, merged_unique_elements):
        ...
        :type: int
        """
        if merged_unique_elements is None:

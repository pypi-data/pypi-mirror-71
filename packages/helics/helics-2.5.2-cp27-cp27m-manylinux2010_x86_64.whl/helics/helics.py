...
def helicsBrokerDataLink(broker, source, target):
    r"""
...
def helicsBrokerAddSourceFilterToEndpoint(broker, filter, endpoint):
    r"""
...
def helicsBrokerAddDestinationFilterToEndpoint(broker, filter, endpoint):
    r"""
...
def helicsCoreWaitForDisconnect(core, msToWait):
    r"""
...
def helicsBrokerWaitForDisconnect(broker, msToWait):
    r"""
...
def helicsCoreDataLink(core, source, target):
    r"""
...
def helicsCoreAddSourceFilterToEndpoint(core, filter, endpoint):
    r"""
    Link a named filter to a source endpoint.
...
def helicsCoreAddDestinationFilterToEndpoint(core, filter, endpoint):
    r"""
    Link a named filter to a destination endpoint.
...
def helicsCreateValueFederate(fedName, fi):
    r"""
...
def helicsCreateValueFederateFromConfig(configFile):
    r"""
...
def helicsCreateMessageFederate(fedName, fi):
    r"""
...
def helicsCreateMessageFederateFromConfig(configFile):
    r"""
...
def helicsCreateCombinationFederate(fedName, fi):
    r"""
...
def helicsCreateCombinationFederateFromConfig(configFile):
    r"""
...
def helicsFederateInfoSetBrokerInitString(fi, brokerInit):
    r"""
...
def helicsFederateInfoSetBroker(fi, broker):
    r"""
...
def helicsFederateInfoSetBrokerKey(fi, brokerkey):
    r"""
...
def helicsFederateInfoSetBrokerPort(fi, brokerPort):
    r"""
...
def helicsFederateInfoSetLocalPort(fi, localPort):
    r"""
...
def helicsGetPropertyIndex(val):
    r"""
...
def helicsFederateInfoSetTimeProperty(fi, timeProperty, propertyValue):
    r"""
...
def helicsFederateInfoSetIntegerProperty(fi, intProperty, propertyValue):
    r"""
...
def helicsFederateRequestTimeAdvance(fed, timeDelta):
    r"""
    Request the next time for federate execution.
...
def helicsFederateSetTimeProperty(fed, timeProperty, time):
    r"""
...
def helicsFederateSetFlagOption(fed, flag, flagValue):
    r"""
...
def helicsFederateSetIntegerProperty(fed, intProperty, propertyVal):
    r"""
...
def helicsFederateGetTimeProperty(fed, timeProperty):
    r"""
...
def helicsFederateGetIntegerProperty(fed, intProperty):
    r"""
...
def helicsFederateSetGlobal(fed, valueName, value):
    r"""
...
def helicsFederateAddDependency(fed, fedName):
    r"""
...
def helicsFederateSetLogFile(fed, logFile):
    r"""
...
def helicsFederateLogErrorMessage(fed, logmessage):
    r"""
...
def helicsFederateLogWarningMessage(fed, logmessage):
    r"""
...
def helicsFederateLogInfoMessage(fed, logmessage):
    r"""
...
def helicsFederateLogDebugMessage(fed, logmessage):
    r"""
...
def helicsFederateLogLevelMessage(fed, loglevel, logmessage):
    r"""
...
def helicsCoreSetGlobal(core, valueName, value):
    r"""
...
def helicsBrokerSetGlobal(broker, valueName, value):
    r"""
...
def helicsCoreSetLogFile(core, logFileName):
    r"""
...
def helicsBrokerSetLogFile(broker, logFileName):
    r"""
...
def helicsQuerySetTarget(query, target):
    r"""
...
def helicsQuerySetQueryString(query, queryString):
    r"""
...
def helicsPublicationPublishBoolean(pub, val):
    r"""
...
def helicsPublicationPublishTime(pub, val):
    r"""
...
def helicsPublicationPublishChar(pub, val):
    r"""
...
def helicsPublicationPublishNamedPoint(pub, str, val):
    r"""
...
def helicsPublicationAddTarget(pub, target):
    r"""
...
def helicsInputAddTarget(ipt, target):
    r"""
...
def helicsInputSetDefaultString(ipt, str):
    r"""
...
def helicsInputSetDefaultInteger(ipt, val):
    r"""
...
def helicsInputSetDefaultBoolean(ipt, val):
    r"""
...
def helicsInputSetDefaultTime(ipt, val):
    r"""
...
def helicsInputSetDefaultChar(ipt, val):
    r"""
...
def helicsInputSetDefaultDouble(ipt, val):
    r"""
...
def helicsInputSetDefaultComplex(ipt, real, imag):
    r"""
...
def helicsInputSetDefaultNamedPoint(ipt, str, val):
    r"""
...
def helicsInputSetInfo(inp, info):
    r"""
...
def helicsInputGetOption(inp, option):
    r"""
...
def helicsInputSetOption(inp, option, value):
    r"""
...
def helicsPublicationSetOption(pub, option, val):
    r"""
...
def helicsInputSetMinimumChange(inp, tolerance):
    r"""
    Set the minimum change detection tolerance.
...
def helicsEndpointSetInfo(end, info):
    r"""
...
def helicsEndpointSetOption(end, option, value):
    r"""
...
def helicsEndpointGetOption(end, option):
    r"""
    Set a handle option on an endpoint.
...
def helicsMessageSetSource(message, src):
    r"""
...
def helicsMessageSetDestination(message, dest):
    r"""
...
def helicsMessageSetOriginalSource(message, src):
    r"""
...
def helicsMessageSetOriginalDestination(message, dest):
    r"""
...
def helicsMessageReserve(message, reserveSize):
    r"""
...
def helicsMessageSetMessageID(message, messageID):
    r"""
...
def helicsMessageSetFlagOption(message, flag, flagValue):
    r"""
...
def helicsMessageSetString(message, str):
    r"""
...
def helicsMessageCopy(source_message, dest_message):
    r"""
...
def helicsFilterSet(filt, prop, val):
    r"""
...
def helicsFilterSetString(filt, prop, val):
    r"""
...
def helicsFilterRemoveTarget(filt, target):
    r"""
...
def helicsFilterSetInfo(filt, info):
    r"""
    Set the data in the info field for a filter.
...
def helicsFilterSetOption(filt, option, value):
    r"""
    Set the data in the info field for a filter.
...
def helicsFilterGetOption(filt, option):
    r"""

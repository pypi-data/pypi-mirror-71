...
from .markets_pb2 import (
    DESCRIPTOR as markets_DESCRIPTOR,
    _MARKET as markets_MARKET,
)
from .assets_pb2 import (
    DESCRIPTOR as assets_DESCRIPTOR,
    _ASSET as assets_ASSET,
    _ASSETSOURCE as assets_ASSETSOURCE,
)
...
_PROPOSAL_STATE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="OPEN", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PASSED",
            index=2,
...
_VOTE_VALUE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="NO", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_NETWORKCONFIGURATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="minCloseInSeconds",
            full_name="vega.NetworkConfiguration.minCloseInSeconds",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="maxCloseInSeconds",
            full_name="vega.NetworkConfiguration.maxCloseInSeconds",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="minEnactInSeconds",
            full_name="vega.NetworkConfiguration.minEnactInSeconds",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="maxEnactInSeconds",
            full_name="vega.NetworkConfiguration.maxEnactInSeconds",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="minParticipationStake",
            full_name="vega.NetworkConfiguration.minParticipationStake",
            index=4,
            number=5,
            type=4,
            cpp_type=4,
...
_NEWMARKET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="changes",
            full_name="vega.NewMarket.changes",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_UPDATENETWORK = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="changes",
            full_name="vega.UpdateNetwork.changes",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_NEWASSET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="changes",
            full_name="vega.NewAsset.changes",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_PROPOSALTERMS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="vega.ProposalTerms.closingTimestamp",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="enactmentTimestamp",
            full_name="vega.ProposalTerms.enactmentTimestamp",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="minParticipationStake",
            full_name="vega.ProposalTerms.minParticipationStake",
            index=2,
            number=3,
            type=4,
            cpp_type=4,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="vega.ProposalTerms.validationTimestamp",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="updateMarket",
            full_name="vega.ProposalTerms.updateMarket",
            index=4,
            number=101,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="newMarket",
            full_name="vega.ProposalTerms.newMarket",
            index=5,
            number=102,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="updateNetwork",
            full_name="vega.ProposalTerms.updateNetwork",
            index=6,
            number=103,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="newAsset",
            full_name="vega.ProposalTerms.newAsset",
            index=7,
            number=104,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="change",
            full_name="vega.ProposalTerms.change",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_GOVERNANCEDATA = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="proposal",
            full_name="vega.GovernanceData.proposal",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="yes",
            full_name="vega.GovernanceData.yes",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="no",
            full_name="vega.GovernanceData.no",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_PROPOSAL = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="reference",
            full_name="vega.Proposal.reference",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="partyID",
            full_name="vega.Proposal.partyID",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="vega.Proposal.timestamp",
            index=4,
            number=5,
            type=3,
            cpp_type=2,
...
_VOTE = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="proposalID",
            full_name="vega.Vote.proposalID",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_PROPOSALTERMS.fields_by_name[
    "updateMarket"
].containing_oneof = _PROPOSALTERMS.oneofs_by_name["change"]
_PROPOSALTERMS.oneofs_by_name["change"].fields.append(
...
NetworkConfiguration = _reflection.GeneratedProtocolMessageType(
    "NetworkConfiguration",
    (_message.Message,),
    {
...
UpdateNetwork = _reflection.GeneratedProtocolMessageType(
    "UpdateNetwork",
    (_message.Message,),
    {

...
_ASSET = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="totalSupply",
            full_name="vega.Asset.totalSupply",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="builtinAsset",
            full_name="vega.Asset.builtinAsset",
            index=5,
            number=101,
            type=11,
            cpp_type=10,
...
_ASSETSOURCE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="builtinAsset",
            full_name="vega.AssetSource.builtinAsset",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="erc20",
            full_name="vega.AssetSource.erc20",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="source",
            full_name="vega.AssetSource.source",
            index=0,
            containing_type=None,
            fields=[],
        ),
...
_BUILTINASSET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="vega.BuiltinAsset.name",
            index=0,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="symbol",
            full_name="vega.BuiltinAsset.symbol",
            index=1,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="totalSupply",
            full_name="vega.BuiltinAsset.totalSupply",
            index=2,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="decimals",
            full_name="vega.BuiltinAsset.decimals",
            index=3,
            number=5,
            type=4,
            cpp_type=4,
...
_ERC20 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="vega.ERC20.contractAddress",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_DEVASSETS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="sources",
            full_name="vega.DevAssets.sources",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_ASSET.fields_by_name["builtinAsset"].message_type = _BUILTINASSET
_ASSET.fields_by_name["erc20"].message_type = _ERC20
_ASSET.oneofs_by_name["source"].fields.append(
    _ASSET.fields_by_name["builtinAsset"]
)
_ASSET.fields_by_name["builtinAsset"].containing_oneof = _ASSET.oneofs_by_name[
    "source"
]
_ASSET.oneofs_by_name["source"].fields.append(_ASSET.fields_by_name["erc20"])
_ASSET.fields_by_name["erc20"].containing_oneof = _ASSET.oneofs_by_name[
    "source"
]
...
_ASSETSOURCE.fields_by_name[
    "builtinAsset"
].containing_oneof = _ASSETSOURCE.oneofs_by_name["source"]
_ASSETSOURCE.oneofs_by_name["source"].fields.append(
...
AssetSource = _reflection.GeneratedProtocolMessageType(
    "AssetSource",
    (_message.Message,),
    {
...
DevAssets = _reflection.GeneratedProtocolMessageType(
    "DevAssets",
    (_message.Message,),
    {

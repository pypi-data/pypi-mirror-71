...
from bsamcli.local.lambda_service.local_lambda_invoke_service import LocalLambdaInvokeService
...
class LocalLambdaService(object):
    ...
    def __init__(self,
        ...
        :param bsamcli.commands.local.cli_common.invoke_context.InvokeContext lambda_invoke_context: Context object

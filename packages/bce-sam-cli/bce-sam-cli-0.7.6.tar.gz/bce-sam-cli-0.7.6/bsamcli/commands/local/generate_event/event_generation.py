...
from bsamcli.cli.options import debug_option
import bsamcli.commands.local.lib.generated_sample_events.events as events
...
class ServiceCommand(click.MultiCommand):
    ...
    def __init__(self, events_lib, *args, **kwargs):
        ...
        Parameters
        ----------
        events_lib: bsamcli.commands.local.lib.generated_sample_events.events

...
import bsamcli.lib.baidubce.protocol
import bsamcli.lib.baidubce.region
from bsamcli.lib.baidubce.retry.retry_policy import BackOffRetryPolicy
...
class BceClientConfiguration(object):
    ...
    def __init__(self,
        ...
        self.backup_endpoint = compat.convert_to_bytes(
            backup_endpoint) if backup_endpoint is not None else backup_endpoint
...
DEFAULT_PROTOCOL = bsamcli.lib.baidubce.protocol.HTTP
DEFAULT_REGION = bsamcli.lib.baidubce.region.BEIJING

...
_SAM_CLI_COMMAND_PACKAGES = {
    "bsamcli.commands.local.local",
    # "bsamcli.commands.validate.validate",
    "bsamcli.commands.init",
    "bsamcli.commands.deploy",
    "bsamcli.commands.package",
    "bsamcli.commands.config"
    # "bsamcli.commands.logs",
}

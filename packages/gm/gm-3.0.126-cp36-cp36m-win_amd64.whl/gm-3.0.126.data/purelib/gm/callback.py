...
def l2transaction_callback(data):
    if _or_not_none(context.on_l2transaction_fun, context.on_l2transaction_fun_v2):
        ...
        trans = protobuf_to_dict(trans, including_default_value_fields=True, dcls=DictLikeL2Transaction)
...
def l2order_queue_callback(data):
    ...
    l2order_queue = protobuf_to_dict(l2order_queue, including_default_value_fields=True, dcls=DictLikeL2OrderQueue)
...
def l2order_callback(data):
    ...
    l2order = protobuf_to_dict(l2order, including_default_value_fields=True, dcls=DictLikeL2Order)
...
def algo_order_status_callback(data):
    ...
    if _or_not_none(context.on_algo_order_status_fun, context.on_algo_order_status_fun_v2):
        ...
        algo_order = protobuf_to_dict(algo_order, including_default_value_fields=True, dcls=DictLikeAlgoOrder)

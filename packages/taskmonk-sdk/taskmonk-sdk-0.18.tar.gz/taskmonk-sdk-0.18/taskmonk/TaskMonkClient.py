...
class TaskMonkClient:
    ...
    def __init__(self, base_url, project_id, client_id = '', client_secret = '', proxy = {}, force_https = True):
        ...
        self._base_url = self._url_convert(base_url, force_https)
    ...
    def _url_convert(self, url, force_https):
    ...
    def update_batch_status(self, batchId = None, state = ''):
        ...
        response = apiCall.put(self._get_token(), url,self._proxy, data, 30)
        print(response)
        return response
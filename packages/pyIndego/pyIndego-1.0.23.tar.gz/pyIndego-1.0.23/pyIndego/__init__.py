...
###########################################################
    ...
    def getState(self):
        ...
        if tmp_json:
            ...
            _LOGGER.error("--- getState gave no value when fetching from API")
            return None
    ...
    def getNetwork(self):
        ...
        if (tmp_json == None):
            _LOGGER.info(f"getNetwork implementation for model: {self._bareToolnumber} = NO!")
        else:
            _LOGGER.info(f"getNetwork implementation for model: {self._bareToolnumber} = YES!")
    ...
    def getConfig(self):
        ...
        if (tmp_json == None):
            _LOGGER.info(f"getConfig implementation for model: {self._bareToolnumber} = NO!")
        else:
            _LOGGER.info(f"getConfig implementation for model: {self._bareToolnumber} = YES!")
        _LOGGER.debug(f"Result = {tmp_json}")

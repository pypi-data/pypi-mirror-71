...
###########################################################
    ...
    def getNetwork(self):
        ...
        if (tmp_json == None):
            _LOGGER.info(f"getNetwork NOT implemented for model: {self._bareToolnumber}")
        else:
            _LOGGER.debug(f"getNetwork implemented for model: {self._bareToolnumber}")
    ...
    def getConfig(self):
        ...
        if (tmp_json == None):
            _LOGGER.info(f"getConfig NOT implemented for model: {self._bareToolnumber}")
        else:
            _LOGGER.debug(f"getConfig implemented for model: {self._bareToolnumber}")
        _LOGGER.debug(f"Result = {tmp_json}")

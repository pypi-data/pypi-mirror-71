...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '0.0.1-alpha.1592249461+b7f4726f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 0.0.1-alpha.1592249461+b7f4726f`
                """)
            else:
                raise

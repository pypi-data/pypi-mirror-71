...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '2.5.0-alpha.1591988095+73ba2e1a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 2.5.0-alpha.1591988095+73ba2e1a`
                """)
            else:
                raise

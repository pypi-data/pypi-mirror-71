...
setup(
  ...
  author_email = 'dmidnightcuberx@gmail.com',      # Type in your E-Mail
  url = 'https://github.com/midnightcuberx/pycubescrambler',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/midnightcuberx/pycubescrambler/archive/v_0.1.6.tar.gz',    # I explain this later on

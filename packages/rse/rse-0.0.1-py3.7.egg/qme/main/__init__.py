...
from rse.defaults import QME_DATABASE
from rse.main.config import Config
from rse.main.database import init_db
from rse.main.executor import get_executor
from rse.utils.regex import uuid_regex
...
class Queue:
    """A Queue Me (rse) Queue is the core operator for the rse library. Here
    ...
    def __init__(self, config_dir=None, database=None):
        """create a queue. We take a config directory (defaults to $HOME/.rse)
           and a database configuration string (defaults to filesystem to be
           created at $HOME/.rse/database
        """

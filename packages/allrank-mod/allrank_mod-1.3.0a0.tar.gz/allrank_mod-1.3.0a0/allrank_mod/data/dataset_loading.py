...
from allrank_mod.utils.file_utils import open_local_or_gs
...
def create_data_loaders(train_ds: LibSVMDataset, val_ds: LibSVMDataset, num_workers: int, batch_size: int):
    ...
    train_dl = DataLoader(train_ds, batch_size=total_batch_size, num_workers=0, shuffle=True)
    val_dl = DataLoader(val_ds, batch_size=total_batch_size * 2, num_workers=0, shuffle=False)

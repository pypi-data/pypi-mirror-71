...
class Collage:
    ...
    haralick_features=[HaralickFeature.All], 
    log_sample_rate=500, 
    ...
    greylevels = 64,
        ...
        self.feature_count = len(haralick_features)
    ...
    def execute(self):
        ...
        number_of_features =  len(self.haralick_features)

        if self.haralick_features[0] == HaralickFeature.All:
            number_of_features = 13
        for feature in range(number_of_features):

            if number_of_features != 13:
                feature = self.haralick_features.pop().value
            if self.verbose_logging:

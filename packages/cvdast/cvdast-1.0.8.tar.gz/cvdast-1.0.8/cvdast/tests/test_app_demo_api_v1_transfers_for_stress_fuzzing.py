...
@pytest.mark.parametrize("user_id1, beneficiary_id, description, amount, account_id", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/stress/alphanum_case.txt", ['user_id1', 'beneficiary_id', 'description', 'amount', 'account_id']))
def test_app_demo_api_v1_transfers_for_stress(user_id1, beneficiary_id, description, amount, account_id):
    data = {}
...
@pytest.mark.parametrize("user_id1, beneficiary_id, description, amount, account_id", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/stress/alphanum_case_extra.txt", ['user_id1', 'beneficiary_id', 'description', 'amount', 'account_id']))
def test_app_demo_api_v1_transfers_for_stress(user_id1, beneficiary_id, description, amount, account_id):
    data = {}
    data["user_id1"] = user_id1
    data["beneficiary_id"] = beneficiary_id
...
@pytest.mark.parametrize("user_id1, beneficiary_id, description, amount, account_id", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/stress/uri_hex.txt", ['user_id1', 'beneficiary_id', 'description', 'amount', 'account_id']))
def test_app_demo_api_v1_transfers_for_stress(user_id1, beneficiary_id, description, amount, account_id):
    data = {}
    data["user_id1"] = user_id1
    data["beneficiary_id"] = beneficiary_id
...
@pytest.mark.parametrize("user_id1, beneficiary_id, description, amount, account_id", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/stress/char.txt", ['user_id1', 'beneficiary_id', 'description', 'amount', 'account_id']))
def test_app_demo_api_v1_transfers_for_stress(user_id1, beneficiary_id, description, amount, account_id):
    data = {}
    data["user_id1"] = user_id1
    data["beneficiary_id"] = beneficiary_id
...
@pytest.mark.parametrize("user_id1, beneficiary_id, description, amount, account_id", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/stress/test_ext.txt", ['user_id1', 'beneficiary_id', 'description', 'amount', 'account_id']))
def test_app_demo_api_v1_transfers_for_stress(user_id1, beneficiary_id, description, amount, account_id):
    data = {}
    data["user_id1"] = user_id1
    data["beneficiary_id"] = beneficiary_id
...
@pytest.mark.parametrize("user_id1, beneficiary_id, description, amount, account_id", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/stress/doble_uri_hex.txt", ['user_id1', 'beneficiary_id', 'description', 'amount', 'account_id']))
def test_app_demo_api_v1_transfers_for_stress(user_id1, beneficiary_id, description, amount, account_id):
    data = {}
    data["user_id1"] = user_id1
    data["beneficiary_id"] = beneficiary_id

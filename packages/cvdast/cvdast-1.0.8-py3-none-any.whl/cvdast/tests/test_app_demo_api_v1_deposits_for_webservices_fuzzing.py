...
@pytest.mark.parametrize("description, amount, user_id, account_id1", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/webservices/ws-files.txt", ['description', 'amount', 'user_id', 'account_id1']))
def test_app_demo_api_v1_deposits_for_webservices(description, amount, user_id, account_id1):
    data = {}
...
@pytest.mark.parametrize("description, amount, user_id, account_id1", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/webservices/ws-dirs.txt", ['description', 'amount', 'user_id', 'account_id1']))
def test_app_demo_api_v1_deposits_for_webservices(description, amount, user_id, account_id1):
    data = {}
    data["description"] = description
    data["amount"] = amount

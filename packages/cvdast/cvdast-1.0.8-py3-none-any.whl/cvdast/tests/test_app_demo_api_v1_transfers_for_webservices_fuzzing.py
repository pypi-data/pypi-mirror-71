...
@pytest.mark.parametrize("user_id1, beneficiary_id, description, amount, account_id", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/webservices/ws-files.txt", ['user_id1', 'beneficiary_id', 'description', 'amount', 'account_id']))
def test_app_demo_api_v1_transfers_for_webservices(user_id1, beneficiary_id, description, amount, account_id):
    data = {}
...
@pytest.mark.parametrize("user_id1, beneficiary_id, description, amount, account_id", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/webservices/ws-dirs.txt", ['user_id1', 'beneficiary_id', 'description', 'amount', 'account_id']))
def test_app_demo_api_v1_transfers_for_webservices(user_id1, beneficiary_id, description, amount, account_id):
    data = {}
    data["user_id1"] = user_id1
    data["beneficiary_id"] = beneficiary_id

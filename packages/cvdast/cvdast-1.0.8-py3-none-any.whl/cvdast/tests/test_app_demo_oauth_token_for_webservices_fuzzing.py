...
@pytest.mark.parametrize("password, client_id, grant_type, email, client_secret, dummy", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/webservices/ws-files.txt", ['password', 'client_id', 'grant_type', 'email', 'client_secret', 'dummy']))
def test_app_demo_oauth_token_for_webservices(password, client_id, grant_type, email, client_secret, dummy):
    data = {}
...
@pytest.mark.parametrize("password, client_id, grant_type, email, client_secret, dummy", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/webservices/ws-dirs.txt", ['password', 'client_id', 'grant_type', 'email', 'client_secret', 'dummy']))
def test_app_demo_oauth_token_for_webservices(password, client_id, grant_type, email, client_secret, dummy):
    data = {}
    data["password"] = password
    data["client_id"] = client_id
...
def test_for_anomalies():
    pattern_observed = {"status_code": [], "resp_size": [], "request":[], "fuzz_type": "webservices"}

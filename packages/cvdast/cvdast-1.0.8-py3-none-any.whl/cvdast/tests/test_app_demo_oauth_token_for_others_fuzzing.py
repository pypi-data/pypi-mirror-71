...
@pytest.mark.parametrize("password, client_id, grant_type, email, client_secret, dummy", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/others/names.txt", ['password', 'client_id', 'grant_type', 'email', 'client_secret', 'dummy']))
def test_app_demo_oauth_token_for_others(password, client_id, grant_type, email, client_secret, dummy):
    data = {}
...
@pytest.mark.parametrize("password, client_id, grant_type, email, client_secret, dummy", _prep_data_for_fuzzing("/Users/balak/PycharmProjects/tools-new/cv-DAST/cvdast/wfuzz/wordlist/others/common_pass.txt", ['password', 'client_id', 'grant_type', 'email', 'client_secret', 'dummy']))
def test_app_demo_oauth_token_for_others(password, client_id, grant_type, email, client_secret, dummy):
    data = {}
    data["password"] = password
    data["client_id"] = client_id

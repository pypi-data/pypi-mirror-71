...
setup(
    ...
    license="MIT license",
    long_description='''Simple class and methods for the Bayesian estimation and comparison of proportions.  i.e. a simple Bayesian AB test of proportions.  
                        ...
                        - The prior distribution, sample count, random seed, credible intervals and parameter names can all be customised.''',  #readme + '\n\n' + history,

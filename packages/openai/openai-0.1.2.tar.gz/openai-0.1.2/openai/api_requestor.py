...
class APIRequestor(object):
    ...
    def request_headers(self, api_key, method, content_type):
    ...
    def request_raw(
        ...
        headers = self.request_headers(my_api_key, method, content_type=content_type)
        ...
        util.log_info("OpenAI API response", path=abs_url, response_code=rcode)

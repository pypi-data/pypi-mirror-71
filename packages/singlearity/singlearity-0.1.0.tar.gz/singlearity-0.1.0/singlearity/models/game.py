...
class Game(object):
    ...
    def __init__(self, home_team=None, visit_team=None, home_lineup=None, visit_lineup=None, atmosphere=None, date='2019-09-29', local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def visit_team(self):
        """Gets the visit_team of this Game.  # noqa: E501


        :return: The visit_team of this Game.  # noqa: E501
        :rtype: Team
        """
        return self._visit_team

    @visit_team.setter
    def visit_team(self, visit_team):
        """Sets the visit_team of this Game.


        :param visit_team: The visit_team of this Game.  # noqa: E501
        :type: Team
        """
        if self.local_vars_configuration.client_side_validation and visit_team is None:  # noqa: E501
            raise ValueError("Invalid value for `visit_team`, must not be `None`")  # noqa: E501

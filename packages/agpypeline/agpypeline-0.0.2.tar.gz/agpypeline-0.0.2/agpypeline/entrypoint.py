...
try :
    ...
    msg = "Unable to load configuration.py. Using default"
    logging.error(msg)
    configuration = import_module('configuration_default')

try:
    transformer = import_module('transformer')
except Exception as ex:
    msg = "Unable to load transformer.py. Using default"
    logging.error(msg)
    configuration = import_module('transformer_default')

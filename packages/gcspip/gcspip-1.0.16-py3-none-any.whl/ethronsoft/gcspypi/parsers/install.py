    ...
    def __init__(self, subparsers):
        ...
        install_parser = subparsers.add_parser(self.name,
                                               description="""Downloads a package from the GCS repository,
                                                           (or pypi index if mirroring is enabled) and 
                                                           installs it locally""")
        ...
        install_parser.add_argument("--no-user", default=True, const=True, nargs="?", type=bool,
                                    help="do not use option --user when installing a package via `pip install`")

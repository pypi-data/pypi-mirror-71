...
# General parameters
name = 'pycliflo'
main_package = 'pycliflo'
datasets = 'datasets'
version = '0.0.5'
descrip = 'Tools to get data from cliflo'
...
if os.environ.get('READTHEDOCS', False) == 'True':
    ...
    INSTALL_REQUIRES = ['pandas', 'selenium', 'requests', 'beautifulsoup4']
...
setup(
    ...
    url='https://github.com/Data-to-Knowledge/pycliflo',  # Optional

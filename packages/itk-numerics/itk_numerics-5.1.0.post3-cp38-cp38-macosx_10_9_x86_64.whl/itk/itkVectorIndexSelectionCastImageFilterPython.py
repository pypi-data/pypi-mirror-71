...
class itkVectorIndexSelectionCastImageFilterICVF22IF2(itkVectorIndexSelectionCastImageFilterICVF22IF2_Superclass):
    ...
    See:  ComposeImageFilter  \\sphinx
    \\sphinxexample{Filtering/ImageIntensity/ExtractComponen
    tOfVectorImage,Extract Component Of Vector Image} \\endsphinx
...
def vector_index_selection_cast_image_filter_init_docstring():
    ...
    vector_index_selection_cast_image_filter.__doc__ += "Available Keyword Arguments:\n"

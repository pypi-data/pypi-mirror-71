...
class itkRescaleIntensityImageFilterID2ID2(itkRescaleIntensityImageFilterID2ID2_Superclass):
    ...
    See:   IntensityWindowingImageFilter  \\sphinx
    \\sphinxexample{Filtering/ImageIntensity/RescaleAnImage,Rescale An
    Image} \\endsphinx
...
def rescale_intensity_image_filter_init_docstring():
    ...
    rescale_intensity_image_filter.__doc__ += "Available Keyword Arguments:\n"

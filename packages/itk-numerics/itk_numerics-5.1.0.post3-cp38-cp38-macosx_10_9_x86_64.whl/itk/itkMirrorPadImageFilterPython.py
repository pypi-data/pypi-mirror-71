...
class itkMirrorPadImageFilterICF2ICF2(itk.itkPadImageFilterPython.itkPadImageFilterICF2ICF2):
    ...
    See:   WrapPadImageFilter, ConstantPadImageFilter  \\sphinx
    \\sphinxexample{Filtering/ImageGrid/PadAnImageByMirroring,Pad An
    Image By Mirroring} \\endsphinx
...
def mirror_pad_image_filter_init_docstring():
    ...
    mirror_pad_image_filter.__doc__ += "Available Keyword Arguments:\n"

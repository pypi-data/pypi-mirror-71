...
class itkMedianImageFilterID2ID2(itk.itkBoxImageFilterPython.itkBoxImageFilterID2ID2):
    ...
    \\sphinxexample{Filtering/Smoothing/ApplyMedianFilter,Median Filter
    Of An Image} \\sphinxexample{Filtering/Smoothing/MedianFilteringOfAn
    RGBImage,Median Filter Of An RGB Image} \\endsphinx

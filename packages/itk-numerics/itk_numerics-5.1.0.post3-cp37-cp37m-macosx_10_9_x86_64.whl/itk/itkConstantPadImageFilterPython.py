...
class itkConstantPadImageFilterICF2ICF2(itk.itkPadImageFilterPython.itkPadImageFilterICF2ICF2):
    ...
    See:   WrapPadImageFilter, MirrorPadImageFilter  \\sphinx
    \\sphinxexample{Filtering/ImageGrid/PadAnImageWithAConstant,Pad An
    Image With A Constant} \\endsphinx
...
def constant_pad_image_filter_init_docstring():
    ...
    constant_pad_image_filter.__doc__ += "Available Keyword Arguments:\n"

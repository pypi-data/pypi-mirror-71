...
class itkClampImageFilterID2ID2(itkClampImageFilterID2ID2_Superclass):
    ...
    See:  CastImageFilter  \\sphinx
    \\sphinxexample{Filtering/ImageIntensity/CastImageToAnot
    herTypeButClampToOutput,Cast Image To Another Type But Clamp To Output
    Range} \\endsphinx

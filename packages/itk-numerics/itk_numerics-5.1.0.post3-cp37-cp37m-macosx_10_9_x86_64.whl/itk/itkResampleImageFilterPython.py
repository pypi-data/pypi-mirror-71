...
class itkResampleImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    coordinate transform must be threadsafe.  \\sphinx
    \\sphinxexample{Core/Transform/TranslateImage,Translate Image}
    \\sphinxexample{Filtering/ImageGrid/UpsampleAnImage,Upsampling An
    Image} \\sphinxexample{Filtering/ImageGrid/ResampleAnImage,Resample
    An Image} \\endsphinx
...
def resample_image_filter_init_docstring():
    ...
    resample_image_filter.__doc__ += "Available Keyword Arguments:\n"

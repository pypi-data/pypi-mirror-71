...
class itkStatisticsImageFilterID2(itk.itkImageSinkPython.itkImageSinkID2):
    ...
    \\sphinx \\sphinxexample{Filtering/ImageStatistics/ComputeMinMaxVa
    rianceMeanOfImage,Compute Min, Max, Variance And Mean Of Image}
    \\endsphinx
...
def statistics_image_filter_init_docstring():
    ...
    statistics_image_filter.__doc__ += "Available Keyword Arguments:\n"

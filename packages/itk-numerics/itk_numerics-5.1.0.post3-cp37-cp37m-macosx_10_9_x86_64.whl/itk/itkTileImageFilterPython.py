...
class itkTileImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    \\sphinx
    \\sphinxexample{Filtering/ImageGrid/Stack2DImagesInto3DImage,Stack
    2D Images Into 3D Image}
    \\sphinxexample{Filtering/ImageGrid/TileImagesSideBySide,Tile Images
    Side By Side} \\endsphinx
...
def tile_image_filter_init_docstring():
    ...
    tile_image_filter.__doc__ += "Available Keyword Arguments:\n"

...
class itkBinomialBlurImageFilterID2ID2(itk.itkImageToImageFilterAPython.itkImageToImageFilterID2ID2):
    ...
    \\sphinx \\sphinxexample{Filtering/Smoothing/BlurringAnImageUsingA
    BinomialKernel,Blurring An Image Using A Binomial Kernel}
    \\endsphinx
...
def binomial_blur_image_filter_init_docstring():
    ...
    binomial_blur_image_filter.__doc__ += "Available Keyword Arguments:\n"

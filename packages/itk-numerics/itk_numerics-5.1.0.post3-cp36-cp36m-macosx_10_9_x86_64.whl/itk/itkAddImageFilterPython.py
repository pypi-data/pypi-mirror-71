...
class itkAddImageFilterID2ID2ID2(itk.itkBinaryGeneratorImageFilterPython.itkBinaryGeneratorImageFilterID2ID2ID2):
    ...
    \\sphinx \\sphinxexample{Filtering/ImageIntensity/AddTwoImages,Add
    Two Images Together}
    \\sphinxexample{Filtering/ImageIntensity/AddConstantToEveryPixel,Add
    Constant To Every Pixel} \\endsphinx

...
class itkCurvatureFlowImageFilterID2ID2(itk.itkDenseFiniteDifferenceImageFilterPython.itkDenseFiniteDifferenceImageFilterID2ID2):
    ...
    \\sphinx \\sphinxexample{Filtering/CurvatureFlow/SmoothImageUsingC
    urvatureFlow,Smooth Image Using Curvature Flow} \\sphinxexample{Filt
    ering/CurvatureFlow/SmoothRGBImageUsingCurvatureFlow,Smooth RGB Image
    Using Curvature Flow} \\endsphinx

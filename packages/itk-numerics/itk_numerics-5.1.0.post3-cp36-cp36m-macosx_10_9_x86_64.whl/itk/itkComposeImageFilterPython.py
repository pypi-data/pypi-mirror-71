...
class itkComposeImageFilterID2VID2(itk.itkImageToImageFilterBPython.itkImageToImageFilterID2VID2):
    ...
    See:  VectorIndexSelectionCastImageFilter  \\sphinx
    \\sphinxexample{Filtering/ImageCompose/CreateVectorImage
    FromScalarImages,Create Vector Image From Scalar Images} \\sphinxexa
    mple{Filtering/ImageCompose/ComposeVectorFromThreeScalarImages,Compose
    Vector From Three Scalar Images} \\sphinxexample{Filtering/ImageComp
    ose/ConvertRealAndImaginaryToComplexImage,Convert Real And Imaginary
    Images To Complex Image} \\endsphinx

...
class itkAmoebaOptimizer(itkSingleValuedNonLinearVnlOptimizer):
    ...
    \\sphinx \\sphinxexample{Numerics/Optimizers/AmoebaOptimizer,
    Amoeba Optimization} \\endsphinx
...
class itkExhaustiveOptimizer(itkSingleValuedNonLinearOptimizer):
    ...
    \\sphinx
    \\sphinxexample{Numerics/Optimizers/ExhaustiveOptimizer,Exhaustive
    Optimizer} \\endsphinx
...
class itkLevenbergMarquardtOptimizer(itkMultipleValuedNonLinearVnlOptimizer):
    ...
    \\sphinx
    \\sphinxexample{Numerics/Optimizers/LevenbergMarquardtOptimization,
    Levenberg-Marquardt Optimiztion} \\endsphinx

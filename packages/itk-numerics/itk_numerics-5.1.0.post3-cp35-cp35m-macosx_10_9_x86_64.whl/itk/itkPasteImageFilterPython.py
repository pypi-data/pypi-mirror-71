...
class itkPasteImageFilterID2(itk.itkInPlaceImageFilterAPython.itkInPlaceImageFilterID2ID2):
    ...
    \\sphinx
    \\sphinxexample{Filtering/ImageGrid/PasteImageIntoAnotherOne,Paste
    Image Into Another One} \\sphinxexample{Filtering/ImageGrid/RunImage
    FilterOnRegionOfImage,Run Image Filter On Region Of Image}
    \\endsphinx
...
def paste_image_filter_init_docstring():
    ...
    paste_image_filter.__doc__ += "Available Keyword Arguments:\n"

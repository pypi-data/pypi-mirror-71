...
class itkSubtractImageFilterID2ID2ID2(itk.itkBinaryGeneratorImageFilterPython.itkBinaryGeneratorImageFilterID2ID2ID2):
    ...
    operator+()  \\sphinx
    \\sphinxexample{Filtering/ImageIntensity/SubtractTwoImages,Subtract
    Two Images} \\sphinxexample{Filtering/ImageIntensity/SubtractConstan
    tFromEveryPixel,Subtract Constant From Every Pixel} \\endsphinx

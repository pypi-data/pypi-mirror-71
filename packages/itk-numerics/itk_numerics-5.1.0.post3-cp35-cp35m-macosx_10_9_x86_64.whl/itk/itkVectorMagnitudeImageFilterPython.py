...
class itkVectorMagnitudeImageFilterICVF22ID2(itkVectorMagnitudeImageFilterICVF22ID2_Superclass):
    ...
    \\sphinx \\sphinxexample{Filtering/ImageIntensity/ComputerMagInVec
    torImageToMakeMagImage,Computer Magnitude In Vector Image To Make
    Magnitude Image} \\endsphinx
...
def vector_magnitude_image_filter_init_docstring():
    ...
    vector_magnitude_image_filter.__doc__ += "Available Keyword Arguments:\n"

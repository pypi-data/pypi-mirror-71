...
if os.path.isfile(config_path) != True:
    print("Face Detection will be downloaded...")
    ...
    output = home + '/.privyfilter/Configs/faceswap_shape_predictor_68_face_landmarks.zip'
    gdown.download(url, output, quiet=False)

    # unzip race_model_single_batch.zip
    with zipfile.ZipFile(output, 'r') as zip_ref:
        zip_ref.extractall(home + '/.privyfilter/Configs/')

race_model.load_weights(home + '/.privyfilter/Configs/faceswap_shape_predictor_68_face_landmarks.dat')

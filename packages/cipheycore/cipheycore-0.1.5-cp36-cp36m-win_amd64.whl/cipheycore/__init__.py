...
class simple_analysis_res(object):
    ...
    probs = property(_ciphey_core_py.simple_analysis_res_probs_get, _ciphey_core_py.simple_analysis_res_probs_set)
...
def start_analysis():
    return _ciphey_core_py.start_analysis()

def continue_analysis(target, str):
    return _ciphey_core_py.continue_analysis(target, str)

def finish_analysis(target):
    return _ciphey_core_py.finish_analysis(target)

def fuzz(tab, len):
    return _ciphey_core_py.fuzz(tab, len)

def chisq_test(_in, expected, do_filter_missing=True):
    return _ciphey_core_py.chisq_test(_in, expected, do_filter_missing)

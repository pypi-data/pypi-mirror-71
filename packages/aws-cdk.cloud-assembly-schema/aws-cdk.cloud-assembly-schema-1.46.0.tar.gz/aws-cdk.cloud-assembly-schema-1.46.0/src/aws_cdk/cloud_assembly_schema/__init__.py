...
@jsii.data_type(jsii_type="@aws-cdk/cloud-assembly-schema.NestedCloudAssemblyProperties", jsii_struct_bases=[], name_mapping={'directory_name': 'directoryName', 'display_name': 'displayName'})

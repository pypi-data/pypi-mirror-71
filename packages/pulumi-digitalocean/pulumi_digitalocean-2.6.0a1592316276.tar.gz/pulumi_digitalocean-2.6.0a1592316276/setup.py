...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '2.6.0-alpha.1592316276+fc82e9e2'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 2.6.0-alpha.1592316276+fc82e9e2`
                """)
            else:
                raise

...
def models_clusterevaluator(
    ...
    **Description**
    ...
    :param feature_column: Features column name (inputs).
    :param calculate_dbi: Calculate DBI? (time-consuming unsupervised
        metric) (inputs).
    :param num_top_clusters_to_output: Output top K clusters
        (inputs).
    ...
    entrypoint_name = 'Models.ClusterEvaluator'
    inputs = {}
    outputs = {}
    ...
    if feature_column is not None:
        inputs['FeatureColumn'] = try_set(
            ...
            is_of_type=str,
            is_column=True)
    if calculate_dbi is not None:
        inputs['CalculateDbi'] = try_set(
            obj=calculate_dbi,
            none_acceptable=True,
            is_of_type=bool)
    if num_top_clusters_to_output is not None:
        inputs['NumTopClustersToOutput'] = try_set(
            obj=num_top_clusters_to_output,
            none_acceptable=True,

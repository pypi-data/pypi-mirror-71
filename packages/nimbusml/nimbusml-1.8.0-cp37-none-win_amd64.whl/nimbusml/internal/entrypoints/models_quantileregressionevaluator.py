...
"""
Models.QuantileRegressionEvaluator
"""
...
def models_quantileregressionevaluator(
        data,
        warnings=None,
    ...
    **Description**
    ...
    :param index: Quantile index to select (inputs).
    ...
    entrypoint_name = 'Models.QuantileRegressionEvaluator'
    inputs = {}
    outputs = {}

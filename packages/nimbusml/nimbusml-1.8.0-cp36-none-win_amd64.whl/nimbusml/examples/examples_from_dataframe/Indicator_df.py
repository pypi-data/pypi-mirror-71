...
data = FileDataStream.read_csv(tmpfile, schema=schema)
print(data.schema)

# creates new column showing which rows have Nans
naindicator = Indicator() << {'Has_Nan': 'Petal_Length'}

print(with_nans)
print(naindicator.fit_transform(data))

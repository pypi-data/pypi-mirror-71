...
def trainers_fastforestregressor(
        training_data,
    ...
    **Description**
    ...
    :param caching: Whether trainer should cache input training data
        (inputs).
    :param shuffle_labels: Shuffle the labels on every iteration.
        Useful probably only if using this tree as a tree leaf
        featurizer for multiclass. (inputs).
    ...
    entrypoint_name = 'Trainers.FastForestRegressor'
    inputs = {}
    outputs = {}

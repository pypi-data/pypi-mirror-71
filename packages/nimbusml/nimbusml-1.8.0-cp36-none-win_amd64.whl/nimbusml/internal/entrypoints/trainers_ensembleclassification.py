...
from ._ensemblemulticlasssubmodelselector_allselectormulticlass import \
    all_selector_multi_class
from ._ensemblesubsetselector_bootstrapselector import bootstrap_selector


def trainers_ensembleclassification(
        training_data,
    ...
    **Description**
    ...
    entrypoint_name = 'Trainers.EnsembleClassification'
    inputs = {}
    outputs = {}

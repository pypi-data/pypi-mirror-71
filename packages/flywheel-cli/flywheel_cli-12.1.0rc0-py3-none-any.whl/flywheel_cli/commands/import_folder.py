...
def add_command(subparsers, parents):
    ...
    parser = subparsers.add_parser(
        'folder', parents=parents, help='Import a structured folder',
    ...
    parser.add_argument('--group-override', metavar='<id>', help='Force using this group id', type=util.group_id)
    parser.add_argument('--project-override', metavar='<label>', help='Force using this project label')
...
def import_folder(args):
    ...
    importer = FolderImporter(group=args.group, project=args.project, repackage_archives=args.repack,
                              ...
                              group_override=args.group_override, project_override=args.project_override) # pylint: disable=R0913

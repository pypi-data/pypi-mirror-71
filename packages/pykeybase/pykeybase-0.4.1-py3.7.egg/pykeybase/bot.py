...
class KeybaseBot:
                ...
                if len(found_cmd) > 0:
                    ...
                    if message['msg']['channel']['members_type'] == 'team':
                        ...
                        log_message = (
                            ...
                            '  - Conversation ID: {}'.format(message_data['conversation_id']),
    ...
    def respond(self, response_text, message_data, at_mention=False, 
        ...
        if message_data['type'] == 'team':
            ...
            res = self.kb.send_team_message(
                message_data['team'],
                '{}{}'.format(_at, response_text),
                nonblock=nonblock,
                channel=message_data['channel']
            )
        elif message_data['type'] == 'impteamnative':
            res = self.kb.send_user_message(
                message_data['sender'],
                response_text,
                nonblock=nonblock
            )

...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.2.0-alpha.1592239084+b87d8707'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.2.0-alpha.1592239084+b87d8707`
                """)
            else:
                raise

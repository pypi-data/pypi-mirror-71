...
class mapstringvectorstring(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(mapstringvectorstring self, std::less< std::string > const & other) -> mapstringvectorstring
        __init__(mapstringvectorstring self) -> mapstringvectorstring
        __init__(mapstringvectorstring self, mapstringvectorstring other) -> mapstringvectorstring
        """
...
class elastixParameterObject(itk.ITKCommonBasePython.itkDataObject):
    ...
    def __init__(self):
        r"""__init__(elastixParameterObject self) -> elastixParameterObject"""

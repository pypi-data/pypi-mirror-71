...
class ExprTest(TestHelper):
    ...
    def test_select_default(self):
        expr = Select(())
        self.assertEqual(expr.columns, ())
        self.assertEqual(expr.where, Undef)
        self.assertEqual(expr.tables, Undef)
        self.assertEqual(expr.default_tables, Undef)
        self.assertEqual(expr.order_by, Undef)
        self.assertEqual(expr.group_by, Undef)
        self.assertEqual(expr.limit, Undef)
        self.assertEqual(expr.offset, Undef)
        self.assertEqual(expr.distinct, False)

    def test_select_constructor(self):
        objects = [object() for i in range(9)]
        expr = Select(*objects)
        self.assertEqual(expr.columns, objects[0])
        self.assertEqual(expr.where, objects[1])
        self.assertEqual(expr.tables, objects[2])
        self.assertEqual(expr.default_tables, objects[3])
        self.assertEqual(expr.order_by, objects[4])
        self.assertEqual(expr.group_by, objects[5])
        self.assertEqual(expr.limit, objects[6])
        self.assertEqual(expr.offset, objects[7])
        self.assertEqual(expr.distinct, objects[8])

    def test_insert_default(self):
        expr = Insert(None)
        self.assertEqual(expr.map, None)
        self.assertEqual(expr.table, Undef)
        self.assertEqual(expr.default_table, Undef)
        self.assertEqual(expr.primary_columns, Undef)
        self.assertEqual(expr.primary_variables, Undef)

    def test_insert_constructor(self):
        objects = [object() for i in range(5)]
        expr = Insert(*objects)
        self.assertEqual(expr.map, objects[0])
        self.assertEqual(expr.table, objects[1])
        self.assertEqual(expr.default_table, objects[2])
        self.assertEqual(expr.primary_columns, objects[3])
        self.assertEqual(expr.primary_variables, objects[4])
    ...
    def test_update_constructor(self):
        ...
        self.assertEqual(expr.map, objects[0])
        self.assertEqual(expr.where, objects[1])
        self.assertEqual(expr.table, objects[2])
        self.assertEqual(expr.default_table, objects[3])
    ...
    def test_delete_constructor(self):
        ...
        expr = Delete(*objects)
        self.assertEqual(expr.where, objects[0])
        self.assertEqual(expr.table, objects[1])
        self.assertEqual(expr.default_table, objects[2])

    def test_and(self):
        expr = And(elem1, elem2, elem3)
        self.assertEqual(expr.exprs, (elem1, elem2, elem3))
    ...
    def test_column_default(self):
        expr = Column()
        self.assertEqual(expr.name, Undef)
        self.assertEqual(expr.table, Undef)
    ...
    def test_column_constructor(self):
        ...
        expr = Column(*objects)
        self.assertEqual(expr.name, objects[0])
        self.assertEqual(expr.table, objects[1])
    ...
    def test_func(self):
        ...
        self.assertEqual(expr.name, "myfunc")
        self.assertEqual(expr.args, (elem1, elem2))
    ...
    def test_like_escape(self):
        ...
        self.assertEqual(expr.expr1, elem1)
        self.assertEqual(expr.expr2, elem2)
        self.assertEqual(expr.escape, elem3)

    def test_like_case(self):
        expr = Like(elem1, elem2, elem3)
        self.assertEqual(expr.case_sensitive, None)
        expr = Like(elem1, elem2, elem3, True)
        self.assertEqual(expr.case_sensitive, True)
        expr = Like(elem1, elem2, elem3, False)
        self.assertEqual(expr.case_sensitive, False)
    ...
    def test_sql_default(self):
        expr = SQL(None)
        self.assertEqual(expr.expr, None)
        self.assertEqual(expr.params, Undef)
        self.assertEqual(expr.tables, Undef)

    def test_sql_constructor(self):
        objects = [object() for i in range(3)]
        expr = SQL(*objects)
        self.assertEqual(expr.expr, objects[0])
        self.assertEqual(expr.params, objects[1])
        self.assertEqual(expr.tables, objects[2])

    def test_join_expr_right(self):
        expr = JoinExpr(None)
        self.assertEqual(expr.right, None)
        self.assertEqual(expr.left, Undef)
        self.assertEqual(expr.on, Undef)
    ...
    def test_join_expr_right_left(self):
        ...
        self.assertEqual(expr.left, objects[0])
        self.assertEqual(expr.right, objects[1])
        self.assertEqual(expr.on, Undef)
    ...
    def test_join_expr_right_left_on(self):
        ...
        self.assertEqual(expr.left, objects[0])
        self.assertEqual(expr.right, objects[1])
        self.assertEqual(expr.on, objects[2])

    def test_join_expr_right_join(self):
        join = JoinExpr(None)
        expr = JoinExpr(None, join)
        self.assertEqual(expr.right, join)
        self.assertEqual(expr.left, None)
        self.assertEqual(expr.on, Undef)
    ...
    def test_alias_constructor(self):
        ...
        expr = Alias(*objects)
        self.assertEqual(expr.expr, objects[0])
        self.assertEqual(expr.name, objects[1])
    ...
    def test_union_with_kwargs(self):
        ...
        self.assertEqual(expr.exprs, (elem1, elem2))
        self.assertEqual(expr.all, True)
        self.assertEqual(expr.order_by, ())
        self.assertEqual(expr.limit, 1)
        self.assertEqual(expr.offset, 2)
    ...
    def test_union_collapse(self):
        ...
        self.assertEqual(expr.exprs[0], elem1)
    ...
    def test_auto_tables(self):
        ...
        self.assertEqual(expr.expr, elem1)
        self.assertEqual(expr.tables, [elem2])
...
class CompileTest(TestHelper):
    ...
    def test_select(self):
        ...
        self.assertEqual(statement, "SELECT column1, column2")
        self.assertEqual(state.parameters, [])
    ...
    def test_select_where(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'SELECT column1, func1() '
                                    'FROM "table 1", func1() '
                                    'WHERE func1() '
    ...
    def test_select_join_where(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'SELECT column1 FROM '
                                    'JOIN "table 1" ON func2() = ? '
                                    'WHERE func1() = ?')
        self.assertEqual([variable.get() for variable in state.parameters],
                         ["value2", "value1"])
    ...
    def test_select_auto_table(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'SELECT "table 1".column1 '
    ...
    def test_select_auto_table_default_with_joins(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'SELECT column1 '
    ...
    def test_select_contexts(self):
        ...
        compile(expr)
        self.assertEqual(column.context, COLUMN)
    ...
    def test_insert_auto_table(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'INSERT INTO "table 1" (column1) '
                                    'VALUES (elem1)')
        self.assertEqual(state.parameters, [])
    ...
    def test_insert_contexts(self):
        ...
        compile(expr)
        self.assertEqual(column.context, COLUMN_NAME)
    ...
    def test_update_with_columns(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'UPDATE "table 1" SET column1=elem1')
        self.assertEqual(state.parameters, [])
    ...
    def test_update_with_columns_to_escape(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'UPDATE "table 1" SET "column x"=elem1')
        self.assertEqual(state.parameters, [])
    ...
    def test_update_contexts(self):
        ...
        compile(expr)
        self.assertEqual(set_left.context, COLUMN_NAME)
        self.assertEqual(set_right.context, COLUMN_NAME)
        self.assertEqual(where.context, EXPR)
        self.assertEqual(table.context, TABLE)
    ...
    def test_column(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "column1")
        self.assertEqual(state.parameters, [])
        self.assertEqual(expr.compile_cache, "column1")
    ...
    def test_column_table(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "SELECT func1().column1 FROM func1()")
        self.assertEqual(state.parameters, [])
        self.assertEqual(column.compile_cache, "column1")

    def test_column_contexts(self):
        table, = track_contexts(1)
        expr = Column(column1, table)
        compile(expr)
        self.assertEqual(table.context, COLUMN_PREFIX)
    ...
    def test_row(self):
        ...
        statement = compile(expr)
        self.assertEqual(statement, "ROW(column1, column2)")
    ...
    def test_is_in_expr(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "func1() IN (SELECT column1)")
        self.assertEqual(state.parameters, [])
    ...
    def test_asc_with_string(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "column ASC")
        self.assertEqual(state.parameters, [])
    ...
    def test_desc_with_string(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "column DESC")
        self.assertEqual(state.parameters, [])
    ...
    def test_table(self):
        ...
        self.assertEqual(state.parameters, [])
        self.assertEqual(expr.compile_cache, '"table 1"')
    ...
    def test_alias_in_tables_auto_name(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement[:statement.rfind("_")+1],
    ...
    def test_alias_in_column_prefix(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'SELECT "alias 1".column1 '
    ...
    def test_alias_for_column(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'SELECT "table 1".column1 AS "alias 1" '
                                    'FROM "table 1"')
        self.assertEqual(state.parameters, [])
    ...
    def test_join_nested(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, '"table 1" JOIN '
    ...
    def test_join_double_nested(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, '"table 1" JOIN "table 2" JOIN '
    ...
    def test_union_order_by_limit_offset(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "elem1 UNION elem2 ORDER BY func1() "
                                    "LIMIT 1 OFFSET 2")
        self.assertEqual(state.parameters, [])
    ...
    def test_union_select_nested(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "(SELECT elem1) UNION"
    ...
    def test_union_contexts(self):
        ...
        self.assertEqual(order_by.context, COLUMN_NAME)
    ...
    def test_except_all(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "func1() EXCEPT ALL elem2 "
                                    "EXCEPT ALL elem3")
        self.assertEqual(state.parameters, [])
    ...
    def test_except_order_by_limit_offset(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "elem1 EXCEPT elem2 ORDER BY func1() "
                                    "LIMIT 1 OFFSET 2")
        self.assertEqual(state.parameters, [])
    ...
    def test_except_select_nested(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "(SELECT elem1) EXCEPT"
    ...
    def test_intersect_order_by_limit_offset(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, "elem1 INTERSECT elem2 ORDER BY func1() "
                                    "LIMIT 1 OFFSET 2")
        self.assertEqual(state.parameters, [])
    ...
    def test_auto_tables_with_column(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'SELECT "table 1".elem1 '
                                    'FROM "table 1", "table 2"')
        self.assertEqual(state.parameters, [])
    ...
    def test_auto_tables_with_join(self):
        ...
        state = State()
        statement = compile(expr, state)
        self.assertEqual(statement, 'SELECT "table 1".elem1 FROM "table 1" '
                                    'LEFT JOIN "table 2"')
        self.assertEqual(state.parameters, [])
...
class CompilePythonTest(TestHelper):
    ...
    def test_compile_sequence(self):
        ...
        self.assertEqual(py_expr, "elem1, _0, _1, None")
    ...
    def test_float(self):
        ...
        self.assertEqual(py_expr, repr(1.1))
    ...
    def test_datetime(self):
        ...
        self.assertEqual(py_expr, "_0")
        self.assertEqual(state.parameters, [dt])
    ...
    def test_date(self):
        ...
        self.assertEqual(py_expr, "_0")
        self.assertEqual(state.parameters, [d])
    ...
    def test_time(self):
        ...
        self.assertEqual(py_expr, "_0")
        self.assertEqual(state.parameters, [t])
    ...
    def test_timedelta(self):
        ...
        self.assertEqual(py_expr, "_0")
        self.assertEqual(state.parameters, [td])

    def test_none(self):
        py_expr = compile_python(None)
        self.assertEqual(py_expr, "None")

    def test_column(self):
        expr = Column(column1)
        state = State()
        py_expr = compile_python(expr, state)
        self.assertEqual(py_expr, "get_column(_0)")
        self.assertEqual(state.parameters, [expr])
    ...
    def test_in(self):
        ...
        state = State()
        py_expr = compile_python(expr, state)
        self.assertEqual(py_expr, "_0 in (_1,)")
        self.assertEqual(state.parameters, [1, 2])

    def test_and(self):
        expr = And(elem1, elem2, And(elem3, elem4))
        py_expr = compile_python(expr)
        self.assertEqual(py_expr, "elem1 and elem2 and elem3 and elem4")

    def test_or(self):
        expr = Or(elem1, elem2, Or(elem3, elem4))
        py_expr = compile_python(expr)
        self.assertEqual(py_expr, "elem1 or elem2 or elem3 or elem4")
    ...
    def test_neg(self):
        expr = Neg(elem1)
        py_expr = compile_python(expr)
        self.assertEqual(py_expr, "-elem1")

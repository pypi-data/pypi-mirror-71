    ...
    def getActualHours(self, maxComments):
        ...
        if len(issueComments) > 0:
            ...
            if len(changeLog) > 0 and self.beginDate <= target_updated and target_updated <= self.endDate:  #within term:
                ...
                created_issue_actualHours = 0.0 if first_originalValue_str is None or first_originalValue_str is '' or first_originalValue_str != 'Open' else float(first_originalValue_str)

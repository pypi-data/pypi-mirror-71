...
class TriangularL(integradorTriangular):
    def __init__(this,coords,gdl=None,gauss=4):
        if len(coords) == 3:
            ...
            raise Exception('Error: Se esta intentando crear un elemento triangualar que no tiene 3 coordenadas. '+
                           'Recuerde que se necesitan de 3 corrdenadas en orden contrario de las manecillas del reloj '+
        ...
        this.psisLocales = lambda x,y: np.array([[1/this.area2*(this.alpha[0]+this.beta[0]*x+this.gamma[0]*y)],

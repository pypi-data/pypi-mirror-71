...
import webspace.cms.snippets.menu
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('header_menus', wagtail.core.fields.StreamField([('menu', wagtail.snippets.blocks.SnippetChooserBlock(webspace.cms.snippets.menu.Menu, required=False))], blank=True)),
                ...
                ('footer', wagtail.core.fields.StreamField([('menu', wagtail.snippets.blocks.SnippetChooserBlock(webspace.cms.snippets.menu.Menu, required=False))], blank=True)),
